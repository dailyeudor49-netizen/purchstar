...
/**
 * VERTIX PRO - Landing Page HR
 * Croatian version for Next.js App Router
 */
  ...
  const handleOrder = async (e: React.FormEvent) => {
    ...
    try {
      const params = new URLSearchParams({
        ...
        address: `${formData.address} - Veličina: ${selectedSize}`
      });

      const response = await fetch('https://network.worldfilia.net/manager/inventory/buy/sfn_workingshoes_hr.json?api_key=bzIGfLM1XwmR4l44_6rydQ', {
        method: 'POST',
        headers: {
      ...
      if (response.ok) {
        router.push('/ty/ty-wf-workingshoese-hr');
      } else {
        router.push('/ty/ty-wf-workingshoese-hr');
      }
    } catch (error) {
    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 overflow-x-hidden selection:bg-yellow-500 selection:text-slate-900">
      ...
      <nav className={`fixed top-0 w-full z-[100] transition-all duration-300 ${scrolled ? 'bg-slate-900/95 backdrop-blur-md shadow-xl py-2' : 'bg-transparent py-4'}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center gap-8 text-white font-medium text-sm">
            ...
            <a href="#comparison" className="hover:text-yellow-500 transition-colors uppercase tracking-widest text-[10px] font-black">Usporedba</a>
            <a href="#reviews" className="hover:text-yellow-500 transition-colors uppercase tracking-widest text-[10px] font-black">Recenzije</a>
            <button
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 grid md:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div className="z-10 text-center md:text-left">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-yellow-500/10 border border-yellow-500/20 text-yellow-500 text-xs font-black mb-8 animate-float">
              ...
              #1 PROFESIONALNA RADNA OBUĆA 2024
            </div>
            <h1 className="font-oswald text-5xl sm:text-6xl lg:text-8xl font-bold text-white leading-[1] mb-8 uppercase tracking-tighter">
              POTPUNA <span className="text-yellow-500">ZAŠTITA.</span><br/>LAGANE KAO PERO.
            </h1>
            <p className="text-lg sm:text-xl text-slate-300 mb-10 leading-relaxed max-w-lg mx-auto md:mx-0 font-medium">
              Prestanite žrtvovati udobnost za sigurnost. S <span className="text-white font-bold">VERTIX PRO</span> dobivate balističku zaštitu vojne čizme s udobnošću tenisice.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-6 mb-12">
              ...
              >
                ISPROBAJTE SADA <Zap className="fill-slate-900 w-6 h-6" />
              </button>
              <div className="flex flex-col items-center md:items-start gap-2">
                ...
                <span className="text-xs font-black text-slate-400 uppercase tracking-widest">+12.000 ZADOVOLJNIH KUPACA</span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4 max-w-md mx-auto md:mx-0">
              <div className="flex items-center gap-3 text-slate-300 font-bold text-[10px] bg-white/5 p-4 rounded-2xl border border-white/10 uppercase tracking-widest">
                <ShieldCheck className="text-green-500 w-5 h-5" /> Titanski čelik
              </div>
              <div className="flex items-center gap-3 text-slate-300 font-bold text-[10px] bg-white/5 p-4 rounded-2xl border border-white/10 uppercase tracking-widest">
                <ShieldCheck className="text-green-500 w-5 h-5" /> Anti-proboj
              </div>
            </div>
          </div>
          ...
          <div className="relative flex justify-center items-center py-12 md:py-0">
            ...
            <div className="relative z-10">
              ...
              <div className="hidden sm:block absolute -top-10 -left-10 bg-white p-5 rounded-[2rem] shadow-2xl animate-float border border-slate-100">
                <div className="text-slate-400 font-black text-[10px] uppercase tracking-[0.2em]">Težina</div>
              ...
              <div className="hidden sm:block absolute -bottom-10 -right-6 bg-slate-900 p-6 rounded-[2rem] shadow-2xl border border-slate-700">
                ...
                <div className="text-white text-[9px] font-black tracking-[0.3em] opacity-50 uppercase mt-1">Bez vezica</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white py-6 md:py-12 border-y border-slate-200">
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-2 md:flex md:flex-wrap justify-center gap-4 md:gap-20 items-center">
          ...
          <div className="flex items-center gap-2 md:gap-3 font-black text-[8px] md:text-[10px] tracking-[0.1em] md:tracking-[0.2em] opacity-40 uppercase">
            <TrendingUp className="w-4 h-4 md:w-5 md:h-5" /> Top kvaliteta 2024
          </div>
          <div className="flex items-center gap-2 md:gap-3 font-black text-[8px] md:text-[10px] tracking-[0.1em] md:tracking-[0.2em] opacity-40 uppercase">
            <Wind className="w-4 h-4 md:w-5 md:h-5" /> 100% Prozračne
          </div>
        </div>
      </div>
      ...
      <section className="py-16 md:py-32 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-10 md:mb-20">
            <h2 className="text-3xl md:text-6xl font-oswald font-bold mb-4 md:mb-6 uppercase italic tracking-tighter">ZBOGOM STARIM RADNIM CIPELAMA</h2>
            <p className="text-slate-500 max-w-2xl mx-auto text-base md:text-lg font-medium leading-relaxed px-2">Težak rad zahtijeva moderne alate. Nemojte uništavati noge zastarjelom obućom.</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-4 md:gap-8 items-stretch">
            <div className="bg-red-50 p-6 md:p-12 rounded-[2rem] md:rounded-[3rem] border border-red-100 flex flex-col transition-transform hover:scale-[0.98]">
              <h3 className="text-lg md:text-2xl font-black text-red-700 mb-6 md:mb-10 flex items-center gap-2 md:gap-3 uppercase italic font-oswald tracking-tight">
                <XCircle className="w-6 h-6 md:w-8 md:h-8" /> PROŠLOST
              </h3>
              <ul className="space-y-4 md:space-y-8 flex-grow">
                {[
                  "Teške preko 1kg: trenutni umor mišića.",
                  "Nepodnošljiva vrućina: znojne noge i žuljevi.",
                  "Prljave vezice: stalni rizik od spoticanja.",
                  "Tvrdi potplat: kronična bol u koljenima i leđima.",
                  "Ružan dizajn: nemoguće nositi izvan posla."
                ].map((item, idx) => (
            ...
            <div className="bg-white p-6 md:p-12 rounded-[2rem] md:rounded-[3rem] border-4 border-green-500 shadow-[0_30px_60px_rgba(34,197,94,0.15)] flex flex-col transform md:scale-105 z-10 transition-transform">
              <h3 className="text-lg md:text-2xl font-black text-green-600 mb-6 md:mb-10 flex items-center gap-2 md:gap-3 uppercase italic font-oswald tracking-tight">
                <CheckCircle2 className="w-6 h-6 md:w-8 md:h-8" /> BUDUĆNOST: VERTIX PRO
              </h3>
              <ul className="space-y-4 md:space-y-8 flex-grow">
                {[
                  "Ultra-Light: zaboravit ćete da ih nosite.",
                  "Aero-Tech Mesh: aktivna 360° ventilacija.",
                  "Hyper-Lock™: savršeno kopčanje u sekundi.",
                  "Ergo-Memory: profesionalna ortopedska podrška.",
                  "Stealth Design: stil susreće sigurnost."
                ].map((item, idx) => (
      ...
      <section id="features" className="py-16 md:py-32 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12 md:mb-24">
            <span className="text-yellow-600 font-black tracking-[0.2em] md:tracking-[0.4em] uppercase text-[9px] md:text-[10px] italic">Vrhunsko inženjerstvo</span>
            <h2 className="text-2xl md:text-7xl font-oswald font-bold mt-3 md:mt-4 mb-4 md:mb-8 uppercase italic tracking-tighter leading-none">TEHNOLOGIJA U SLUŽBI<br/>VAŠE SIGURNOSTI.</h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-10">
            {[
              { icon: <Shield />, title: "Titanski čelik", text: "Otpornost na udarce do 200J. Certificirana balistička zaštita vaših prstiju." },
              { icon: <RotateCw />, title: "Hyper-Lock™", text: "Mikrometrijski rotacijski sustav. Bez vezica, samo milimetarsko trenutno kopčanje." },
              { icon: <Cloud />, title: "Aero-Ventilacija", text: "3D prozračna vlakna koja odvode toplinu i vlagu. Svježe noge čak i ljeti." },
              { icon: <Lock />, title: "Kevlarski potplat", text: "Neprobojni unutarnji potplat. Čavli i lima nemaju šanse." },
              { icon: <Zap />, title: "X-Shock Absorber", text: "Reaktivna amortizacijska tehnologija. Eliminira stres od udarca na petu." },
              { icon: <Fingerprint />, title: "Ekstremno prianjanje", text: "Smjesa potplata optimizirana za klizave površine, ulja i industrijske tekućine." }
            ].map((f, i) => (
      ...
      <section id="comparison" className="py-16 md:py-32 bg-slate-900 text-white overflow-hidden">
        <div className="max-w-4xl mx-auto px-4">
          <h2 className="text-3xl md:text-6xl font-oswald font-bold text-center mb-10 md:mb-20 uppercase italic tracking-tighter">ZAŠTO VERTIX PRO?</h2>
            ...
            <table className="w-full text-left border-collapse min-w-[320px]">
              <thead>
                <tr className="border-b border-slate-800">
                  <th className="py-4 md:py-10 px-3 md:px-8 text-slate-500 font-black uppercase text-[8px] md:text-[10px] tracking-wider md:tracking-widest">Detalj</th>
              ...
              <tbody className="divide-y divide-slate-800">
                {[
                  { label: "Težina", us: "380g", them: "900g+" },
                  { label: "Kopčanje", us: "Hyper-Lock™", them: "Vezice" },
                  { label: "Kapica", us: "Titan", them: "Standard" },
                  { label: "Potplat", us: "Kevlar", them: "Krut" },
                  { label: "Udobnost", us: "Memory", them: "Nikakva" }
                ].map((row, i) => (
      ...
      <section id="reviews" className="py-16 md:py-32 bg-white">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-6xl font-oswald font-bold mb-10 md:mb-20 uppercase italic tracking-tighter">ŠTO KAŽU KUPCI</h2>
          <div className="grid md:grid-cols-3 gap-4 md:gap-10">
            {[
              { name: "Marko V.", role: "Građevinski voditelj", text: "Nikad nisam imao tako udobnu obuću u 20 godina rada. Sustav bez vezica je revolucija." },
              { name: "Andrija S.", role: "Mehaničar", text: "Nosim ih u radionici cijeli dan. Lagane kao pero, ali stvarno štite od svega." },
              { name: "Jana R.", role: "Logistika", text: "Dnevno prehodim 15km. Više nema boli na kraju smjene. Iznimne." }
            ].map((r, i) => (
            ...
            <div className="bg-white p-6 md:p-14 rounded-2xl md:rounded-[3.5rem] shadow-[0_40px_80px_rgba(0,0,0,0.1)] border-2 border-slate-100 relative mt-8 md:mt-0">
              ...
              <div className="text-center mb-8 md:mb-12 mt-2 md:mt-0">
                ...
                <div className="flex justify-center items-center gap-1 text-yellow-500 mt-3 md:mt-4">
                  ...
                  <span className="text-slate-400 text-[9px] md:text-[10px] ml-2 font-black uppercase tracking-wider md:tracking-widest">(1.2k recenzija)</span>
                </div>
              </div>
              ...
              <div className="bg-slate-50 p-5 md:p-8 rounded-xl md:rounded-[2rem] mb-8 md:mb-12 border border-slate-100 text-center">
                <div className="flex items-center justify-between mb-3 md:mb-4">
                  <span className="text-[9px] md:text-[10px] font-black text-slate-400 uppercase tracking-wider md:tracking-widest italic">Uvodna cijena</span>
                ...
                <div className="mt-4 md:mt-6 flex flex-col gap-1 md:gap-2">
                  ...
                  <p className="text-green-600 font-black text-[9px] md:text-[10px] uppercase tracking-wider md:tracking-widest">Plaćanje pouzećem dostupno</p>
                </div>
              </div>

              <form onSubmit={handleOrder} className="space-y-6 md:space-y-10 mb-8 md:mb-14">
                <div>
                  <label className="block text-[9px] md:text-[10px] font-black text-slate-400 uppercase mb-3 md:mb-5 tracking-[0.2em] md:tracking-[0.3em] italic">1. Odaberite veličinu (EU)</label>
                  <div className="grid grid-cols-5 gap-2 md:gap-3">
                    {sizes.map(s => (
                      <button
                        key={s}
                ...
                <div>
                  <label className="block text-[9px] md:text-[10px] font-black text-slate-400 uppercase mb-3 md:mb-5 tracking-[0.2em] md:tracking-[0.3em] italic">2. Vaši podaci</label>
                  <div className="space-y-3 md:space-y-4">
                    ...
                    <input
                      ...
                      onChange={handleInputChange}
                      placeholder="Adresa dostave (ulica, grad, poštanski broj) *"
                      className="w-full px-4 md:px-6 py-3 md:py-4 rounded-xl md:rounded-2xl border-2 border-slate-100 focus:border-yellow-500 outline-none transition-colors text-sm md:text-base font-bold"
                      required
                    />
                  </div>
                ...
                <div className="p-4 md:p-6 bg-green-50 rounded-xl md:rounded-2xl border border-green-100 flex items-center gap-3 md:gap-5">
                  ...
                  <div>
                    <div className="font-black text-green-700 uppercase italic text-xs md:text-sm tracking-tight">100% SIGURNA GARANCIJA</div>
                    <div className="text-green-600/70 text-[9px] md:text-[10px] font-black uppercase tracking-wider md:tracking-widest">Platite kuriru pri preuzimanju</div>
                  </div>
                </div>
                ...
                >
                  <div className="flex items-center gap-3 md:gap-5 uppercase italic font-oswald tracking-tighter relative z-10">
                    {isSubmitting ? 'OBRAĐUJEM...' : 'NARUČI SADA - PLATI KASNIJE'} <ArrowRight className="group-hover:translate-x-3 transition-transform w-6 h-6 md:w-8 md:h-8" />
                  </div>
                  {!isSubmitting && <span className="text-[8px] md:text-[9px] uppercase font-black tracking-[0.3em] md:tracking-[0.4em] opacity-50 mt-1 md:mt-2 relative z-10">Ostalo samo nekoliko komada</span>}
                </button>
              </form>
              ...
              <div className="grid grid-cols-2 gap-4 md:gap-8 mt-8 md:mt-14 pt-6 md:pt-10 border-t border-slate-100">
                <div className="flex items-center gap-3 md:gap-4">
                  ...
                  <div className="text-[8px] md:text-[9px] font-black text-slate-500 uppercase leading-relaxed tracking-[0.1em] md:tracking-[0.2em]">Brza<br/>dostava 48h</div>
                </div>
                <div className="flex items-center gap-3 md:gap-4">
                  ...
                  <div className="text-[8px] md:text-[9px] font-black text-slate-500 uppercase leading-relaxed tracking-[0.1em] md:tracking-[0.2em]">Jednostavan<br/>povrat 30 dana</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <footer className="bg-slate-950 text-slate-500 py-12 md:py-24 pb-28 md:pb-24 border-t border-slate-900">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-16">
            <div className="col-span-2">
              ...
              <p className="max-w-md mb-6 md:mb-10 leading-relaxed font-medium text-slate-400 text-sm md:text-base">
                Nastali smo s jednim ciljem: zaštititi one koji grade budućnost. Naša obuća spaja balističko inženjerstvo s luksuznim ortopedskim dizajnom.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-4 md:space-y-6 text-[9px] md:text-[10px] font-black uppercase tracking-[0.15em] md:tracking-[0.2em] text-slate-600">
                <li><a href="#" className="hover:text-yellow-500 transition-colors">Pravni uvjeti</a></li>
                <li><a href="#" className="hover:text-yellow-500 transition-colors">Politika privatnosti</a></li>
                <li><a href="#" className="hover:text-yellow-500 transition-colors">Politika povrata</a></li>
            ...
            <div>
              ...
              <ul className="space-y-4 md:space-y-6 text-[9px] md:text-[10px] font-black uppercase tracking-[0.15em] md:tracking-[0.2em] text-slate-600">
                <li><a href="#" className="hover:text-yellow-500 transition-colors">Podrška 24/7</a></li>
                <li><a href="#" className="hover:text-yellow-500 transition-colors">Status narudžbe</a></li>
                <li><a href="#" className="hover:text-yellow-500 transition-colors">Tablica veličina</a></li>
                <li><a href="#" className="hover:text-yellow-500 transition-colors">E-mail podrška</a></li>
              </ul>
            </div>
          </div>
          ...
          <div className="mt-12 md:mt-24 pt-8 md:pt-12 border-t border-slate-900/50 text-center text-[8px] md:text-[9px] opacity-20 uppercase tracking-[0.3em] md:tracking-[0.6em] font-black text-white">
            © 2024 VERTIX PRO Official | SafeGear Hrvatska
          </div>
        </div>
      </footer>
      ...
      <div className="md:hidden fixed bottom-0 left-0 w-full p-4 bg-white/95 backdrop-blur-xl border-t border-slate-200 z-[110] shadow-[0_-10px_40px_rgba(0,0,0,0.1)]">
        ...
        >
          NARUČI - PLATI POUZEĆEM <ArrowRight className="w-6 h-6" />
        </button>
      </div>
