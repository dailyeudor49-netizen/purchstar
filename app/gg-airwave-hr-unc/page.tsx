...
export default function LandingPage() {
  ...
  const handleFormSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      router.push('/ty/ty-gg-airwave-hr-unc');
    } catch (error) {
  ...
  return (
    <>
      ...
      {/* Click Pixel */}
      <img
        src="https://offers.uncappednetwork.com/forms/api/ck/?o=1851&uid=0191dbf2-738a-7d28-82a0-18c3859d5e8f&lp=1871"
        ...
        <div className="product-container">
          ...
          <div className="product-images" id="productImages" ref={productImagesRef} style={imagesStyle}>
                ...
                <div className="slider-images" id="mainSlider" style={{ transform: `translateX(-${currentSlide * 100}%)` }}>
                  {[
                    ...
                    <div className="slider-image" key={index}>
                      <img src={src} alt={`Klima uređaj Air Wave Smart prikaz ${index + 1}`} style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                    </div>
                  ))}
                </div>
              </div>
            ...
            <div className="thumbnails">
              {[
                ...
                >
                  <img src={src} alt={`Pregled klima uređaja ${index + 1}`} style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="product-info">
            ...
            <div className="product-header">
              <h1 className="product-title">Prijenosni Klima Uređaj Air Wave Smart™ 3u1 - Zagrijava, Hladi i Odvlažuje</h1>
              <p className="product-subtitle">Grije, Hladi i Odvlaživanje • ThermoPanel Tehnologija s Eliminacijom CO2 • Bez Vanjskog Agregata • 12 000 BTU • Iznimno Tihi Rad</p>
            </div>
            ...
            <div className="product-rating">
              ...
              <span className="rating-text">4.9 (289 ocjena)</span>
            </div>
            ...
            <div className="product-cta">
              <button className="btn-add-to-cart btn-add-to-cart-mobile" onClick={scrollToForm}>
                ...
                <span style={{ display: 'block', fontWeight: 400 }} className="btn-text-sub">
                  Plaćanje pri Isporuci - Besplatna Isporuka
                </span>
              </button>
            ...
            <div className="product-description">
              ...
              <ul>
                <li><span className="icon">✓</span><span><strong>Snaga 12 000 BTU</strong> – Brzo grije, hladi i odvlaživanje prostora do 60 m²</span></li>
                <li><span className="icon">✓</span><span><strong>Tri načina u jednom</strong> – Grijanje zimi, hlađenje ljeti i odvlaživanje</span></li>
                <li><span className="icon">✓</span><span><strong>Precizna regulacija temperature 16-32°C</strong> – Elektronski termostat koji osigurava optimalnu udobnost</span></li>
                <li><span className="icon">✓</span><span><strong>Razred učinkovitosti A+++</strong> – Smanjenje računa za 60% u odnosu na konvencionalne sustave</span></li>
                <li><span className="icon">✓</span><span><strong>ThermoPanel tehnologija bez vanjske jedinice</strong> – Obnavlja zrak eliminirajući CO2, bez vanjske jedinice</span></li>
                <li><span className="icon">✓</span><span><strong>Upravljanje telefonom</strong> – Dedikirana aplikacija za iOS i Android, uključite grijanje s bilo kojeg mjesta</span></li>
                <li><span className="icon">✓</span><span><strong>Kontrola vlažnosti</strong> – Smanjuje artritis i plijesan, zdravo okruženje</span></li>
                <li><span className="icon">✓</span><span><strong>Lagana montaža</strong> – Instalacija na zid ili pod, bez stručnjaka</span></li>
                <li><span className="icon">✓</span><span><strong>Vrlo tihi</strong> – Idealan čak i za spavaće sobe</span></li>
              </ul>
            </div>

            {/* Trust Section */}
            <div className="trust-section">
              <h3 className="trust-title">Osiguranja i Servis</h3>
              <div className="trust-items">
                <div className="trust-item">
                  ...
                  <div className="trust-content">
                    <h4>BESPLATNA Isporuka u 48h</h4>
                    <p>Ekspresna kurirska pošiljka s praćenjem. Bez naknade za isporuku.</p>
                  </div>
                </div>
                <div className="trust-item">
                  <div className="trust-icon">
                  ...
                  <div className="trust-content">
                    <h4>Plaćanje pri Isporuci</h4>
                    <p>Bez akontacije. Plaćate tek kada primite proizvod izravno kuriru</p>
                  </div>
                </div>
                <div className="trust-item">
                  <div className="trust-icon">
            ...
            <div className="info-boxes">
              ...
              <div className="info-box green">
                ...
                <div className="info-box-content">
                  <p>Bez Suglasnosti</p>
                  <span>Montaža bez suglasnosti zajednice</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="timeline-container" style={{ position: 'relative', maxWidth: '800px', margin: '0 auto', padding: '2rem 0' }}>
            ...
            <div ref={whyItem1.ref} className="timeline-item timeline-item-left" style={{ display: 'grid', gridTemplateColumns: '1fr auto 1fr', gap: '2rem', alignItems: 'center', marginBottom: '3rem', position: 'relative' }}>
              <div className="timeline-content timeline-content-left" style={{
                ...
                <p style={{ fontSize: '0.9375rem', color: '#995200', lineHeight: 1.6 }}>
                  Bez <strong style={{ color: '#663300' }}>vanjske jedinice</strong>, bez suglasnosti. Obnavlja i čisti zrak eliminirajući CO2 i nečistoće.
                </p>
              </div>
            ...
            <div ref={whyItem2.ref} className="timeline-item timeline-item-right" style={{ display: 'grid', gridTemplateColumns: '1fr auto 1fr', gap: '2rem', alignItems: 'center', marginBottom: '3rem', position: 'relative' }}>
              ...
              <div className="timeline-content timeline-content-right" style={{
                ...
                <h3 style={{ fontSize: '1.25rem', fontWeight: 700, color: '#CC6600', marginBottom: '0.5rem' }}>Stvarne Uštede Struje</h3>
                <p style={{ fontSize: '0.9375rem', color: '#995200', lineHeight: 1.6 }}>
                  <strong style={{ color: '#663300' }}>Inteligentni termostat</strong> koji kontrolira temperaturu. <strong style={{ color: '#663300' }}>Smanjenje troškova do 60%</strong> na fakturama.
                </p>
              </div>
            </div>
            ...
            <div ref={whyItem3.ref} className="timeline-item timeline-item-left timeline-item-last" style={{ display: 'grid', gridTemplateColumns: '1fr auto 1fr', gap: '2rem', alignItems: 'center', position: 'relative' }}>
              <div className="timeline-content timeline-content-left" style={{
                ...
                <h3 style={{ fontSize: '1.25rem', fontWeight: 700, color: '#CC6600', marginBottom: '0.5rem' }}>Tri Funkcije u Jednom Aparatu</h3>
                <p style={{ fontSize: '0.9375rem', color: '#995200', lineHeight: 1.6 }}>
      ...
      <section style={{ background: 'white', padding: '4rem 1rem' }}>
        <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
          ...
          <p style={{ textAlign: 'center', color: '#6b7280', maxWidth: '800px', margin: '0 auto 3rem', fontSize: '1rem' }}>
            Zagrijte stan učinkovito bez mana običnih klima uređaja
          </p>
            ...
            >
              ...
              >
                ...
                <div className="why-choose-slide">
                    <div className="why-choose-slide-content">
                        <div className="why-choose-slide-text">
                            <h3>Učinkovito i Jako Grijanje</h3>
                            <p>ThermoPanel tehnologija koja <strong>munjevito zagrijava</strong> vaš dom bez vanjske jedinice. <strong>Konstantna toplina</strong>, bez rasipanja, <strong>sigurne uštede</strong> na fakturama.</p>
                        </div>
                        <div className="why-choose-slide-image">
                            <img src="/images/condizionatore/riscaldamento.webp" alt="Funkcija grijanja Air Wave" />
                        </div>
                    </div>
                </div>
                ...
                <div className="why-choose-slide">
                    <div className="why-choose-slide-content">
                        <div className="why-choose-slide-text">
                            <h3>S Montažom ili Bez</h3>
                            <p><strong>Nekompliciranа montaža</strong> na zid ili pod. <strong>Bez instalatera</strong>, <strong>priključi i koristi</strong>. Počnite koristiti za par minuta.</p>
                        </div>
                        <div className="why-choose-slide-image">
                            <img src="/images/condizionatore/installazione.webp" alt="Montaža klima uređaja Air Wave" />
                        </div>
                    </div>
                </div>
                ...
                <div className="why-choose-slide">
                    <div className="why-choose-slide-content">
                        <div className="why-choose-slide-text">
                            <h3>Hladi Ljeti, Zagrijava Zimi</h3>
                            <p><strong>Tri načina u jednom</strong>: jako grijanje zimi, hlađenje ljeti, odvlaživanje tijekom cijele godine. <strong>Bez dozvola</strong> zajednice.</p>
                        </div>
                        <div className="why-choose-slide-image">
                            <img src="/images/condizionatore/caldo-freddo.webp" alt="Klima uređaj tri u jednom" />
                        </div>
                    </div>
                </div>
                ...
                <div className="why-choose-slide">
                    <div className="why-choose-slide-content">
                        <div className="why-choose-slide-text">
                            <h3>Smanjenje troškova do 60% na Računima</h3>
                            <p><strong>Efikasnost A+++</strong> i inteligentni termostat: trošite samo onoliko koliko vam treba. <strong>Bez gubitaka</strong>, <strong>najveće uštede</strong> u odnosu na plinske instalacije.</p>
                        </div>
                        <div className="why-choose-slide-image">
                            <img src="/images/condizionatore/risparmio.webp" alt="Ušteda energije Air Wave" />
                        </div>
                    </div>
                </div>
                ...
                <div className="why-choose-slide">
                    <div className="why-choose-slide-content">
                        <div className="why-choose-slide-text">
                            <h3>Vrlo tihi: Spavajte Mirno</h3>
                            <p>Idealan za <strong>spavaće sobe</strong>. <strong>Iznimno tihi</strong> rad, bez bučnog vanjske jedinice. Uživajte u <strong>maksimalnoj udobnosti</strong> bez smetnji.</p>
                        </div>
                        <div className="why-choose-slide-image">
                            <img src="/images/condizionatore/silenzioso.webp" alt="Tihi rad klima uređaja" />
                        </div>
                    </div>
                </div>
        ...
        <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
          ...
          <div className="tech-specs-container">
               ...
               <div className="tech-specs-row-3">
                    <div style={{
                      ...
                      transition: 'opacity 0.6s ease-out, transform 0.6s ease-out'
                        ...
                        <div style={{ fontSize: '0.875rem', color: '#6b7280' }}>Maksimalna površina</div>
                    </div>
                    <div style={{
                      background: '#F5F5F5',
                      border: '2px solid transparent',
                    ...
                    <div style={{
                      ...
                      transition: 'opacity 0.6s ease-out 0.4s, transform 0.6s ease-out 0.4s'
                        ...
                        <div style={{ fontSize: '0.875rem', color: '#6b7280' }}>Temperaturni raspon</div>
                    </div>
                </div>
                    ...
                    <div style={{
                      ...
                      transition: 'opacity 0.6s ease-out 0.6s, transform 0.6s ease-out 0.6s'
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1rem' }}>
                            ...
                            <h3 style={{ fontSize: '1.125rem', fontWeight: 600, color: '#FF8C00' }}>Ušteda Struje</h3>
                        </div>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.75rem' }}>
                    <div style={{
                      ...
                      transition: 'opacity 0.6s ease-out, transform 0.6s ease-out'
                        ...
                        <div style={{ fontSize: '0.75rem', color: '#6b7280' }}>Maksimalna površina</div>
                    </div>
                    <div style={{
                      background: '#F5F5F5',
                      border: '2px solid transparent',
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.75rem' }}>
                    <div style={{
                      ...
                      transition: 'opacity 0.6s ease-out 0.4s, transform 0.6s ease-out 0.4s'
                        ...
                        <div style={{ fontSize: '0.75rem', color: '#6b7280' }}>Temperaturni raspon</div>
                    </div>
                    <div style={{
                      background: '#F5F5F5',
                      border: '2px solid transparent',
                ...
                <div style={{
                  ...
                  transition: 'opacity 0.6s ease-out 0.8s, transform 0.6s ease-out 0.8s'
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '0.75rem' }}>
                        ...
                        <h3 style={{ fontSize: '1rem', fontWeight: 600, color: '#FF8C00', margin: 0 }}>Ušteda Struje</h3>
                    </div>
            ...
            <div className="tech-specs-image" style={{ background: 'linear-gradient(135deg, #FFF8F0, #FFE8CC)', border: '2px solid #FFD966', borderRadius: '16px', overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '400px' }}>
              <img src="/images/condizionatore/specifiche.webp" alt="Tehnički parametri Air Wave Smart" style={{ width: '100%', height: '100%', objectFit: 'contain' }} />
            </div>
          </div>
        </div>
      </section>
        ...
        <div style={{ maxWidth: '900px', margin: '0 auto' }}>
          ...
          <div style={{ background: 'linear-gradient(135deg, #FFF4E6, #FFE8CC)', borderRadius: '16px', padding: '2rem', border: '1px solid #FFDAA3' }}>
            <div className="include-grid">
              <img src="/images/condizionatore/include.webp" alt="Kompletan paket Air Wave Smart" className="include-img" />
              <div className="include-list">
                 {[
                    "1× aparat Air Wave Smart™ 12 000 BTU",
                    "1× Daljinski upravljač s baterijama u kompletu",
                    "1× Komplet za zidnu montažu",
                    "2× Zamjenski HEPA filteri (za 2 godine)",
                    "Korisnički priručnik + jamstvo 24 mjeseca",
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div style={{ position: 'relative', maxWidth: '900px', margin: '0 auto 2rem' }}>
            <div id="reviewsSlider" style={{ overflow: 'hidden', borderRadius: '12px' }}>
              <div id="reviewsTrack" style={{ display: 'flex', transition: 'transform 0.5s ease', transform: `translateX(-${currentReview * 100}%)` }}>
                {[
                    { t: 'Konačno stvarno šteđim', d: 'Koristim ga otprilike 2 mjeseca i moram reći da su računi značajno pali. Ranije sam sa starom klimom plaćao puno, sada značajno manje. Dobro grije i radi odlično.', a: 'Marko K.', stars: 5 },
                    { t: 'Munjevita isporuka!', d: 'Naručio sam u ponedjeljak, stiglo je u srijedu. Kurir također pristojan. Proizvod izvrstan, sam sam instalirao na zid bez pozivanja ikoga. Radi dobro i brzo zagrije sobu.', a: 'Ivan W.', stars: 5 },
                    { t: 'Sjajan za spavaću sobu', d: 'Instalirao sam u spavaćoj sobi i gotovo se ne čuje, jedva ga primjećujem. Sa starim nisam mogao spavati, a ovaj je savršen. Također malo troši struju.', a: 'Ana M.', stars: 5 },
                    { t: 'Zasad je dobro', d: 'Vrlo sam zadovoljna, brzo zagrije i kuća ostaje topla. Ne znam kako sam se snalazila ranije s grijalicama koje su se grijale satima. Ovo je potpuno druga liga. Dajem 4 zvjezdice, vidjet ću kako će biti dalje.', a: 'Katarina P.', stars: 4 },
                    { t: 'Laka montaža', d: 'Ja i moj sin smo ga instalirali za pola sata, ima vijke i sve, dovoljno je obesiti i odmah radi. Ne treba tehničar i štediš i te novce. Super.', a: 'Roberto S.', stars: 5 },
                    { t: 'Ekspresna dostava', d: 'Stiglo je za 2 dana, uredno zapakirano. Kurir mi je čak pomogao unijeti na kat jer živim na trećem bez lifta! Proizvod izvrstan, grije izvrsno i troši malo u usporedbi sa starim.', a: 'Monika B.', stars: 5 },
                    { t: 'Odličan omjer kvalitete i cijene', d: 'Po ovoj cijeni je stvarno odličan. Zagrijava i hladi, ja koristim pretežno zimi i temperatura je uvijek onakva kakvu trebam. Neću se vratiti na stari.', a: 'Luka D.', stars: 5 },
                    { t: 'Stan uvijek topao', d: 'Kupio sam za dnevnu sobu koja ima oko 50 m² i zagrije sve. Čak i kad je vani hladno, za 10 minuta stan je topao. Troši značajno manje od starog i vidi se to na fakturama.', a: 'Marija G.', stars: 5 },
                    { t: 'Brza isporuka i odličan proizvod', d: 'Naručio sam u utorak, primio u četvrtak, kurir na vrijeme. Proizvod je izvrstan, zagrijava i hladi, koristim ga cijelu godinu. Vrlo tih i lak za korištenje čak i za mene koji se ne snalazim.', a: 'Antonio C.', stars: 5 },
                    { t: 'Stvarno oduševljena', d: 'Bojala sam se naručivati preko interneta ali sve je stiglo savršeno za par dana. Radi izvrsno i troši vrlo malo u usporedbi s mojim prethodnim klima uređajem. Računi su se značajno smanjili. Jako sam zadovoljna.', a: 'Stefania L.', stars: 5 }
                ].map((review, i) => (
          ...
          <div style={{ textAlign: 'center', marginTop: '1.5rem' }}>
            <p style={{ color: '#6b7280', fontSize: '0.875rem' }}>
              Sve ocjene možete pogledati na službenoj stranici <strong style={{ color: '#FFB800' }}>Feedaty</strong>.
            </p>
          </div>
            ...
            <div style={{ background: 'white', borderRadius: '16px', padding: '2rem', maxWidth: '500px', width: '90%', margin: '0 auto', boxShadow: '0 20px 60px rgba(0,0,0,0.3)', position: 'relative' }} onClick={e => e.stopPropagation()}>
                ...
                <div style={{ textAlign: 'center' }}>
                    ...
                    <p style={{ color: '#6b7280', fontSize: '0.9375rem', lineHeight: 1.6 }}>
                        Kako bismo spriječili neistinite recenzije, samo kupci koji su kupili ovaj proizvod mogu dodati ocjenu.
                    </p>
      ...
      <section id="ordina" style={{ background: '#1E293B', padding: '5rem 1.5rem', color: 'white', position: 'relative' }}>
        ...
        <div className="checkout-grid" style={{ maxWidth: '1000px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))', gap: '4rem', alignItems: 'start' }}>
          ...
          <div>
            <h2 style={{ fontSize: '1.75rem', fontWeight: 800, marginBottom: '1rem' }}>Ograničena Količina</h2>
            ...
            <div style={{ background: 'rgba(255,255,255,0.05)', padding: '2rem', borderRadius: '24px', border: '1px solid rgba(255,255,255,0.1)' }}>
              <div style={{ display: 'flex', gap: '1rem', marginBottom: '1.5rem', alignItems: 'center' }}>
                <img src="/images/condizionatore/specifiche.webp" alt="Klima uređaj Air Wave Smart proizvod" style={{ width: '80px', height: '80px', borderRadius: '12px', objectFit: 'cover' }} />
                <div>
              ...
              <ul style={{ color: '#cbd5e1', listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ display: 'flex', justifyContent: 'space-between', padding: '0.5rem 0', borderBottom: '1px solid rgba(255,255,255,0.1)' }}>
                  <span>Kataložna cijena</span> <span style={{ textDecoration: 'line-through' }}>199 €</span>
                </li>
                <li style={{ display: 'flex', justifyContent: 'space-between', padding: '0.5rem 0', borderBottom: '1px solid rgba(255,255,255,0.1)' }}>
                  <span>Black Friday popust</span> <span style={{ color: '#FFB800' }}>-100 €</span>
                </li>
                <li style={{ display: 'flex', justifyContent: 'space-between', padding: '0.5rem 0', borderBottom: '1px solid rgba(255,255,255,0.1)' }}>
                  <span>Isporuka</span> <span style={{ color: '#4ADE80' }}>BESPLATNO</span>
                </li>
                <li style={{ display: 'flex', justifyContent: 'space-between', padding: '1rem 0', fontSize: '1.25rem', fontWeight: 700, color: 'white' }}>
                  <span>Zbroj</span> <span>99 €</span>
                </li>
              </ul>
          ...
          <div style={{ background: 'white', borderRadius: '24px', padding: '2.5rem', color: '#1E293B' }}>
            <div style={{ marginBottom: '1.5rem', textAlign: 'center' }}>
              <h3 style={{ fontSize: '1.5rem', fontWeight: 800 }}>Sigurna Transakcija</h3>
              <p style={{ color: '#64748b', fontSize: '0.9rem' }}>Bez akontacije.</p>
            </div>
            ...
            <form onSubmit={handleFormSubmit} style={{ display: 'grid', gap: '1rem' }}>
              ...
              <div>
                <label style={{ fontSize: '0.8rem', fontWeight: 700, color: '#64748b', marginBottom: '4px', display: 'block' }}>IME TE PREZIME</label>
              ...
              <div>
                <label style={{ fontSize: '0.8rem', fontWeight: 700, color: '#64748b', marginBottom: '4px', display: 'block' }}>KOMPLETNA ADRESA</label>
              ...
              <div style={{ margin: '1rem 0', padding: '1.5rem', background: '#F8FAFC', border: '2px solid #E2E8F0', borderRadius: '12px' }}>
                <div style={{ display: 'grid', gap: '0.75rem' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                    ...
                    <span style={{ fontSize: '0.9rem', color: '#1E293B', fontWeight: 600 }}>Plaćanje pri isporuci</span>
                  </div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                    ...
                    <span style={{ fontSize: '0.9rem', color: '#1E293B', fontWeight: 600 }}>Besplatna isporuka 24-48h</span>
                  </div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
          ...
          <div className="sticky-info" style={{
            ...
            <div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                <span style={{ fontSize: '1.25rem', fontWeight: 800, color: '#16a34a' }}>99 €</span>
                <span style={{ fontSize: '0.875rem', textDecoration: 'line-through', color: 'white', opacity: 0.8 }}>199 €</span>
              </div>
            </div>
          </div>
          <button
