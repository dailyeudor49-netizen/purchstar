...
export default function LandingPage() {
  ...
  const handleFormSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const postalCodeInput = event.currentTarget.querySelector('input[name="postal-code"]') as HTMLInputElement;
      const postalCode = postalCodeInput?.value || '';
      const addressLevel2Input = event.currentTarget.querySelector('input[name="address-level2"]') as HTMLInputElement;
      ...
      router.push('/ty/ty-fb-airwave-pl-unc');
    } catch (error) {
  ...
  return (
    <>
      ...
      {/* Click Pixel */}
      <img
        src="https://offers.uncappednetwork.com/forms/api/ck/?o=1739&uid=0191dbf2-738a-7d28-82a0-18c3859d5e8f&lp=1759"
