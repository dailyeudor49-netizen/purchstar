    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{
          ...
          Váš Mini 17 Pro Titanium sa pripravuje a čoskoro bude odoslaný.
        </p>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '0.8rem', color: '#1e40af', fontWeight: 600, marginBottom: '0.25rem' }}>KÓD OBJEDNÁVKY</div>
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontWeight: 600, color: '#92400e', fontSize: '0.9rem' }}>Platba na dobierku: 79,99€</div>
        ...
        <div style={{
          ...
          Máte otázky? Napíšte nám: <a href="mailto:info@purchstar.com" style={{ color: '#2563eb', fontWeight: 600, textDecoration: 'none' }}>info@purchstar.com</a>
        </div>
