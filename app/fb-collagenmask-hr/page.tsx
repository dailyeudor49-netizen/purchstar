      ...
      <div className="container mx-auto px-6 relative z-10 pt-6 md:pt-0">
        <div className="max-w-2xl">
          <div className="flex items-center gap-2 mb-6 animate-fade-in-up">
            ...
            <span className="text-gray-600 font-medium tracking-wide text-sm uppercase">Viralna maska 2024. godine</span>
          </div>

          <h1 className="font-serif text-5xl md:text-7xl leading-tight text-gray-900 mb-6 drop-shadow-sm">
            Probudite se s <br />
            <span className="text-rose-600 italic">Novom Kožom.</span>
          </h1>

          <p className="text-xl md:text-2xl text-gray-700 mb-8 leading-relaxed font-light">
            Prva maska s Bio-Kolagenom koja postaje prozirna dok vaša koža upija hranjive tvari. Zbogom proširene pore, dobrodošla „Glass Skin".
          </p>

          <div className="flex flex-col sm:flex-row gap-4">
            <Button onClick={scrollToForm} className="text-lg z-20">
              Želim „Glass Skin" ODMAH
            </Button>
            <div className="flex items-center gap-3 text-sm text-gray-500 mt-2 sm:mt-0 px-4 backdrop-blur-sm rounded-lg bg-white/30 border border-white/50 py-2">
              ...
              Ograničena dostupnost: Ostalo samo 12 paketa
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-6 order-2 md:order-1">
            ...
            <h2 className="font-serif text-4xl text-gray-900">
              Gledate se u ogledalo i vidite...
            </h2>
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                <XCircle className="text-red-400 shrink-0 mt-1" />
                <span className="text-lg text-gray-600">Blijedu, sivu i beživotnu kožu unatoč kremama.</span>
              </li>
              <li className="flex items-start gap-3">
                <XCircle className="text-red-400 shrink-0 mt-1" />
                <span className="text-lg text-gray-600">Proširene pore koje čak ni puder ne može sakriti.</span>
              </li>
              <li className="flex items-start gap-3">
                <XCircle className="text-red-400 shrink-0 mt-1" />
                <span className="text-lg text-gray-600">Znakove dehidracije i prve bore vidljive ujutro.</span>
              </li>
              <li className="flex items-start gap-3">
                <XCircle className="text-red-400 shrink-0 mt-1" />
                <span className="text-lg text-gray-600">Frustraciju zbog potrošenih stotina eura na beskorisne proizvode.</span>
              </li>
            </ul>
            ...
            <div className="mt-8">
              <div className="relative rounded-2xl overflow-hidden shadow-xl">
                ...
                <div className="absolute bottom-4 left-4 bg-white/90 backdrop-blur px-4 py-2 rounded-full text-sm font-bold text-rose-700">
                  Stvarni rezultati nakon 1 primjene
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="relative bg-white rounded-2xl shadow-xl border border-rose-50 overflow-hidden">
              <div className="p-4 bg-rose-50/50 relative">
                <img
                  ...
                  alt="Bio-Collagen Mask u akciji"
              ...
              <div className="p-8">
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">
                  Ovo nije obična maska u maramici. To je učvršćeni hidrogel koji sadrži <strong>kolagen ultra-niske molekularne mase</strong> koji prodire tamo gdje druge kreme ne mogu.
                </p>
                ...
                <div className="space-y-4 mb-8">
                   <div className="flex items-center gap-3 p-3 bg-rose-50 rounded-lg border border-rose-100/50">
                      ...
                      <span className="font-medium text-rose-900">Duboka penetracija (3-4 sata)</span>
                   </div>
                   <div className="flex items-center gap-3 p-3 bg-rose-50 rounded-lg border border-rose-100/50">
                      <CheckCircle2 className="text-rose-600" />
                      <span className="font-medium text-rose-900">Trenutno sužavanje pora</span>
                   </div>
                   <div className="flex items-center gap-3 p-3 bg-rose-50 rounded-lg border border-rose-100/50">
                      <CheckCircle2 className="text-rose-600" />
                      <span className="font-medium text-rose-900">Lifting efekt nakon buđenja</span>
                   </div>
                </div>

                <p className="text-sm text-center text-gray-400 italic">
                  Maska postaje prozirna kada završi s djelovanjem.
                </p>
              </div>
            </div>
          </div>
  ...
  const features = [
    {
      ...
      title: "Duboka Hidratacija",
      desc: "Hijaluronska kiselina niske molekularne mase hidratizira slojeve do kojih kreme ne dopiru."
    },
    {
      icon: <Clock className="w-8 h-8 text-rose-500" />,
      title: "Noćni Efekt",
      desc: "Nosite je dok spavate. Ujutro je maska prozirna: sve je apsorbirano."
    },
    {
      icon: <ShieldCheck className="w-8 h-8 text-rose-500" />,
      title: "Ojačana Barijera",
      desc: "Obnavlja oštećenu kožnu barijeru nakon samo jedne primjene."
    },
    {
      icon: <Sparkles className="w-8 h-8 text-rose-500" />,
      title: "Nevidljive Pore",
      desc: "Sužava proširene pore za 40% nakon prve uporabe (Klinička ispitivanja)."
    }
  ];
    ...
    <section className="py-20 bg-rose-50">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="font-serif text-3xl md:text-5xl text-gray-900 mb-4">Znanost Ljepote</h2>
          <p className="text-gray-600 max-w-2xl mx-auto">Zašto tisuće žena napuštaju tradicionalne maske.</p>
        </div>
...
const GeminiConsultant = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setResponse(`Za vaš problem "${input}", Bio-Collagen Mask je idealna jer hidrolizirani kolagen od 243 Daltona prodire točno tamo gdje vaša koža ima nedostatke, vraćajući elastičnost i sužavajući pore za trenutni učinak.`);
    ...
    <section className="py-16 bg-gradient-to-r from-gray-900 to-gray-800 text-white">
      <div className="container mx-auto px-6 text-center max-w-3xl">
        <div className="inline-flex items-center gap-2 bg-white/10 px-4 py-2 rounded-full text-rose-200 text-sm font-semibold tracking-wider mb-6">
          <Sparkles size={16} />
          <span>AI KONZULTANT ZA LJEPOTU</span>
        </div>

        <h2 className="font-serif text-3xl md:text-4xl mb-4">
          Imate pitanja? Pitajte Virtualnog Stručnjaka
        </h2>
        <p className="text-gray-300 mb-8">
          Opišite svoj glavni problem (npr. „Imam vrlo suhu kožu i proširene pore na nosu") i otkrijte zašto će ova maska promijeniti vašu rutinu njege.
        </p>
        ...
        <form onSubmit={handleSubmit} className="relative max-w-xl mx-auto mb-8">
          <input
            ...
            placeholder="Upišite ovdje svoju nesavršenost..."
...
const Testimonials = () => {
  const reviews = [
    {
      name: "Katarina M.",
      role: "Verificirana Kupac",
      content: "Bila sam skeptična prema TikToku, ali wow. Držala sam je cijelu noć. Ujutro je bila prozirna, a moja koža izgledala kao staklo. Nikad nisam vidjela ništa slično.",
      rating: 5
    },
    {
      name: "Ana R.",
      role: "Vizažistica",
      content: "Koristim je na mladenkama večer prije vjenčanja. Puder klizi, pore su nestale. To je moja profesionalna tajna.",
      rating: 5
    },
    {
      name: "Sofija L.",
      role: "Zaposlena Mama",
      content: "Imam 42 godine i suhu kožu. Nakon paketa od 4 komada, moje prijateljice su me pitale jesam li radila botoks. Nevjerojatno.",
      rating: 5
    }
  ];
    ...
    <section className="py-20 bg-white overflow-hidden">
      <div className="container mx-auto px-6">
        <h2 className="font-serif text-3xl md:text-5xl text-center text-gray-900 mb-16">
          Što kažu <br /> <span className="text-rose-600 italic">prave žene</span>
        </h2>
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        window.location.href = '/ty/ty-collagen-hr';
      } else {
      ...
      setErrorMessage('Došlo je do greške prilikom slanja narudžbe. Pokušajte ponovo.');
    }
  };
      ...
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row">
          ...
          <div className="md:w-5/12 bg-gray-900 text-white p-8 md:p-12 flex flex-col justify-between">
            <div>
              <h3 className="font-serif text-2xl mb-2">Vaša narudžba</h3>
              ...
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-rose-300 text-sm">Paket od 4 komada (Kompletni tretman)</p>
                </div>
              </div>

              <div className="space-y-3 border-t border-gray-700 pt-6">
                <div className="flex justify-between">
                  <span className="text-gray-400">Redovna Cijena</span>
                  <span className="line-through text-gray-500">59,99 €</span>
                </div>
                <div className="flex justify-between font-bold text-xl items-center">
                  <span>Današnja Ponuda</span>
            ...
            <div className="mt-8 space-y-3 text-sm text-gray-400">
              <div className="flex items-center gap-2">
                <Truck size={16} className="text-rose-400" /> Besplatna Ekspresna Dostava
              </div>
              <div className="flex items-center gap-2">
                <Shield size={16} className="text-rose-400" /> Jamstvo Zadovoljstva ili Povrat Novca
              </div>
              <div className="flex items-center gap-2">
                <CreditCard size={16} className="text-rose-400" /> Plaćanje Pouzećem
              </div>
            </div>
          </div>

          <div className="md:w-7/12 p-8 md:p-12">
            <h2 className="font-serif text-2xl text-gray-900 mb-6">Kamo poslati pošiljku?</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                 <label className="block text-sm font-medium text-gray-700 mb-1">Telefon (za dostavljača)</label>
                 <input required type="tel" name="phone" value={formData.phone} onChange={handleChange} className="w-full p-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-rose-500 outline-none" placeholder="+385 91 234 5678" />
              </div>

              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Adresa</label>
                <input required name="address" value={formData.address} onChange={handleChange} className="w-full p-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-rose-500 outline-none" placeholder="Ilica 10" />
              </div>

              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Grad</label>
                  <input required name="city" value={formData.city} onChange={handleChange} className="w-full p-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-rose-500 outline-none" placeholder="Zagreb" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Poštanski Broj</label>
                  <input required name="zipCode" value={formData.zipCode} onChange={handleChange} className="w-full p-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-rose-500 outline-none" placeholder="10000" />
                </div>
              </div>
              ...
              <div className="pt-4">
                <Button
                  ...
                  className="text-lg"
                >
                  {status === FormStatus.SUBMITTING ? 'Obrada...' : 'Naruči - Plaćanje Pouzećem'}
                </Button>
                <p className="text-center text-xs text-gray-400 mt-4">
                  Klikom potvrđujete da ste pročitali Politiku Privatnosti. Vaši podaci su sigurni.
                </p>
              </div>
            </form>
          </div>
  ...
  return (
    <div className="min-h-screen font-sans text-gray-800 selection:bg-rose-200 selection:text-rose-900 pb-24 md:pb-0">
      ...
      <div className="bg-rose-600 text-white py-3 text-center font-medium animate-pulse px-4">
        Pozor: Zbog velike potražnje s TikToka, zalihe se smanjuju.
      </div>
      ...
      <footer className="bg-gray-900 text-gray-400 py-12 text-sm mb-20 md:mb-0">
        <div className="container mx-auto px-6 text-center">
          <p className="mb-4">&copy; 2024 BioCollagen Distribution Hrvatska. Sva prava pridržana.</p>
          ...
          <p className="mt-8 text-xs text-gray-600 max-w-lg mx-auto">
            Ova stranica nije dio Facebook stranice niti Facebook Inc. Također, ova stranica nije podržana od strane Facebooka ni na koji način. FACEBOOK je zaštićeni znak FACEBOOK, Inc.
          </p>
        </div>
      </footer>
    </div>
