    ...
    <main className="min-h-screen bg-[#050505] text-white flex flex-col items-center justify-center px-6 py-20">
      ...
      <div className="text-center max-w-2xl">
        <h1 className="text-4xl md:text-6xl font-orbitron font-black mb-6 tracking-tighter">
          DĚKUJEME ZA<br />
          <span className="text-gradient">OBJEDNÁVKU!</span>
        </h1>

        <p className="text-xl text-gray-300 mb-8 leading-relaxed">
          Vaše objednávka <span className="text-white font-bold">TitanGo Ultra</span> byla úspěšně přijata.
          Náš tým vás brzy kontaktuje pro potvrzení detailů.
        </p>
        ...
        <div className="bg-white/5 backdrop-blur-lg rounded-3xl p-8 border border-white/10 mb-10">
          <div className="flex items-center justify-center gap-4 mb-6">
            ...
            <div className="text-left">
              ...
              <p className="text-green-500 font-black text-2xl mt-1">1 749 Kč</p>
            </div>
          </div>
          ...
          <div className="border-t border-white/10 pt-6 space-y-4">
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="text-white font-bold">Dobírka</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-gray-400">Předpokládané doručení:</span>
              <span className="text-blue-400 font-bold">1-3 pracovní dny</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-blue-600/10 border border-blue-500/30 rounded-2xl p-6 mb-10">
          ...
          <ul className="text-left space-y-3 text-sm text-gray-300">
            <li className="flex items-start gap-3">
              ...
              <span>Náš konzultant vám zavolá <span className="text-white font-semibold">do 24 hodin</span> pro potvrzení objednávky</span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>Obdržíte SMS s <span className="text-white font-semibold">odkazem na sledování zásilky</span></span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>Zaplatíte kurýrovi <span className="text-white font-semibold">1 749 Kč při převzetí</span></span>
            </li>
          </ul>
        </div>
        ...
        <div className="text-center text-gray-400 text-sm mb-10">
          ...
          <p className="text-white font-bold mt-2">support@titango-ultra.cz</p>
        </div>
      ...
      <footer className="mt-20 text-center text-gray-600 text-xs">
        <p>TitanGo Ultra - Prémiová Přenosná Herní Konzole</p>
        <p className="mt-2">© 2026 Všechna práva vyhrazena</p>
      </footer>
    </main>
  );
}
