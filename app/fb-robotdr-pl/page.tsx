  ...
  const features = [
    {
      ...
      bg: "bg-blue-500",
      title: "2-w-1: Odkurza i Mopuje",
      desc: "Cyklonowy silnik zbiera kurz, podczas gdy mikrofibra usuwa uporczywe plamy. Jeden przejazd, podwójny efekt."
    },
    {
      icon: <Navigation className="w-8 h-8 text-white" />,
      bg: "bg-purple-500",
      title: "Smart Nawigacja 3.0",
      desc: "Nie spada ze schodów i nie uderza mocno. Czujniki IR mapują pomieszczenie, omijają przeszkody i sprzątają pod łóżkami i kanapami."
    },
    {
      icon: <Smartphone className="w-8 h-8 text-white" />,
      bg: "bg-green-500",
      title: "Pełna Kontrola",
      desc: "Użyj pilota lub dołączonej aplikacji. Uruchom sprzątanie z biura i wróć do lśniącego domu."
    },
    {
    ...
    },
    {
       ...
       bg: "bg-red-500",
       title: "Filtr HEPA",
       desc: "Wychwytuje 99,9% alergenów i drobnego kurzu. Idealny dla alergików i właścicieli zwierząt."
    }
  ];
        ...
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="w-full md:w-1/2">
            ...
            <p className="text-gray-400 text-lg mb-8 leading-relaxed">
              Dobrze czytasz. Nie płacisz dodatkowo. <strong>NovaStation™ Omni All-in-One</strong> jest w podstawowym zestawie. Robot sam wraca, opróżnia się i czyści.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="bg-white/5 border border-white/10 p-4 rounded-xl hover:bg-white/10 transition duration-300">
                ...
                <p className="text-gray-400 text-sm">Wysysa brud z robota do zamkniętego worka 3L (wystarcza na 2 miesiące).</p>
              </div>

              <div className="bg-white/5 border border-white/10 p-4 rounded-xl hover:bg-white/10 transition duration-300">
                <Droplets className="text-blue-500 mb-3 w-8 h-8" />
                <h4 className="font-bold text-lg mb-1">Wymiana Wody i Mycie</h4>
                <p className="text-gray-400 text-sm">Myje brudne ściereczki i uzupełnia zbiornik robota czystą wodą.</p>
              </div>

              <div className="bg-white/5 border border-white/10 p-4 rounded-xl hover:bg-white/10 transition duration-300">
                <Wind className="text-gray-300 mb-3 w-8 h-8" />
                <h4 className="font-bold text-lg mb-1">Suszenie Ciepłem</h4>
                <p className="text-gray-400 text-sm">Suszy mop w 45°C, zapobiegając pleśni i nieprzyjemnym zapachom.</p>
              </div>

              <div className="bg-white/5 border border-white/10 p-4 rounded-xl hover:bg-white/10 transition duration-300">
                <Zap className="text-yellow-400 mb-3 w-8 h-8" />
                <h4 className="font-bold text-lg mb-1">Ładowanie +30%</h4>
                <p className="text-gray-400 text-sm">Inteligentne szybkie ładowanie dla szybszego powrotu do pracy.</p>
              </div>
            </div>
          </div>
          ...
          <div className="w-full md:w-1/2 relative">
             ...
             <div className="absolute -bottom-6 -left-6 bg-white text-gray-900 p-4 rounded-xl shadow-xl z-20 border-l-4 border-orange-500 max-w-xs hidden md:block">
                <div className="font-bold uppercase text-xs text-gray-500">Wartość 799 PLN</div>
                <div className="font-black text-xl text-orange-500">GRATIS DZISIAJ</div>
             </div>
          </div>
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <ReviewCard
            ...
            flag="🇵🇱"
            date="2 dni temu"
            text="Szczerze mówiąc, byłam sceptyczna ze względu na cenę. Ale odkurza lepiej niż mój stary iRobot za 1800 zł. Sierść psa już nie jest problemem."
          />
          <ReviewCard
            name="Marcin Nowak"
            country="Polska"
            flag="🇵🇱"
            date="tydzień temu"
            text="Dotarł w 24 godziny. Mopowanie nie jest tak dokładne jak ręczne, ale do codziennego utrzymania czystości jest idealny. Polecam!"
          />
          <ReviewCard
            ...
            flag="🇵🇱"
            date="3 dni temu"
            text="Bateria trzyma wieki. Sprząta całe moje 80m² mieszkanie i jeszcze zostaje naładowania. Najlepszy zakup roku dla żony (i dla mnie)."
          />
        </div>
      </div>
    </section>
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <SpecItem
            ...
            label="Siła Ssania"
            value="6000 Pa"
            detail="Silnik bezszczotkowy Nidec™ (Japonia)"
          />
          <SpecItem
          ...
          <SpecItem
            ...
            value="20 mm"
            detail="Terenowe antypoślizgowe koła"
          />
          <SpecItem
            icon={<Shield size={24} />}
            label="Filtracja"
            value="HEPA H13"
            detail="Wychwytuje 99,97% mikrocząstek"
          />
        </div>
        ...
        <div className="flex flex-col md:flex-row items-center gap-8">
          ...
          <div className="text-center md:text-left flex-1">
            ...
            <p className="text-gray-700 mb-6 text-lg leading-relaxed">
              Wiemy, że zakupy online mogą być stresujące. Dlatego dajemy Ci <span className="font-bold">30 dni</span> na przetestowanie NovaClean X1 w domu. Jeśli nie sprząta tak, jak obiecujemy, lub po prostu nie podoba Ci się kolor, odbieramy go i zwracamy każdą złotówkę.
            </p>
  ...
  const faqs = [
    {
      ...
      answer: "Absolutnie tak. Centralna szczotka w kształcie litery V i silne cyklonowe ssanie są specjalnie zaprojektowane do zbierania sierści psów i kotów bez plątania."
    },
    {
      question: "Gdzie znajdę części zamienne?",
      answer: "Oferujemy zestawy części zamiennych (szczotki, filtry HEPA, ściereczki) bezpośrednio na naszej stronie w cenach fabrycznych. Ponadto komponenty są uniwersalne i łatwo dostępne."
    },
    {
      question: "Czy gwarancja obejmuje awarie?",
      answer: "Tak, oferujemy 2-letnią Gwarancję Bezpośrednią. Jeśli robot ma wadę techniczną, wymieniamy go bezpłatnie na nowy. 100% polskie wsparcie."
    },
    {
      question: "Jak działa płatność za pobraniem?",
      answer: "To bardzo proste. Zamawiasz teraz wypełniając formularz, nic nie płacisz online. Płacisz gotówką bezpośrednio kurierowi przy dostawie paczki (zwykle w ciągu 24/48 godzin)."
    },
    {
      question: "Czy potrzebuje WiFi do działania?",
      answer: "Nie! Robot działa doskonale po prostu naciskając przycisk 'Start' lub za pomocą dołączonego pilota. Aplikacja WiFi to opcjonalny dodatek dla tych, którzy chcą go programować z dala od domu."
    }
  ];
...
const OrderForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      router.push('/ty/ty-fb-robotdr-pl');
    } catch (error) {
      ...
      <div className="max-w-xl mx-auto bg-white rounded-3xl shadow-2xl overflow-hidden border-4 border-orange-500 relative">
        ...
        <div className="bg-white p-6 md:p-8">
          <div className="text-center mb-6">
            ...
            <p className="text-gray-500">Wypełnij poniżej, aby otrzymać kompletny zestaw.</p>
          </div>

          <div className="bg-orange-50 rounded-xl border-2 border-orange-500 p-5 mb-8 relative overflow-hidden">
             <div className="absolute top-0 right-0 bg-orange-500 text-white text-xs font-bold px-3 py-1 rounded-bl-lg">OFERTA LIMITOWANA</div>
             ...
             <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                   <h4 className="font-black text-xl text-gray-900">ZESTAW NovaClean X1</h4>
             ...
             <div className="flex justify-between items-end border-t-2 border-orange-200 mt-3 pt-2">
                <div className="text-xs text-gray-500 font-medium">Do zapłaty<br/>przy dostawie:</div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="block text-xs font-bold text-gray-500 uppercase mb-1 ml-1">Adres (Ulica i Numer)</label>
              <input
                type="text"
                name="address"
                required
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-xs font-bold text-gray-500 uppercase mb-1 ml-1">Kod Pocztowy</label>
                <input
                  type="text"
                  name="postalCode"
                  required
              ...
              <div>
                <label className="block text-xs font-bold text-gray-500 uppercase mb-1 ml-1">Miasto</label>
                <input
                  type="text"
                  name="city"
                  required
            ...
            <div className="mt-6 border-2 border-green-500 bg-green-50 rounded-xl p-4 flex items-center justify-between cursor-pointer relative">
               ...
               <div className="flex items-center gap-3">
                  ...
                  <span className="font-bold text-gray-800">Płatność za Pobraniem</span>
               </div>
  ...
  return (
    <>
      ...
      <main>
        <div className="relative bg-[#111] text-white pt-10 pb-20 px-4 overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto text-center relative z-10">
            ...
            <p className="text-lg md:text-xl text-gray-300 mb-8 max-w-2xl mx-auto leading-relaxed">
              Robot, który Odkurza, Mopuje i <span className="text-white font-bold underline decoration-orange-500">Sam się Opróżnia</span>. Technologia za 3500 zł, dziś za cenę kolacji.
            </p>
            ...
            <div className="mb-8 relative group perspective-1000">
              ...
              <div className="absolute top-4 right-4 md:-right-4 bg-white text-gray-900 p-4 rounded-xl shadow-2xl transform rotate-3 border-4 border-orange-500 z-30">
                <div className="text-xs text-gray-500 font-bold uppercase">Wartość Zestawu 1598 PLN</div>
                <div className="text-sm text-gray-500">Cena regularna <span className="line-through text-gray-400 decoration-red-500 decoration-2">799 PLN</span></div>
            ...
            <div className="mt-6 flex flex-wrap justify-center gap-4 text-sm text-gray-400">
               <span className="flex items-center gap-1"><CheckCircle size={16} className="text-orange-500" /> Płatność za Pobraniem</span>
        ...
        <section className="py-16 px-4 bg-white border-t border-gray-100">
           <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold text-center mb-8">Co dostajesz za tylko 339 PLN?</h2>
              <div className="bg-gray-50 rounded-2xl p-8 border border-gray-200 flex flex-col md:flex-row items-center gap-8">
                 <div className="w-full md:w-1/2 relative">
                    ...
                    <img src="/images/robot-asp/1.webp" className="rounded-xl shadow-lg w-full" alt="Zawartość zestawu" />
                 </div>
                 <div className="w-full md:w-1/2">
                    ...
                    <ul className="space-y-3">
                       <li className="flex items-center gap-2 p-2 bg-orange-50 rounded-lg shadow-sm border border-orange-200">
                          ...
                          <span className="font-bold">1x NovaStation™ Omni (Wartość 799 PLN)</span>
                       </li>
                    ...
                    <div className="mt-4 text-xs text-gray-500 bg-yellow-50 p-2 rounded border border-yellow-200 inline-block">
                       🎁 BONUS: Dostawa Express z Ubezpieczeniem (Gratis)
                    </div>
                 </div>
              </div>
           </div>
            ...
            <div className="bg-white/5 backdrop-blur-sm p-6 rounded-2xl border border-white/10">
               <div className="flex flex-col md:grid md:grid-cols-5 gap-4 items-center justify-center">
                  ...
                  <div className="col-span-2 w-full">
                     ...
                     <div className="mt-2 text-red-400 font-bold text-xl">2200 - 4000 PLN</div>
                  </div>
