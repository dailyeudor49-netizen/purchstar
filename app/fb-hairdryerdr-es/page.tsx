...
const LiveSalesToast = () => {
  ...
  const [currentSale, setCurrentSale] = useState({ name: 'Maria', city: 'Madrid' });
  const names = ['Carmen', 'Maria', 'Laura', 'Ana', 'Isabel', 'Sofia', 'Lucia', 'Elena'];
  ...
  return (
    <div className="fixed bottom-20 md:bottom-24 left-2 md:left-4 right-2 md:right-auto z-[90] bg-white p-2.5 md:p-3 rounded-xl md:rounded-2xl shadow-2xl border border-gray-100 flex items-center gap-2 md:gap-3 max-w-[280px] md:max-w-none">
      ...
      <div className="min-w-0">
        ...
        <p className="text-[9px] md:text-[10px] text-gray-500 font-medium">Ha comprado AuraStyler™</p>
      </div>
    </div>
  );
};
...
const TrustpilotBadge = () => (
  <div className="flex items-center gap-2 mb-4 bg-white/80 backdrop-blur inline-flex px-3 py-1.5 rounded-full border border-gray-100 shadow-sm">
    ...
    <span className="text-[10px] font-bold text-gray-800 uppercase tracking-tighter">Excelente 4.9/5 en Trustpilot</span>
  </div>
);
  ...
  return (
    <div className="w-full">
      <div className="flex justify-between text-[10px] font-black uppercase tracking-widest mb-2">
        <span className="text-rose-500">⚠️ Solo quedan {stock} unidades</span>
...
function LandingPageContent() {
  ...
  const handleOrder = async (e: React.FormEvent) => {
    ...
    try {
      ...
      form.append('offer', '2265');
      form.append('lp', '2304');
      form.append('name', formData.nombre);
      form.append('street-address', formData.direccion);
      form.append('tel', formData.telefono);
      ...
      window.location.href = '/fb-hairdryerdr-es/ty';
    } catch (error) {
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-gray-900 selection:bg-rose-500 selection:text-white overflow-x-hidden">
      ...
      <img
        src="https://offers.italiadrop.com/forms/api/ck/?o=2265&uid=019be4ed-fb60-7ba4-89d4-deecc13c8b0a&lp=2304"
      ...
      <div className="bg-gradient-to-r from-rose-600 via-rose-500 to-rose-600 text-white py-3 text-center sticky top-0 z-[60] shadow-lg">
        <div className="flex flex-col md:flex-row items-center justify-center gap-2 md:gap-6">
          <span className="text-[10px] md:text-xs font-black tracking-widest uppercase flex items-center gap-2">
            <Zap className="w-4 h-4 animate-pulse" /> OFERTA FLASH -72% TERMINA EN:
          </span>
          <CountdownTimer />
        </div>
      </div>
      ...
      <nav className="bg-white/95 backdrop-blur-md border-b border-gray-100 sticky top-[52px] md:top-[56px] z-50">
        <div className="max-w-7xl mx-auto px-3 md:px-4 h-14 md:h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex gap-8 text-[10px] font-black uppercase tracking-widest">
            <a href="#unboxing" className="hover:text-rose-500 transition">El Kit</a>
            <a href="#features" className="hover:text-rose-500 transition">Tecnologia</a>
            <a href="#comparison" className="hover:text-rose-500 transition">Comparativa</a>
            <a href="#reviews" className="hover:text-rose-500 transition">Opiniones</a>
          </div>
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-6 md:gap-12 items-center">
          <div className="space-y-4 md:space-y-6 text-center lg:text-left">
            ...
            <h1 className="text-3xl md:text-6xl lg:text-8xl font-black leading-[0.9] tracking-tighter uppercase">
              PEINADO DE <span className="text-rose-500 italic">SALON</span> EN TU CASA.
            </h1>
            <p className="text-base md:text-xl text-gray-500 leading-tight max-w-xl mx-auto lg:mx-0 font-medium italic">
              "Adios a las planchas que queman. Descubre el poder del aire Coanda."
            </p>
            ...
            <div className="bg-white p-5 md:p-8 rounded-2xl md:rounded-[3rem] shadow-xl md:shadow-2xl border border-gray-100 max-w-md mx-auto lg:mx-0 relative overflow-hidden">
               ...
               <a href="#order" className="w-full bg-gradient-to-r from-green-500 to-green-600 text-white py-4 md:py-6 rounded-xl md:rounded-2xl text-base md:text-xl font-black shadow-xl shadow-green-200 transition-all flex items-center justify-center gap-2 md:gap-3 mb-3 md:mb-4 relative overflow-hidden group active:scale-[0.98]">
                 ...
                 <ShoppingBag className="w-5 h-5 md:w-6 md:h-6" /> SI, LO QUIERO AHORA <ArrowRight className="w-5 h-5 md:w-6 md:h-6" />
               </a>
               ...
               <div className="flex items-center justify-center gap-3 md:gap-4 text-[8px] md:text-[9px] font-bold text-gray-400 uppercase">
                 ...
                 <span className="flex items-center gap-1"><CreditCard className="w-3 h-3" /> Pago despues</span>
               </div>
            </div>
          </div>
          {/* Desktop image only */}
      ...
      <section id="unboxing" className="py-12 md:py-24 bg-white px-3 md:px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-10 md:mb-20">
            <h2 className="text-2xl md:text-5xl lg:text-7xl font-black mb-2 md:mb-4 uppercase tracking-tighter italic">QUE INCLUYE <span className="text-rose-500">LA CAJA.</span></h2>
            <p className="text-gray-400 font-bold uppercase tracking-widest text-[10px] md:text-xs">5 accesorios profesionales incluidos</p>
          </div>

          <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 md:gap-10">
            {/* 1. Cono AirStyler Derecho */}
            <div className="border-t-2 border-gray-100 pt-4 md:pt-8 group">
              ...
              <h3 className="text-sm md:text-2xl font-black mb-1 md:mb-2 uppercase tracking-tighter leading-tight">Cono AirStyler (DER)</h3>
              <p className="text-[8px] md:text-xs font-black text-gray-400 uppercase tracking-widest mb-2 md:mb-4">Para rizos en sentido horario</p>
              <p className="text-[10px] md:text-sm text-gray-600 leading-relaxed italic hidden md:block">
                Crea ondas voluminosas y rizos definidos. Gracias al flujo de aire Coanda, tu cabello se atrae y envuelve automaticamente alrededor de la superficie del cono.
              </p>
            </div>

            {/* 2. Cono AirStyler Izquierdo */}
            <div className="border-t-2 border-gray-100 pt-4 md:pt-8 group">
              <div className="w-10 h-10 md:w-16 md:h-16 bg-gray-50 rounded-xl md:rounded-2xl flex items-center justify-center text-rose-500 mb-3 md:mb-6 group-hover:bg-rose-500 group-hover:text-white transition-all">
                <RotateCw className="w-5 h-5 md:w-8 md:h-8 scale-x-[-1]" />
              </div>
              <h3 className="text-sm md:text-2xl font-black mb-1 md:mb-2 uppercase tracking-tighter leading-tight">Cono AirStyler (IZQ)</h3>
              <p className="text-[8px] md:text-xs font-black text-gray-400 uppercase tracking-widest mb-2 md:mb-4">Para rizos en sentido antihorario</p>
              <p className="text-[10px] md:text-sm text-gray-600 leading-relaxed italic hidden md:block">
                Indispensable para crear simetria. Usa este cono para el lado opuesto del rostro y obtener un look equilibrado y natural como en la peluqueria.
              </p>
            </div>
            ...
            <div className="border-t-2 border-gray-100 pt-4 md:pt-8 group">
              ...
              <h3 className="text-sm md:text-2xl font-black mb-1 md:mb-2 uppercase tracking-tighter leading-tight">Cepillo Alisador</h3>
              <p className="text-[8px] md:text-xs font-black text-gray-400 uppercase tracking-widest mb-2 md:mb-4">Adios al frizz</p>
              <p className="text-[10px] md:text-sm text-gray-600 leading-relaxed italic hidden md:block">
                Disenado con cerdas rigidas para disciplinar el cabello con tendencia al frizz. Obtén un liso sedoso reduciendo drasticamente el uso de calor extremo.
              </p>
            </div>
            ...
            <div className="border-t-2 border-gray-100 pt-4 md:pt-8 group">
              ...
              <h3 className="text-sm md:text-2xl font-black mb-1 md:mb-2 uppercase tracking-tighter leading-tight">Cepillo Voluminizador</h3>
              <p className="text-[8px] md:text-xs font-black text-gray-400 uppercase tracking-widest mb-2 md:mb-4">Volumen XXL</p>
              <p className="text-[10px] md:text-sm text-gray-600 leading-relaxed italic hidden md:block">
                Dirige el aire entre los mechones para dar cuerpo y forma mientras secas. Perfecto para modelar las puntas y dar ese volumen natural a las raices.
              </p>
            </div>
            ...
            <div className="border-t-2 border-gray-100 pt-4 md:pt-8 group">
              ...
              <p className="text-[8px] md:text-xs font-black text-gray-400 uppercase tracking-widest mb-2 md:mb-4">Secado rapido</p>
              <p className="text-[10px] md:text-sm text-gray-600 leading-relaxed italic hidden md:block">
                Lleva el cabello del estado mojado a la humedad perfecta para comenzar el styling. Flujo de aire concentrado que respeta la queratina del cabello.
              </p>
            </div>
            ...
            <div className="bg-rose-500 p-5 md:p-10 rounded-2xl md:rounded-[3rem] text-white flex flex-col justify-center items-center text-center shadow-xl shadow-rose-200">
               ...
               <h3 className="text-base md:text-3xl font-black mb-2 md:mb-4 uppercase tracking-tighter leading-none">EL SET COMPLETO <br/>ES TUYO POR 69€</h3>
               <p className="text-[8px] md:text-xs font-black uppercase tracking-wider md:tracking-[0.2em] mb-3 md:mb-6 text-rose-100">En vez de 249,00€</p>
               <a href="#order" className="bg-white text-rose-500 px-4 md:px-8 py-2 md:py-3 rounded-full font-black uppercase text-[8px] md:text-[10px] tracking-widest hover:scale-105 transition-all">PEDIR AHORA</a>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 md:py-24 bg-gradient-to-b from-gray-50 to-white px-3 md:px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-8 md:mb-16">
            <h2 className="text-2xl md:text-5xl lg:text-7xl font-black mb-2 md:mb-4 uppercase tracking-tighter italic">MIRA EL <span className="text-rose-500">RESULTADO.</span></h2>
            <p className="text-gray-400 font-bold uppercase tracking-widest text-[10px] md:text-xs">Styling profesional en pocos minutos</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 md:gap-10 items-center mb-8 md:mb-16">
            ...
            <div className="relative rounded-2xl md:rounded-[3rem] overflow-hidden shadow-2xl border-4 border-white">
              <img src="/gif/hairdryer/1.gif" className="w-full h-auto" alt="AuraStyler en accion" />
              <div className="absolute bottom-4 left-4 right-4 md:bottom-6 md:left-6 md:right-6 bg-black/70 backdrop-blur-sm rounded-xl md:rounded-2xl p-3 md:p-4">
                <p className="text-white text-xs md:text-sm font-black uppercase tracking-wider">Efecto Coanda en accion</p>
                <p className="text-gray-300 text-[10px] md:text-xs italic">El cabello se envuelve automaticamente</p>
              </div>
            </div>
          ...
          <div className="relative rounded-2xl md:rounded-[3rem] overflow-hidden shadow-2xl border-4 border-white">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent flex items-end">
              <div className="p-6 md:p-12 text-white">
                ...
                <p className="text-gray-300 text-sm md:text-lg italic max-w-xl">Materiales de alta calidad y tecnologia de vanguardia para resultados de salon.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto relative z-10">
          <div className="text-center mb-8 md:mb-16">
            <span className="inline-block bg-rose-500/20 text-rose-400 px-3 md:px-4 py-1.5 md:py-2 rounded-full text-[8px] md:text-[10px] font-black uppercase tracking-widest mb-4 md:mb-6 border border-rose-500/30">
              <AlertTriangle className="inline w-2.5 h-2.5 md:w-3 md:h-3 mr-1" /> La verdad que nadie te cuenta
            </span>
            <h2 className="text-2xl md:text-7xl font-black text-white uppercase tracking-tighter italic leading-[0.9] mb-4 md:mb-6">
              CADA DIA QUE ESPERAS <br/><span className="text-rose-500">ESTAS PERDIENDO.</span>
            </h2>
            <p className="text-gray-400 text-sm md:text-lg max-w-2xl mx-auto font-medium italic px-2">
              No es solo cuestion de cabello. Es el tiempo, el dinero y la confianza en ti misma que tiras cada manana.
            </p>
          </div>
            ...
            {[
              {
                ...
                value: "45 min",
                label: "Perdidos cada manana",
                desc: "Son 273 horas al ano. 11 dias enteros de tu vida frente al espejo."
              },
              {
                icon: <CreditCard className="text-rose-500 w-6 h-6 md:w-10 md:h-10" />,
                value: "1.200€+",
                label: "Desperdiciados al ano",
                desc: "Entre peluqueria, tratamientos, productos que prometen milagros y luego decepcionan."
              },
              {
                icon: <Flame className="text-rose-500 w-6 h-6 md:w-10 md:h-10" />,
                value: "80%",
                label: "Cabello danado",
                desc: "Las planchas tradicionales alcanzan 230°C. El dano es irreversible."
              }
            ].map((item, i) => (
          ...
          <div className="bg-rose-500/10 border-2 border-rose-500/30 rounded-2xl md:rounded-[3rem] p-6 md:p-14 text-center">
            <h3 className="text-lg md:text-4xl font-black text-white uppercase tracking-tighter mb-4 md:mb-6 italic leading-tight">
              "Espero el proximo mes" = Otros 100€ tirados
            </h3>
            <p className="text-gray-300 max-w-2xl mx-auto mb-6 md:mb-8 text-sm md:text-lg font-medium">
              Las 1.847 mujeres que ya han pedido esta semana? <br/>
              <span className="text-rose-400 font-black">Manana se despertaran con el peinado ya listo.</span>
            </p>
            <a href="#order" className="inline-flex items-center gap-2 md:gap-3 bg-rose-500 text-white px-6 md:px-10 py-4 md:py-5 rounded-xl md:rounded-2xl font-black uppercase text-sm md:text-lg shadow-2xl shadow-rose-500/40 hover:scale-105 active:scale-95 transition-all">
              PEDIR AHORA <ArrowRight className="w-4 h-4 md:w-5 md:h-5" />
            </a>
            <p className="text-[8px] md:text-[10px] text-gray-500 mt-3 md:mt-4 font-bold uppercase tracking-widest">
              Oferta valida solo hoy. Manana el precio vuelve a 249€
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="comparison" className="py-12 md:py-24 bg-white px-3 md:px-4">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl md:text-7xl font-black text-center mb-8 md:mb-16 tracking-tighter uppercase italic">Elige <span className="text-rose-500">con sabiduria.</span></h2>
          <div className="grid grid-cols-2 gap-0 border-2 md:border-4 border-gray-900 rounded-2xl md:rounded-[4rem] overflow-hidden">
             <div className="p-4 md:p-12 bg-gray-50 opacity-40">
                ...
                <ul className="space-y-3 md:space-y-6">
                  ...
                  <li className="flex gap-2 md:gap-3 text-[10px] md:text-sm font-bold text-gray-500 italic"><X className="text-red-500 shrink-0 w-4 h-4 md:w-5 md:h-5" /> <span>Pago anticipado</span></li>
                  <li className="flex gap-2 md:gap-3 text-[10px] md:text-sm font-bold text-gray-500 italic"><X className="text-red-500 shrink-0 w-4 h-4 md:w-5 md:h-5" /> <span>Envio de pago</span></li>
                </ul>
             </div>
             <div className="p-4 md:p-12 bg-white relative">
                ...
                <ul className="space-y-3 md:space-y-6">
                  ...
                  <li className="flex gap-2 md:gap-3 text-[10px] md:text-sm font-black italic"><CheckCircle className="text-green-500 shrink-0 w-4 h-4 md:w-5 md:h-5" /> <span>Pagas a la entrega</span></li>
      ...
      <section id="reviews" className="py-12 md:py-24 bg-gray-50 px-3 md:px-4">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-2xl md:text-6xl font-black mb-8 md:mb-16 text-center tracking-tighter uppercase italic">Opiniones <span className="text-rose-500">Verificadas</span></h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-12 items-center mb-8 md:mb-16 bg-white p-5 md:p-12 rounded-2xl md:rounded-[3rem] border border-gray-100">
            <div className="text-center md:text-left">
              ...
              <p className="text-[9px] md:text-[10px] font-black uppercase tracking-widest text-gray-400 mt-2">456 CLIENTAS SATISFECHAS</p>
            </div>
            <div className="md:col-span-2 space-y-2 md:space-y-3">
               {[5, 4, 3, 2, 1].map(s => (
                 <div key={s} className="flex items-center gap-2 md:gap-4 text-[9px] md:text-[10px] font-black uppercase">
                    <span className="w-10 md:w-12">{s} ESTRELLAS</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8">
            {[
              { a: "Maria R.", r: "Increible. Hace exactamente lo que promete. Los rizos aguantan muchisimo!", d: "Hoy" },
              { a: "Elena L.", r: "Paquete llegado en 24 horas. Pague al mensajero en efectivo. Super recomendado!", d: "Ayer" },
              { a: "Sara V.", r: "El cepillo alisador es magico para quien tiene el cabello encrespado como yo.", d: "Hace 2 dias" },
              { a: "Julia C.", r: "Valor increible por 69 euros. No tiene nada que envidiar a las marcas de 500 euros.", d: "Hace 3 dias" }
            ].map((rev, i) => (
      ...
      <section id="order" className="py-12 md:py-24 bg-gray-900 px-3 md:px-4">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-8 md:gap-20 items-center">
          <div className="text-white text-center lg:text-left">
             <h2 className="text-3xl md:text-8xl font-black uppercase tracking-tighter leading-none italic mb-4 md:mb-8">PAGA AL <br/> <span className="text-rose-500">MENSAJERO.</span></h2>
             <p className="text-sm md:text-xl text-gray-400 font-medium italic mb-6 md:mb-10">"Ninguna tarjeta requerida. Pagas solo cuando tienes el producto en tus manos."</p>
             <div className="space-y-2 md:space-y-4 hidden lg:block">
               {[
                 { t: "Pago en Efectivo", i: <CreditCard className="w-5 h-5" /> },
          ...
          <div className="bg-white p-5 md:p-12 rounded-2xl md:rounded-[3rem] shadow-2xl relative overflow-hidden">
             ...
             <div className="absolute top-0 left-0 right-0 bg-green-500 text-white text-center py-1.5 md:py-2 text-[8px] md:text-[10px] font-black uppercase tracking-widest">
               ✓ 2.847 pedidos esta semana
             </div>

             <form onSubmit={handleOrder} className="space-y-3 md:space-y-5 mt-6 md:mt-8">
               <div className="text-center mb-4 md:mb-8">
                 <h3 className="text-xl md:text-3xl font-black uppercase tracking-tighter">Donde lo enviamos?</h3>
                 <p className="text-[9px] md:text-[10px] font-black uppercase text-gray-400 tracking-widest mt-1 md:mt-2">Completa en 30 segundos • Pagas al mensajero</p>
               </div>

               {/* Progress indicator */}
               <div className="flex items-center justify-center gap-1.5 md:gap-2 mb-4 md:mb-6">
                 <div className={`w-2.5 h-2.5 md:w-3 md:h-3 rounded-full ${formData.nombre ? 'bg-green-500' : 'bg-gray-200'}`}></div>
                 <div className={`w-6 md:w-8 h-0.5 ${formData.direccion ? 'bg-green-500' : 'bg-gray-200'}`}></div>
                 <div className={`w-2.5 h-2.5 md:w-3 md:h-3 rounded-full ${formData.direccion ? 'bg-green-500' : 'bg-gray-200'}`}></div>
                 <div className={`w-6 md:w-8 h-0.5 ${formData.telefono ? 'bg-green-500' : 'bg-gray-200'}`}></div>
                 <div className={`w-2.5 h-2.5 md:w-3 md:h-3 rounded-full ${formData.telefono ? 'bg-green-500' : 'bg-gray-200'}`}></div>
               </div>

               <div className="relative">
                 <input
                   required
                   className={`w-full p-4 md:p-5 bg-gray-50 rounded-xl md:rounded-2xl outline-none border-2 transition-all font-bold text-sm md:text-base ${activeField === 'nombre' ? 'border-rose-500 bg-white shadow-lg' : 'border-transparent'}`}
                 ...
                 />
                 {formData.nombre && <CheckCircle className="absolute right-3 md:right-4 top-1/2 -translate-y-1/2 text-green-500 w-4 h-4 md:w-5 md:h-5" />}
               </div>

               <div className="relative">
                 <input
                   required
                   className={`w-full p-4 md:p-5 bg-gray-50 rounded-xl md:rounded-2xl outline-none border-2 transition-all font-bold text-sm md:text-base ${activeField === 'direccion' ? 'border-rose-500 bg-white shadow-lg' : 'border-transparent'}`}
                   ...
                   onBlur={() => setActiveField(null)}
                 />
                 {formData.direccion && <CheckCircle className="absolute right-3 md:right-4 top-1/2 -translate-y-1/2 text-green-500 w-4 h-4 md:w-5 md:h-5" />}
               </div>
               ...
               <div className="relative">
                 <input
                   required
                   type="tel"
                   className={`w-full p-4 md:p-5 bg-gray-50 rounded-xl md:rounded-2xl outline-none border-2 transition-all font-bold text-sm md:text-base ${activeField === 'telefono' ? 'border-rose-500 bg-white shadow-lg' : 'border-transparent'}`}
                   placeholder="Telefono (para el mensajero) *"
                   value={formData.telefono}
                   onChange={e => setFormData({...formData, telefono: e.target.value})}
                   onFocus={() => setActiveField('telefono')}
                   onBlur={() => setActiveField(null)}
                 />
                 {formData.telefono && <CheckCircle className="absolute right-3 md:right-4 top-1/2 -translate-y-1/2 text-green-500 w-4 h-4 md:w-5 md:h-5" />}
               </div>
               ...
               >
                 ...
                 {isSubmitting ? (
                   ...
                   <span className="flex items-center justify-center gap-2">
                     <ShoppingBag className="w-5 h-5 md:w-6 md:h-6" /> <span className="hidden md:inline">COMPLETAR PEDIDO - </span>PAGO AL MENSAJERO
                   </span>
                 )}
               </button>
               ...
               <div className="flex items-center justify-center gap-4 md:gap-6 pt-1 md:pt-2">
                 ...
                 <div className="flex items-center gap-1 text-[8px] md:text-[9px] font-bold text-gray-400">
                   <RotateCw className="w-3 h-3 md:w-4 md:h-4 text-green-500" /> Devolucion facil
                 </div>
               </div>
             </form>
          </div>
      ...
      <footer className="py-10 md:py-20 bg-black text-white px-3 md:px-4 text-center pb-24 md:pb-20">
        ...
        <div className="max-w-4xl mx-auto flex flex-wrap justify-center gap-4 md:gap-10 text-[9px] md:text-[10px] font-black uppercase tracking-widest text-gray-500 mb-6 md:mb-12">
           <a href="#" className="hover:text-white transition">Politica de Privacidad</a>
           <a href="#" className="hover:text-white transition">Terminos de Venta</a>
           <a href="#" className="hover:text-white transition">Derecho de Desistimiento</a>
        </div>
        <p className="text-[8px] md:text-[10px] text-gray-700 font-black uppercase tracking-widest md:tracking-[0.4em] leading-relaxed">
          AURA STYLER™ NO ESTA AFILIADA A DYSON LTD. <br/>
          LA MARCA DYSON® PERTENECE A SU RESPECTIVO PROPIETARIO.
        </p>
      </footer>
