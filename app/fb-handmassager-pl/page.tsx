...
const REVIEWS = [
  ...
  { id: 2, title: "Prawdziwa pomoc po biurze", name: "Weronika S.", rating: 5, comment: "Pracując przy komputerze często czuję sztywność szyi. 15 minut z tym urządzeniem i czuję się jak nowo narodzona. Bardzo wszechstronny, świetny też na uda.", date: "2 kwietnia 2024" },
  { id: 3, title: "Wszechstronny i bardzo łatwy w użyciu", name: "Robert L.", rating: 5, comment: "Ciepło jest bardzo przyjemne. Szybka wysyłka i wygodnie zapłaciłem przy odbiorze. Polecam każdemu, kto szuka relaksu.", date: "22 kwietnia 2024" },
  ...
  { id: 7, title: "Praktyczny również w podróży", name: "Serena B.", rating: 5, comment: "Lekki, zawsze go ze sobą zabieram. Pomaga mi utrzymać mięśnie rozluźnione nawet podczas długich podróży służbowych.", date: "25 maja 2024" },
  { id: 8, title: "Precyzyjnie regulowana moc", name: "Dawid V.", rating: 5, comment: "15 poziomów intensywności to fantastyczne rozwiązanie. Można przejść od delikatnego dotyku do bardzo głębokiej stymulacji mięśni.", date: "1 czerwca 2024" },
  ...
  { id: 10, title: "Znacznie więcej niż masażer", name: "Mateusz S.", rating: 4, comment: "Używam go też na ramiona. Świetny pomysł z płatnością przy odbiorze, dało mi to dużo pewności przy zakupie online.", date: "15 czerwca 2024" },
  ...
  { id: 12, title: "Lekki ale mocny", name: "Stefan C.", rating: 5, comment: "Kształt U idealnie blokuje się również na odcinku lędźwiowym gdy siedzisz w fotelu. Mocny i skuteczny.", date: "28 czerwca 2024" },
  { id: 13, title: "Błyskawiczna wysyłka", name: "Elena F.", rating: 5, comment: "Dotarł w mniej niż 24 godziny. Idealne opakowanie i produkt przewyższający oczekiwania. Biały kolor jest bardzo elegancki.", date: "5 lipca 2024" },
  ...
  { id: 16, title: "Top dla codziennego dobrego samopoczucia", name: "Klara G.", rating: 5, comment: "Używam na nogi wieczorami. Bardzo relaksujący, polecam tym, którzy dużo stoją.", date: "22 lipca 2024" }
];
...
export default function LandingPage() {
  ...
  useEffect(() => {
    // Initialize timer only on client
  ...
  const handleOrder = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const payload = new URLSearchParams({
        ...
        'address-level2': formData['address-level2'],
      ...
      if (response.ok) {
        window.location.href = '/ty/ty-fb-handmassager-pl';
      } else {
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 font-sans selection:bg-blue-100">
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-8 md:gap-16 relative z-10">
          <div className="flex-1 text-center md:text-left w-full">
            ...
            <div className="flex flex-col items-center md:items-start gap-4 mb-6">
              ...
              <p className="text-xs font-bold text-red-600 uppercase tracking-wide">Oszczędzasz 50%</p>
      ...
      {/* 5. REVIEWS SECTION - Amazon Style Mobile Optimized */}
      ...
      {/* 6. ORDER FORM SECTION - Mobile Optimized */}
      <section ref={orderRef} className="py-10 sm:py-16 md:py-20 px-4 sm:px-6 bg-white">
        <div className="max-w-lg mx-auto">
          ...
          <div className="bg-white rounded-2xl sm:rounded-3xl shadow-xl border border-gray-200 overflow-hidden">
            ...
            <form onSubmit={handleOrder} className="p-4 sm:p-6 md:p-8 space-y-4 sm:space-y-6">
              {/* Product Box */}
              <div className="bg-blue-50 p-4 sm:p-5 rounded-xl border-2 border-blue-500 relative">
                <span className="absolute -top-3 left-4 bg-blue-600 text-white text-[10px] sm:text-xs font-bold px-3 py-1 rounded-full uppercase">Oferta Dnia</span>
