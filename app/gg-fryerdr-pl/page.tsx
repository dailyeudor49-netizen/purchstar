...
function LandingPageContent() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push('/gg-fryerdr-pl/ty');
    } catch (error) {
      console.error('Submit error:', error);
      // Redirect anyway
      router.push('/gg-fryerdr-pl');
    } finally {
...
export default function LandingPage() {
  return (
    <>
      ...
      <img
        src="https://offers.italiadrop.com/forms/api/ck/?o=2538&uid=019be4ed-80e5-7970-ab86-1938a865c187&lp=2577"
