...
export default function LandingPage() {
  ...
  const handleFormSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      router.push('/ty/ty-fb-airwave-hu-unc');
    } catch (error) {
  ...
  return (
    <>
      ...
      {/* Click Pixel */}
      <img
        src="https://offers.uncappednetwork.com/forms/api/ck/?o=2919&uid=0191dbf2-738a-7d28-82a0-18c3859d5e8f&lp=2952"
        ...
        <div className="product-container">
          ...
          <div className="product-images" id="productImages" ref={productImagesRef} style={imagesStyle}>
                ...
                <div className="slider-images" id="mainSlider" style={{ transform: `translateX(-${currentSlide * 100}%)` }}>
                  {[
                    ...
                    <div className="slider-image" key={index}>
                      <img src={src} alt={`Air Wave Smart klíma nézet ${index + 1}`} style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                    </div>
                  ))}
                </div>
              </div>
            ...
            <div className="thumbnails">
              {[
                ...
                >
                  <img src={src} alt={`Klíma előnézet ${index + 1}`} style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="product-info">
            ...
            <div className="product-header">
              <h1 className="product-title">Hordozható Air Wave Smart™ Klíma 3az1-ben - Fűt, Hűt és Párátlanít</h1>
              <p className="product-subtitle">Fűt, Hűt és Párátlanít • ThermoPanel Rendszer CO2 Kiküszöböléssel • Külső Aggregát Nélkül • 12 000 BTU • Rendkívül Csendes Működés</p>
            </div>
            ...
            <div className="product-rating">
              ...
              <span className="rating-text">4.9 (298 értékelés)</span>
            </div>
            ...
            <div className="product-price">
              <div className="price-row">
                ...
                <span className="price-save">-24%</span>
              </div>
            </div>
            ...
            <div className="product-cta">
              <button className="btn-add-to-cart btn-add-to-cart-mobile" onClick={scrollToForm}>
                ...
                <span style={{ display: 'block', fontWeight: 400 }} className="btn-text-sub">
                  Utánvételes Fizetés - Ingyenes Kézbesítés
                </span>
              </button>
            ...
            <div className="product-description">
              <h3>Kulcsfontosságú Előnyök</h3>
              <ul>
                <li><span className="icon">✓</span><span><strong>12 000 BTU Kapacitás</strong> – Gyorsan fűt, hűt és párátlanít akár 60 m²-es helyiségekben</span></li>
                <li><span className="icon">✓</span><span><strong>Három üzemmód egyben</strong> – Télen fűtés, nyáron hűtés és párátlanítás</span></li>
                ...
                <li><span className="icon">✓</span><span><strong>A+++ hatékonysági osztály</strong> – 60%-ot takarít meg a hagyományos rendszerekhez képest</span></li>
                <li><span className="icon">✓</span><span><strong>ThermoPanel rendszer külső aggregát nélkül</strong> – Visszanyeri a levegőt és kiküszöböli a CO2-t, külső egység nélkül</span></li>
                ...
                <li><span className="icon">✓</span><span><strong>Egyszerű szerelés</strong> – Falra vagy padlóra szerelhető, szerelő nélkül</span></li>
                <li><span className="icon">✓</span><span><strong>Nagyon csendes</strong> – Hálószobába is ideális</span></li>
              </ul>
            </div>
              ...
              <div className="trust-items">
                <div className="trust-item">
                  ...
                  <div className="trust-content">
                    <h4>INGYENES Kézbesítés 48 Órán Belül</h4>
                    <p>Gyors futárszolgálat csomagkövetéssel. Kézbesítési költség nélkül.</p>
                  </div>
                </div>
                <div className="trust-item">
                  <div className="trust-icon">
                  ...
                  <div className="trust-content">
                    ...
                    <p>Előleg nélkül. Csak az áru futártól való átvétele után fizet</p>
                  </div>
                </div>
                <div className="trust-item">
                  <div className="trust-icon">
                  ...
                  <div className="trust-content">
                    <h4>Ingyenes Visszaküldés 30 Napig</h4>
          ...
          <div className="timeline-container" style={{ position: 'relative', maxWidth: '800px', margin: '0 auto', padding: '2rem 0' }}>
            ...
            <div ref={whyItem1.ref} className="timeline-item timeline-item-left" style={{ display: 'grid', gridTemplateColumns: '1fr auto 1fr', gap: '2rem', alignItems: 'center', marginBottom: '3rem', position: 'relative' }}>
              <div className="timeline-content timeline-content-left" style={{
                ...
                <h3 style={{ fontSize: '1.25rem', fontWeight: 700, color: '#CC6600', marginBottom: '0.5rem' }}>ThermoPanel Rendszer</h3>
                <p style={{ fontSize: '0.9375rem', color: '#995200', lineHeight: 1.6 }}>
                  <strong style={{ color: '#663300' }}>Külső motor nélkül</strong>, hozzájárulás nélkül. Visszanyeri és megtisztítja a levegőt, kiküszöbölve a CO2-t és a szennyeződéseket.
                </p>
              </div>
            ...
            <div ref={whyItem2.ref} className="timeline-item timeline-item-right" style={{ display: 'grid', gridTemplateColumns: '1fr auto 1fr', gap: '2rem', alignItems: 'center', marginBottom: '3rem', position: 'relative' }}>
              ...
              <div className="timeline-content timeline-content-right" style={{
                ...
                <p style={{ fontSize: '0.9375rem', color: '#995200', lineHeight: 1.6 }}>
                  <strong style={{ color: '#663300' }}>Okos termosztát</strong>, amely szabályozza a hőmérsékletet. <strong style={{ color: '#663300' }}>Akár 60%-os költségcsökkentés</strong> a számlákon.
                </p>
              </div>
            </div>
            ...
            <div ref={whyItem3.ref} className="timeline-item timeline-item-left timeline-item-last" style={{ display: 'grid', gridTemplateColumns: '1fr auto 1fr', gap: '2rem', alignItems: 'center', position: 'relative' }}>
              <div className="timeline-content timeline-content-left" style={{
                ...
                <h3 style={{ fontSize: '1.25rem', fontWeight: 700, color: '#CC6600', marginBottom: '0.5rem' }}>Három Funkció Egy Készülékben</h3>
                <p style={{ fontSize: '0.9375rem', color: '#995200', lineHeight: 1.6 }}>
            ...
            >
              ...
              >
                ...
                <div className="why-choose-slide">
                    <div className="why-choose-slide-content">
                        <div className="why-choose-slide-text">
                            <h3>Hatékony és Erős Fűtés</h3>
                            <p>ThermoPanel technológia, amely <strong>gyorsan felmelegíti</strong> otthonát külső egység nélkül. <strong>Folyamatos meleg</strong>, veszteség nélkül, <strong>biztos megtakarítás</strong> a számlákon.</p>
                        </div>
                        <div className="why-choose-slide-image">
                            <img src="/images/condizionatore/riscaldamento.webp" alt="Air Wave fűtési funkció" />
                        </div>
                    </div>
                </div>
                ...
                <div className="why-choose-slide">
                    <div className="why-choose-slide-content">
                        <div className="why-choose-slide-text">
                            <h3>Szereléssel vagy Anélkül</h3>
                            <p><strong>Egyszerű szerelés</strong> falra vagy padlóra. <strong>Szerelő nélkül</strong>, <strong>csatlakoztasd és használd</strong>. Perceken belül használható.</p>
                        </div>
                        <div className="why-choose-slide-image">
                            <img src="/images/condizionatore/installazione.webp" alt="Air Wave klíma szerelése" />
                        </div>
                    </div>
                </div>
                ...
                <div className="why-choose-slide">
                    <div className="why-choose-slide-content">
                        <div className="why-choose-slide-text">
                            ...
                            <p><strong>Három üzemmód egyben</strong>: erős fűtés télen, hűtés nyáron, párátlanítás egész évben. <strong>Engedély nélkül</strong> társasházban is.</p>
                        </div>
                        <div className="why-choose-slide-image">
                            <img src="/images/condizionatore/caldo-freddo.webp" alt="Három az egyben klíma" />
                        </div>
                    </div>
                </div>
                ...
                <div className="why-choose-slide">
                    <div className="why-choose-slide-content">
                        <div className="why-choose-slide-text">
                            <h3>Akár 60%-os Költségcsökkentés</h3>
                            <p><strong>A+++ hatékonyság</strong> és okos termosztát: csak annyit fogyaszt amennyire szükség van. <strong>Nincs pazarlás</strong>, <strong>legnagyobb megtakarítás</strong> a gázfűtéshez képest.</p>
                        </div>
                        <div className="why-choose-slide-image">
                            <img src="/images/condizionatore/risparmio.webp" alt="Air Wave energia-megtakarítás" />
                        </div>
                    </div>
                </div>
                ...
                <div className="why-choose-slide">
                    <div className="why-choose-slide-content">
                        <div className="why-choose-slide-text">
                            <h3>Nagyon csendes: Aludjon Nyugodtan</h3>
                            <p>Ideális <strong>hálószobába</strong>. <strong>Rendkívül csendes</strong> működés, hangos külső egység nélkül. Élvezze a <strong>maximális kényelmet</strong> zavaró zajok nélkül.</p>
                        </div>
                        <div className="why-choose-slide-image">
                            <img src="/images/condizionatore/silenzioso.webp" alt="Csendes klíma működés" />
                        </div>
                    </div>
                </div>
        ...
        <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
          ...
          <div className="tech-specs-container">
                    ...
                    <div style={{
                      ...
                      transition: 'opacity 0.6s ease-out 0.6s, transform 0.6s ease-out 0.6s'
                        ...
                        <p style={{ color: '#555555', fontSize: '0.9375rem', lineHeight: 1.6 }}>
                            <strong>Akár 60%-kal alacsonyabb költségek</strong> más klímaberendezésekhez és gázfűtéshez képest a ThermoPanel technológiának és az A+++ hatékonysági osztálynak köszönhetően.
                        </p>
                    </div>
                    <div style={{
                      background: '#F5F5F5',
                ...
                <div className="tech-cost-box" style={{
                  ...
                  transition: 'opacity 0.6s ease-out 1s, transform 0.6s ease-out 1s'
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '1rem' }}>
                        <div style={{ fontSize: '1.5rem', fontWeight: 700, color: '#FF8C00' }}>161 Ft naponta</div>
                ...
                <div style={{
                  ...
                  transition: 'opacity 0.6s ease-out 0.8s, transform 0.6s ease-out 0.8s'
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.75rem', paddingTop: '0.75rem', borderTop: '1px solid #e5e7eb' }}>
                        <div style={{ fontSize: '1.25rem', fontWeight: 700, color: '#FF8C00' }}>161 Ft naponta</div>
            ...
            <div className="tech-specs-image" style={{ background: 'linear-gradient(135deg, #FFF8F0, #FFE8CC)', border: '2px solid #FFD966', borderRadius: '16px', overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '400px' }}>
              <img src="/images/condizionatore/specifiche.webp" alt="Air Wave Smart műszaki paraméterek" style={{ width: '100%', height: '100%', objectFit: 'contain' }} />
            </div>
          </div>
        </div>
      </section>
        ...
        <div style={{ maxWidth: '900px', margin: '0 auto' }}>
          ...
          <div style={{ background: 'linear-gradient(135deg, #FFF4E6, #FFE8CC)', borderRadius: '16px', padding: '2rem', border: '1px solid #FFDAA3' }}>
            <div className="include-grid">
              <img src="/images/condizionatore/include.webp" alt="Air Wave Smart teljes csomag" className="include-img" />
              <div className="include-list">
                 {[
                    "1× Air Wave Smart™ klímaberendezés 12 000 BTU",
                    "1× Távirányító elemekkel együtt a csomagban",
                    "1× Falra szerelő készlet",
                    "2× Pót HEPA szűrők (2 évre elegendő)",
                    "Felhasználói kézikönyv + 24 hónap garancia",
                    "Ingyenes hozzáférés a mobilalkalmazáshoz (iOS és Android)"
                 ].map((item, i) => (
          ...
          <div style={{ position: 'relative', maxWidth: '900px', margin: '0 auto 2rem' }}>
            <div id="reviewsSlider" style={{ overflow: 'hidden', borderRadius: '12px' }}>
              <div id="reviewsTrack" style={{ display: 'flex', transition: 'transform 0.5s ease', transform: `translateX(-${currentReview * 100}%)` }}>
                {[
                    { t: 'Végre látom a valódi megtakarítást', d: 'Nagyjából 2 hónapja használom és el kell mondanom, hogy a számlák jelentősen csökkentek. Korábban a régi klímával sokat fizettem, most jóval kevesebbet. Jól fűt és kiválóan működik.', a: 'Kovács Péter', stars: 5 },
                    { t: 'Villámgyors kézbesítés!', d: 'Hétfőn rendeltem, szerdára megérkezett. A futár is udvarias volt. A termék nagyszerű, egyedül szereltem fel a falra anélkül, hogy bárkit hívtam volna. Jól működik és gyorsan felmelegíti a helyiséget.', a: 'Nagy Tamás', stars: 5 },
                    { t: 'Ideális hálószobába', d: 'A hálószobába szereltem és alig hallani, alig észlelem. A régivel nem tudtam aludni, ez pedig tökéletes. Kevés energiát is fogyaszt.', a: 'Szabó Anna', stars: 5 },
                    { t: 'Eddig jó', d: 'Nagyon elégedett vagyok, gyorsan felmelegít és a ház meleg marad. Nem tudom, hogy korábban hogyan boldogultam a radiátorokkal, amik órákig melegedtek. Ez teljesen más szint. 4 csillagot adok, hogy lássam később hogyan lesz.', a: 'Kiss Katalin', stars: 4 },
                    { t: 'Egyszerű szerelés', d: 'Fiammal fél óra alatt felszereltük, csavarok és minden megvan, elég felakasztani és azonnal működik. Nem kell szerelő és ezzel is pénzt takarítasz meg. Szuper.', a: 'Tóth Róbert', stars: 5 },
                    { t: 'Expressz kézbesítés', d: '2 nap alatt megérkezett, gondosan becsomagolva. A futár még felsegített a harmadikra, mert lift nélküli házban lakom! A termék nagyszerű, remekül fűt és kevesebbet fogyaszt a régihez képest.', a: 'Horváth Mónika', stars: 5 },
                    { t: 'Kiváló ár-érték arány', d: 'Ezen az áron tényleg jó. Fűt és hűt, én főleg télen használom és a hőmérséklet mindig olyan, amilyet szeretnék. Nem térek vissza az előzőhöz.', a: 'Varga László', stars: 5 },
                    ...
                    { t: 'Gyors kézbesítés és remek termék', d: 'Kedden rendeltem, csütörtökön megkaptam, a futár időben volt. A termék kiváló, fűt és hűt, egész évben használom. Nagyon csendes és könnyű kezelni még nekem is aki nem értek hozzá.', a: 'Fekete Antal', stars: 5 },
                    { t: 'Nagyon elégedett vagyok', d: 'Féltem interneten rendelni, de minden tökéletesen megérkezett pár nap alatt. Kiválóan működik és nagyon keveset fogyaszt az előző klímámhoz képest. A számlák jelentősen csökkentek. Nagyon elégedett vagyok.', a: 'Németh Szilvia', stars: 5 }
                ].map((review, i) => (
        ...
        <div id="reviewModal" style={{ display: 'flex', position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, background: 'rgba(0,0,0,0.5)', zIndex: 1000, alignItems: 'center', justifyContent: 'center' }} onClick={() => setIsModalOpen(false)}>
            <div style={{ background: 'white', borderRadius: '16px', padding: '2rem', maxWidth: '500px', width: '90%', margin: '0 auto', boxShadow: '0 20px 60px rgba(0,0,0,0.3)', position: 'relative' }} onClick={e => e.stopPropagation()}>
                ...
                <div style={{ textAlign: 'center' }}>
                    ...
                    <h3 style={{ fontSize: '1.25rem', fontWeight: 700, color: '#111827', marginBottom: '1rem' }}>Kizárólag Igazolt Vásárlások</h3>
      ...
      <section id="ordina" style={{ background: '#1E293B', padding: '5rem 1.5rem', color: 'white', position: 'relative' }}>
        ...
        <div className="checkout-grid" style={{ maxWidth: '1000px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))', gap: '4rem', alignItems: 'start' }}>
          ...
          <div>
            <h2 style={{ fontSize: '1.75rem', fontWeight: 800, marginBottom: '1rem' }}>Limitált Mennyiség</h2>
            <p style={{ fontSize: '1rem', color: '#94a3b8', marginBottom: '2rem' }}>Használja ki a Black Friday akciót amíg tart</p>
            ...
            <div style={{ background: 'rgba(255,255,255,0.05)', padding: '2rem', borderRadius: '24px', border: '1px solid rgba(255,255,255,0.1)' }}>
              <div style={{ display: 'flex', gap: '1rem', marginBottom: '1.5rem', alignItems: 'center' }}>
                <img src="/images/condizionatore/specifiche.webp" alt="Air Wave Smart klíma termék" style={{ width: '80px', height: '80px', borderRadius: '12px', objectFit: 'cover' }} />
                <div>
              ...
              <ul style={{ color: '#cbd5e1', listStyle: 'none', padding: 0, margin: 0 }}>
                ...
                <li style={{ display: 'flex', justifyContent: 'space-between', padding: '0.5rem 0', borderBottom: '1px solid rgba(255,255,255,0.1)' }}>
                  <span>Black Friday kedvezmény</span> <span style={{ color: '#FFB800' }}>-9 000 Ft</span>
                </li>
                <li style={{ display: 'flex', justifyContent: 'space-between', padding: '0.5rem 0', borderBottom: '1px solid rgba(255,255,255,0.1)' }}>
                  <span>Kézbesítés</span> <span style={{ color: '#4ADE80' }}>INGYEN</span>
                </li>
                <li style={{ display: 'flex', justifyContent: 'space-between', padding: '1rem 0', fontSize: '1.25rem', fontWeight: 700, color: 'white' }}>
                  <span>Végösszeg</span> <span>28 999 Ft</span>
                </li>
              </ul>
          ...
          <div style={{ background: 'white', borderRadius: '24px', padding: '2.5rem', color: '#1E293B' }}>
            <div style={{ marginBottom: '1.5rem', textAlign: 'center' }}>
              <h3 style={{ fontSize: '1.5rem', fontWeight: 800 }}>Biztonságos Tranzakció</h3>
            ...
            <form onSubmit={handleFormSubmit} style={{ display: 'grid', gap: '1rem' }}>
              ...
              <div>
                <label style={{ fontSize: '0.8rem', fontWeight: 700, color: '#64748b', marginBottom: '4px', display: 'block' }}>VEZETÉK- ÉS KERESZTNÉV</label>
              ...
              <button type="submit" style={{
                ...
                <span>Rendelés Jóváhagyása</span>
