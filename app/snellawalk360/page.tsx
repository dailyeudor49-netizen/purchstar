...
function getCarouselImages(): string[] {
  ...
  return fs
    ...
    .map((f) => `/images/land/snellawalk360/carosello/${f}`);
}

export const metadata: Metadata = {
  title: "SnellaWalk 360 - Scarpe Dimagranti Ortopediche | Aurea Calzature",
  description:
      ...
      <div className="grid items-start gap-8 md:grid-cols-2 md:gap-12">
        ...
        <div>
          ...
          <h1 className="mb-1 text-2xl font-extrabold tracking-tight text-gray-900 md:text-3xl">
            <span className="text-teal-700">SnellaWalk 360</span> — Scarpe dimagranti ortopediche
          </h1>
          <p className="mb-4 text-base font-medium text-gray-500">
            Con suola curva che ti spinge in avanti: cammini con meno fatica, scarichi ginocchia e schiena e attivi i glutei ad ogni passo.
          </p>
          ...
          <ul className="mb-6 space-y-2.5">
            {[
              { bold: "Rocker ortopedico SnellaWalk 360", rest: "suola curva che ti spinge in avanti" },
              { bold: "Effetto GluteLift", rest: "attiva e solleva i glutei camminando" },
              { bold: "Plantare OrtoLift™", rest: "con supporto dell'arco" },
              { bold: "Postura+", rest: "passo più allineato, meno stress su schiena e ginocchia" },
              { bold: "Cushion+ anti-urto", rest: "ammortizzazione morbida che assorbe l'impatto" },
              { bold: "ThermoBalance™", rest: "mantiene i piedi asciutti e senza odori" },
              { bold: "Suola antiscivolo", rest: "aderenza sicura anche su bagnato" },
            ].map((f) => (
...
export default function SnellaWalk360Landing() {
  return (
  ...
  return (
    <section className="lp-fasi">
      <div className="lp-fasi-head">
        <h2>Cammini e il Tuo Corpo <em>Si Trasforma</em></h2>
        <p>SnellaWalk™ non è una scarpa qualunque. È un sistema a suola curva che ti spinge in avanti: attivi i glutei, scarichi le articolazioni e bruci di più ad ogni passo.</p>
      </div>
      <div className="lp-fasi-grid">
        {[
          { img: "https://cdn.shopify.com/s/files/1/0977/4134/1049/files/1.png?v=1770390980", alt: "Fase Attiva", tag: "Fase 1", title: "Attiva", text: "La suola rocker spinge il piede in avanti e attiva glutei, cosce e polpacci ad ogni passo." },
          { img: "https://cdn.shopify.com/s/files/1/0977/4134/1049/files/2.png?v=1770390979", alt: "Fase Solleva", tag: "Fase 2", title: "Solleva", text: "L'estensione d'anca fa lavorare i glutei di più: si sollevano e si tonificano camminando." },
          { img: "https://cdn.shopify.com/s/files/1/0977/4134/1049/files/3.png?v=1770390980", alt: "Fase Scolpisci", tag: "Fase 3", title: "Scolpisci", text: "In 4 settimane noti glutei più tonici, gambe più sode e una postura visibilmente migliore." },
        ].map((f) => (
      ...
      <div className="lp-inner">
        <div className="lp-stats">
          <div>
            ...
            <div className="lp-stat-l">Glutei più tonici<br />in 4 settimane*</div>
          </div>
          <div>
            <div className="lp-stat-n">96%</div>
            <div className="lp-stat-l">Comfort quotidiano<br />senza dolori</div>
          </div>
          <div>
...
const techCards = [
  { img: "/images/land/snellawalk360/rocker.webp", alt: "Suola Rocker Ortopedica", title: "Suola Rocker Ortopedica", text: "Suola curva che ti spinge in avanti. Rullata fluida, meno stress su ginocchia e schiena." },
  { img: "/images/land/snellawalk360/plantare.webp", alt: "Plantare OrtoLift", title: "Plantare OrtoLift™", text: "Supporto mirato ad arco e tallone. Postura più allineata dal primo passo." },
  { img: "/images/land/snellawalk360/carosello/7.webp", alt: "Cushion+ Anti-urto", title: "Cushion+ Anti-urto", text: "Doppia ammortizzazione che assorbe gli impatti e protegge le articolazioni." },
  { img: "/images/land/snellawalk360/premium.webp", alt: "ThermoBalance", title: "ThermoBalance™", text: "Traspirante e termoregolante. Piede asciutto, fresco e senza odori." },
  { img: "/images/land/snellawalk360/antiscivolo.webp", alt: "Suola Antiscivolo", title: "Suola Antiscivolo", text: "Grip avanzato e tassellatura profonda. Passi sicuri anche su bagnato." },
  { img: "/images/land/snellawalk360/glutelift.webp", alt: "Attivazione Glutei", title: "Attivazione Glutei", text: "L'estensione d'anca attiva e solleva i glutei ad ogni camminata." },
];
  ...
  return (
    <section className="lp-sec">
      <div className="lp-inner">
        ...
        <p className="sub">Ogni dettaglio della SnellaWalk™ è progettato per farti camminare meglio e sentirti meglio.</p>
...
function TimelineSection() {
  return (
    <section className="lp-sec lp-sec-light" style={{ background: "#f7faf9" }}>
      <div className="lp-inner">
        <h2>Glutei Scolpiti in <em>4 Settimane</em></h2>
        <p className="sub">Anche solo 20 minuti al giorno di camminata con SnellaWalk™ bastano per vedere la differenza.</p>
        <div className="lp-timeline">
          {[
            { week: "Settimana 1", pct: "25%", title: "Ti abitui alla suola rocker", text: "Il piede si adatta alla rullata. Senti già i glutei e i polpacci lavorare di più durante la camminata." },
            { week: "Settimana 2", pct: "50%", title: "Meno dolori, più energia", text: "Schiena e ginocchia ringraziano. Cammini più a lungo senza fatica. I muscoli si attivano in automatico." },
            { week: "Settimana 3", pct: "75%", title: "Inizi a vedere i risultati", text: "Le gambe sono più sode. I glutei appaiono più sollevati. La postura è visibilmente più dritta." },
            { week: "Settimana 4", pct: "100%", title: "Glutei scolpiti, silhouette snella", text: "Il cambiamento è evidente. Glutei più tonici, gambe definite e una silhouette più snella. E non hai fatto palestra." },
          ].map((s) => (
        ...
        <div className="lp-tl-bottom">
          <div className="lp-tl-badge">Solo 20 min/giorno</div>
          <div className="lp-tl-badge">Cammini e basta</div>
          <div className="lp-tl-badge">Zero palestra</div>
        </div>
        <p className="lp-tl-disc">*Tempi indicativi: i risultati variano in base a continuità, peso, intensità e stile di camminata.</p>
      </div>
    </section>
  );
}
      ...
      <div className="lp-inner">
        ...
        <div className="lp-guar-grid">
          {[
            ...
            { icon: "🔄", title: "Reso 30 Giorni", sub: "Soddisfatta o rimborsata" },
      ...
      <div className="lp-inner">
        ...
        <div className="lp-pasos">
          {[
            ...
            { n: "4", title: "Non ti convincono? Le restituisci", text: "30 giorni per il reso. Senza complicazioni. Soddisfatta o rimborsata." },
          ].map((s) => (
