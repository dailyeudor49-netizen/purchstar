        ...
        >
          {images.map((src, index) => (
            <img
              key={index}
              src={src}
              alt={`NovaClean X1 - Obrázek ${index + 1}`}
  ...
  const features = [
    {
      ...
      desc: "Cyklonový motor vysává prach, zatímco mikrovláknový hadřík odstraňuje odolné skvrny. Jeden průjezd, dvojitý výsledek."
    },
    {
      icon: <Navigation className="w-8 h-8 text-white" />,
      bg: "bg-purple-500",
      title: "Smart Navigace 3.0",
      desc: "Nepadá ze schodů a nenarážíprudce. IR senzory mapují místnost, vyhýbají se překážkám a čistí pod postelemi a pohovkami."
    },
    {
      icon: <Smartphone className="w-8 h-8 text-white" />,
      bg: "bg-green-500",
      title: "Úplná Kontrola",
      desc: "Použijte dálkové ovládání nebo přiloženou aplikaci. Spusťte úklid z kanceláře a vraťte se do zářícího domu."
    },
    {
       icon: <Battery className="w-8 h-8 text-white" />,
       bg: "bg-yellow-500",
       title: "Automatické Nabíjení",
       desc: "Když se baterie vybije, sám se vrátí na NovaStation, nabije se, vyprázdní a pokračuje tam, kde skončil."
    },
    {
    ...
    },
    {
       ...
       bg: "bg-red-500",
       title: "HEPA Filtr",
       desc: "Zachycuje 99,9% alergenů a jemného prachu. Ideální pro alergiky a majitele domácích mazlíčků."
    }
  ];
    ...
    <section className="py-20 px-4 bg-gray-50">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
           <span className="text-brand-orange text-orange-600 font-bold tracking-widest text-sm uppercase">Pokročilá Technologie</span>
           <h2 className="text-3xl md:text-5xl font-extrabold text-gray-900 mt-2">
             Vše, co od robota očekáváte.<br />
             <span className="text-gray-400">Bez šílené ceny.</span>
           </h2>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="w-full md:w-1/2">
            ...
            <p className="text-gray-400 text-lg mb-8 leading-relaxed">
              Čtete správně. Neplatíte navíc. <strong>NovaStation™ Omni All-in-One</strong> je v základním balení. Robot se sám vrátí, vyprázdní a vyčistí.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="bg-white/5 border border-white/10 p-4 rounded-xl hover:bg-white/10 transition duration-300">
                ...
                <h4 className="font-bold text-lg mb-1">Auto-Vyprazdňování</h4>
                <p className="text-gray-400 text-sm">Vysaje nečistoty z robota do uzavřeného sáčku 3L (vydrží 2 měsíce).</p>
              </div>

              <div className="bg-white/5 border border-white/10 p-4 rounded-xl hover:bg-white/10 transition duration-300">
                <Droplets className="text-blue-500 mb-3 w-8 h-8" />
                <h4 className="font-bold text-lg mb-1">Výměna Vody a Mytí</h4>
                <p className="text-gray-400 text-sm">Umyje špinavé hadříky a doplní nádrž robota čistou vodou.</p>
              </div>

              <div className="bg-white/5 border border-white/10 p-4 rounded-xl hover:bg-white/10 transition duration-300">
                <Wind className="text-gray-300 mb-3 w-8 h-8" />
                <h4 className="font-bold text-lg mb-1">Sušení Teplem</h4>
                <p className="text-gray-400 text-sm">Suší mop při 45°C, čímž předchází plísni a nepříjemným zápachům.</p>
              </div>

              <div className="bg-white/5 border border-white/10 p-4 rounded-xl hover:bg-white/10 transition duration-300">
                <Zap className="text-yellow-400 mb-3 w-8 h-8" />
                <h4 className="font-bold text-lg mb-1">Nabíjení +30%</h4>
                <p className="text-gray-400 text-sm">Inteligentní rychlé nabíjení pro rychlejší návrat do práce.</p>
              </div>
            </div>
          </div>
          ...
          <div className="w-full md:w-1/2 relative">
             ...
             <div className="absolute -bottom-6 -left-6 bg-white text-gray-900 p-4 rounded-xl shadow-xl z-20 border-l-4 border-orange-500 max-w-xs hidden md:block">
                <div className="font-bold uppercase text-xs text-gray-500">Hodnota 3999 Kč</div>
                <div className="font-black text-xl text-orange-500">ZDARMA DNES</div>
             </div>
          </div>
...
const ReviewCard: React.FC<{ name: string; country: string; flag: string; text: string; date: string }> = ({ name, country, flag, text, date }) => (
  <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 h-full flex flex-col">
    ...
    <div className="mt-auto flex items-center text-xs text-green-700 font-bold bg-green-50 w-fit px-2 py-1 rounded-md">
      <Check size={12} className="mr-1" /> Ověřený Nákup
    </div>
  </div>
);
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-4 mb-12 bg-gray-50 p-6 rounded-2xl border border-gray-100">
           ...
           <div className="flex flex-col items-center md:items-start">
              ...
              <p className="text-gray-500 text-sm font-medium">Na základě <span className="underline">1 248 recenzí</span> zákazníků</p>
           </div>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <ReviewCard
            ...
            flag="🇨🇿"
            date="před 2 dny"
            text="Upřímně, byl jsem skeptický vzhledem k ceně. Ale vysává lépe než můj starý iRobot za 10 000 Kč. Srst psa už není problém."
          />
          <ReviewCard
            name="Jana Nováková"
            country="Česko"
            flag="🇨🇿"
            date="před týdnem"
            text="Dorazil za 24 hodin. Mopování není tak hluboké jako ruční, ale na každodenní udržování čistoty je perfektní. Doporučuji!"
          />
          <ReviewCard
            name="Martin Dvořák"
            country="Česko"
            flag="🇨🇿"
            date="před 3 dny"
            text="Baterie vydrží věčně. Vyčistí celý můj 80m² byt a ještě zbude nabití. Nejlepší nákup roku pro manželku (i pro mě)."
          />
        </div>
      </div>
    </section>
...
const TechSpecs: React.FC = () => {
  return (
    <section className="py-16 px-4 bg-white border-t border-gray-100">
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">Technické Specifikace</h2>
          <p className="text-gray-500 max-w-2xl mx-auto">
            Komponenty průmyslové kvality navržené na více než 10 let používání.
            Porovnejte s modely za 25 000 Kč.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <SpecItem
            ...
            label="Sací Výkon"
            value="6000 Pa"
            detail="Bezkartáčový motor Nidec™ (Japonsko)"
          />
          <SpecItem
            icon={<Battery size={24} />}
            label="Baterie"
            value="5200 mAh"
            detail="Až 180 min nepřetržitého provozu"
          />
          <SpecItem
            icon={<Cpu size={24} />}
            label="Navigace"
            value="LiDAR LDS 4.0"
            detail="Laserové Mapování 360° + SLAM AI"
          />
           <SpecItem
            icon={<Volume2 size={24} />}
            label="Hlučnost"
            value="< 55 dB"
            detail="Ultra-Tichý Noční Režim"
          />
          <SpecItem
            icon={<Wifi size={24} />}
            label="Připojení"
            value="WiFi 2.4/5 GHz"
            detail="Kompatibilní s Alexa, Google Home a App"
          />
           <SpecItem
            icon={<Layers size={24} />}
            label="Kapacita Prachu"
            value="3 Litry (Stanice)"
            detail="400ml vnitřní nádrž robota"
          />
          <SpecItem
            icon={<Maximize size={24} />}
            label="Překonávání Překážek"
            value="20 mm"
            detail="Off-Road protiskluzová kola"
          />
          <SpecItem
            icon={<Shield size={24} />}
            label="Filtrace"
            value="HEPA H13"
            detail="Zachycuje 99,97% mikročástic"
          />
        </div>

        <div className="mt-8 p-4 bg-gray-50 rounded-lg text-center text-xs text-gray-400">
           * Specifikace ověřené v nezávislé laboratoři TÜV Rheinland. Certifikace CE/RoHS v balení.
        </div>
      </div>
    </section>
  );
        ...
        <div className="flex flex-col md:flex-row items-center gap-8">
          ...
          <div className="flex-shrink-0 relative group">
            ...
            <div className="w-32 h-32 md:w-40 md:h-40 bg-white border-4 border-orange-500 rounded-full flex flex-col items-center justify-center shadow-2xl relative z-10 transform rotate-[-5deg] group-hover:rotate-0 transition-transform duration-300">
              ...
              <span className="text-gray-900 font-bold text-xs uppercase tracking-wider">Dnů na</span>
          ...
          <div className="text-center md:text-left flex-1">
            ...
            <p className="text-gray-700 mb-6 text-lg leading-relaxed">
              Víme, že nakupování online může být stresující. Proto vám dáváme <span className="font-bold">30 dní</span> na otestování NovaClean X1 doma. Pokud nečistí tak, jak slibujeme, nebo se vám prostě nelíbí barva, vezmeme ho zpět a vrátíme každou korunu.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
               ...
               <div className="flex items-center gap-2 text-sm font-bold text-gray-800 bg-white p-3 rounded-lg shadow-sm border border-orange-100">
                  <RefreshCw className="text-blue-500" /> Vrácení Zdarma
               </div>
               <div className="flex items-center gap-2 text-sm font-bold text-gray-800 bg-white p-3 rounded-lg shadow-sm border border-orange-100">
                  <ThumbsUp className="text-orange-500" /> Podpora CZ
               </div>
            </div>
          </div>
...
const FAQ: React.FC = () => {
  const faqs = [
    {
      question: "Funguje dobře se srstí zvířat?",
      answer: "Absolutně ano. Centrální kartáč ve tvaru V a silné cyklonové sání jsou speciálně navrženy pro zachycování srsti psů a koček bez zamotání."
    },
    {
      question: "Kde najdu náhradní díly?",
      answer: "Nabízíme sady náhradních dílů (kartáče, HEPA filtry, hadříky) přímo na našich stránkách za tovární ceny. Navíc jsou komponenty univerzální a snadno dostupné."
    },
    {
      question: "Vztahuje se záruka na poruchy?",
      answer: "Ano, nabízíme 2letou Přímou Záruku. Pokud má robot technickou závadu, vyměníme ho zdarma za nový. 100% česká podpora."
    },
    {
      question: "Jak funguje platba na dobírku?",
      answer: "Je to velmi jednoduché. Objednáte nyní vyplněním formuláře, online nic neplatíte. Zaplatíte hotově přímo kurýrovi při doručení balíku (obvykle do 24/48 hodin)."
    },
    {
      question: "Potřebuje k fungování WiFi?",
      answer: "Ne! Robot funguje perfektně jen stisknutím tlačítka 'Start' nebo pomocí přiloženého dálkového ovladače. WiFi aplikace je volitelný doplněk pro ty, kteří ho chtějí programovat mimo domov."
    }
  ];
    ...
    <section className="py-16 px-4 bg-white">
      <div className="max-w-3xl mx-auto">
        <div className="flex items-center justify-center gap-2 mb-8">
          ...
          <h2 className="text-3xl font-bold text-center text-gray-900">Často Kladené Dotazy</h2>
        </div>
    ...
    try {
      ...
      if (typeof window !== 'undefined' && (window as unknown as { gtag?: (...args: unknown[]) => void }).gtag) {
        (window as unknown as { gtag: (...args: unknown[]) => void }).gtag('event', 'conversion', {
          'send_to': 'AW-17791478075/GiMlCLO9k9QbELvS0aNC'
        });
      }

      router.push('/ty/ty-gg-robotvac-cz');
    } catch (error) {
    ...
    <section id="order-form" className="py-16 px-4 bg-gradient-to-b from-gray-50 to-orange-100">
      <div className="max-w-xl mx-auto bg-white rounded-3xl shadow-2xl overflow-hidden border-4 border-orange-500 relative">
        ...
        <div className="bg-red-600 text-white text-center py-2 text-sm font-bold animate-pulse">
           🔥 Vysoký zájem: Pouze 3 kusy se Stanicí OMNI v balení!
        </div>

        <div className="bg-white p-6 md:p-8">
          <div className="text-center mb-6">
            <h3 className="text-3xl font-black text-gray-900 uppercase tracking-tight mb-2">Objednávkový Formulář</h3>
            <p className="text-gray-500">Vyplňte níže pro získání kompletního balení.</p>
          </div>

          <div className="bg-orange-50 rounded-xl border-2 border-orange-500 p-5 mb-8 relative overflow-hidden">
             <div className="absolute top-0 right-0 bg-orange-500 text-white text-xs font-bold px-3 py-1 rounded-bl-lg">LIMITOVANÁ NABÍDKA</div>
             ...
             <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                   <h4 className="font-black text-xl text-gray-900">NovaClean X1 BALENÍ</h4>
                   <div className="text-sm text-gray-600">Robot + Stanice + Příslušenství</div>
                </div>
             </div>
             ...
             <div className="space-y-2 border-t border-orange-200 pt-3 text-sm">
                ...
                <div className="flex justify-between items-center font-bold text-orange-500">
                   <span className="flex items-center gap-1"><Sparkles size={14} /> Stanice Omni-Clean</span>
                   <span className="bg-orange-500 text-white px-1 rounded text-xs">ZDARMA</span>
                </div>
                <div className="flex justify-between items-center font-bold text-green-600">
                   <span className="flex items-center gap-1"><Truck size={14} /> Express Doručení</span>
                   <span className="bg-green-600 text-white px-1 rounded text-xs">ZDARMA</span>
                </div>
                <div className="flex justify-between items-center text-red-600 font-bold">
                   <span>Akční Sleva</span>
                   <span>- 2 029 Kč</span>
                </div>
             </div>

             <div className="flex justify-between items-end border-t-2 border-orange-200 mt-3 pt-2">
                <div className="text-xs text-gray-500 font-medium">K úhradě<br/>při doručení:</div>
                <div className="text-3xl font-black text-green-700">1 970 Kč</div>
             </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="block text-xs font-bold text-gray-500 uppercase mb-1 ml-1">Jméno a Příjmení</label>
              <input
                type="text"
                name="name"
                required
            ...
            <div>
              <label className="block text-xs font-bold text-gray-500 uppercase mb-1 ml-1">Telefon (pro kurýra)</label>
              <input
                type="tel"
                name="phone"
                required
            ...
            <div>
              <label className="block text-xs font-bold text-gray-500 uppercase mb-1 ml-1">Kompletní Adresa</label>
              <input
                type="text"
                name="address"
                required
                className="w-full p-4 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-transparent outline-none transition font-medium text-gray-900"
                placeholder="ul. Příkladná 10, 110 00 Praha"
            ...
            <div className="mt-6 border-2 border-green-500 bg-green-50 rounded-xl p-4 flex items-center justify-between cursor-pointer relative">
               <div className="absolute -top-3 left-4 bg-green-500 text-white text-[10px] font-bold px-2 py-0.5 rounded">ZPŮSOB PLATBY</div>
               <div className="flex items-center gap-3">
                  <div className="w-5 h-5 rounded-full border-4 border-green-500 bg-white"></div>
                  <span className="font-bold text-gray-800">Platba na Dobírku</span>
               </div>
            ...
            <div className="flex justify-center items-center gap-2 text-xs text-gray-400 mt-4">
               <Lock size={12} /> Vaše údaje jsou v bezpečí a šifrované SSL 256-bit
            </div>
          </form>
        </div>
      </div>
...
export default function NovaCleanLandingCZ() {
  ...
  return (
    <>
      ...
      <img
        src="https://offers.supertrendaffiliateprogram.com/forms/api/ck/?o=597&uid=0198088f-a4bc-7ed8-89aa-83089fe0180e&lp=597"
      ...
      <div className="min-h-screen pb-24 md:pb-0 font-sans text-gray-900 bg-gray-50">
        ...
        <span className="text-xs font-bold text-gray-700"><span className="text-gray-900">{viewers}</span> lidí si prohlíží tuto stránku</span>
      </div>
        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div className="flex items-center gap-3">
            <div className="hidden md:flex bg-green-100 text-green-800 text-xs font-bold px-3 py-1.5 rounded-full items-center gap-1 shadow-inner border border-green-200">
              <CheckCircle size={14} /> DOPRAVA ZDARMA
            </div>
      ...
      <main>
        <div className="relative bg-[#111] text-white pt-10 pb-20 px-4 overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto text-center relative z-10">
            <div className="inline-block bg-red-600 text-white text-xs md:text-sm font-bold px-3 py-1 rounded-full mb-4 animate-pulse shadow-[0_0_15px_rgba(211,47,47,0.5)]">
              ⚠️ BLESKOVÁ NABÍDKA: STANICE OMNI ZDARMA
            </div>

            <h1 className="text-4xl md:text-6xl font-black leading-tight mb-4 tracking-tight">
              NIKDY SE HO NEDOTÝKEJTE.<br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-yellow-400">ČISTÍ SE SÁM.</span>
            </h1>

            <p className="text-lg md:text-xl text-gray-300 mb-8 max-w-2xl mx-auto leading-relaxed">
              Robot, který Vysává, Mopuje a <span className="text-white font-bold underline decoration-orange-500">Sám se Vyprazdňuje</span>. Technologie za 20 000 Kč, dnes za cenu večeře.
            </p>
            ...
            <div className="mb-8 relative group perspective-1000">
              ...
              <div className="absolute top-4 right-4 md:-right-4 bg-white text-gray-900 p-4 rounded-xl shadow-2xl transform rotate-3 border-4 border-orange-500 z-30">
                <div className="text-xs text-gray-500 font-bold uppercase">Hodnota Balení 7 998 Kč</div>
                <div className="text-sm text-gray-500">Běžná cena <span className="line-through text-gray-400 decoration-red-500 decoration-2">3 999 Kč</span></div>
                <div className="text-4xl font-black text-green-700 tracking-tighter">1 970<span className="text-xl align-top"> Kč</span></div>
              </div>
            </div>
            ...
            >
              OBJEDNEJTE NEŽ DOJDE
              <ArrowDown size={32} className="animate-bounce" />
            </button>

            <div className="mt-6 flex flex-wrap justify-center gap-4 text-sm text-gray-400">
               <span className="flex items-center gap-1"><CheckCircle size={16} className="text-orange-500" /> Platba na Dobírku</span>
               <span className="flex items-center gap-1"><CheckCircle size={16} className="text-orange-500" /> 2 Roky Záruky</span>
               <span className="flex items-center gap-1"><CheckCircle size={16} className="text-orange-500" /> Spokojenost nebo Vrácení</span>
            </div>
          </div>
        </div>
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                 <div className="bg-red-50 p-8 rounded-3xl border border-red-100">
                    ...
                    <ul className="space-y-3 text-gray-600">
                       <li className="flex gap-2">❌ Vyprazdňování nádoby pokaždé.</li>
                       <li className="flex gap-2">❌ Ruční mytí špinavého mopu.</li>
                       <li className="flex gap-2">❌ Prach se vrací po hodině.</li>
                       <li className="flex gap-2">❌ Ohlušující hluk vysavače.</li>
                    </ul>
                 </div>
                 <div className="bg-green-50 p-8 rounded-3xl border border-green-100 shadow-xl relative overflow-hidden">
                    ...
                    <ul className="space-y-3 text-gray-700 font-medium">
                       <li className="flex gap-2">✅ Auto-vyprazdňování na 60 dní.</li>
                       <li className="flex gap-2">✅ Automaticky mytý mop.</li>
                       <li className="flex gap-2">✅ Domov vždy připravený na hosty.</li>
                       <li className="flex gap-2">✅ Více volného času pro vás a rodinu.</li>
                    </ul>
                 </div>
              </div>
           </div>
        ...
        <section className="py-16 px-4 bg-white border-t border-gray-100">
           <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold text-center mb-8">Co dostanete za pouhých 1 970 Kč?</h2>
                 ...
                 <div className="w-full md:w-1/2">
                    ...
                    <ul className="space-y-3">
                       <li className="flex items-center gap-2 p-2 bg-orange-50 rounded-lg shadow-sm border border-orange-200">
                          ...
                          <span className="font-bold">1x NovaStation™ Omni (Hodnota 3 999 Kč)</span>
                       </li>
                       ...
                       <li className="flex items-center gap-2 p-2 bg-white rounded-lg shadow-sm border border-gray-100">
                          <CheckCircle size={18} className="text-green-500" /> 1x Dálkové Ovládání (Baterie v balení)
                       </li>
                       <li className="flex items-center gap-2 p-2 bg-white rounded-lg shadow-sm border border-gray-100">
                          <CheckCircle size={18} className="text-green-500" /> 2x Extra Boční Kartáče
                       </li>
                       <li className="flex items-center gap-2 p-2 bg-white rounded-lg shadow-sm border border-gray-100">
                          <CheckCircle size={18} className="text-green-500" /> 2x Sáčky na Prach 3L
                       </li>
                    </ul>
                    <div className="mt-4 text-xs text-gray-500 bg-yellow-50 p-2 rounded border border-yellow-200 inline-block">
                       🎁 BONUS: Express Doručení s Pojištěním (Zdarma)
                    </div>
                 </div>
              </div>
           </div>
            ...
            <div className="bg-white/5 backdrop-blur-sm p-6 rounded-2xl border border-white/10">
               <div className="flex flex-col md:grid md:grid-cols-5 gap-4 items-center justify-center">
                  ...
                  <div className="col-span-2 w-full">
                     <div className="text-gray-400 text-sm mb-2 font-mono">ZNÁMÉ ZNAČKY</div>
                     ...
                     <div className="mt-2 text-red-400 font-bold text-xl">12 000 - 25 000 Kč</div>
                  </div>
                  ...
                  <div className="col-span-2 w-full transform md:scale-110 transition-transform">
                     ...
                     <div className="mt-2 text-green-600 font-black text-3xl">1 970 Kč</div>
                  </div>
               </div>
            </div>

            <p className="mt-8 text-gray-400 text-sm max-w-2xl mx-auto">
               Eliminovali jsme náklady na branding, televizní reklamy a zprostředkovatele. Platíte jen za technologii, ne za logo.
            </p>
          </div>
        </section>
      ...
      <div className="fixed bottom-0 left-0 w-full bg-white/95 backdrop-blur-md border-t border-gray-200 p-3 md:hidden z-50 shadow-[0_-5px_15px_-5px_rgba(0,0,0,0.1)] pb-safe transition-transform duration-300">
        <div className="flex items-center gap-3">
           <div className="flex-1">
              <div className="text-[10px] text-red-500 font-bold animate-pulse uppercase tracking-wider">⚡ Pouze 7 kusů</div>
              <div className="text-2xl font-black text-green-700 leading-none">1 970<span className="text-sm"> Kč</span></div>
           </div>
           <button
             onClick={() => scrollToSection('order-form')}
