...
export default function LandingPage() {
  ...
  const handleFormSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      router.push('/ty/ty-gg-airwave-hu-unc');
    } catch (error) {
          ...
          <div className="product-info">
            ...
            <div className="product-price">
              <div className="price-row">
                ...
                <span className="price-original">38 999 Ft</span>
                <span className="price-save">-26%</span>
              </div>
            </div>
            ...
            <div style={{ background: 'rgba(255,255,255,0.05)', padding: '2rem', borderRadius: '24px', border: '1px solid rgba(255,255,255,0.1)' }}>
              ...
              <ul style={{ color: '#cbd5e1', listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ display: 'flex', justifyContent: 'space-between', padding: '0.5rem 0', borderBottom: '1px solid rgba(255,255,255,0.1)' }}>
                  <span>Listaár</span> <span style={{ textDecoration: 'line-through' }}>38 999 Ft</span>
                </li>
                <li style={{ display: 'flex', justifyContent: 'space-between', padding: '0.5rem 0', borderBottom: '1px solid rgba(255,255,255,0.1)' }}>
          ...
          <div className="sticky-info" style={{
            ...
            <div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                ...
                <span style={{ fontSize: '0.875rem', textDecoration: 'line-through', color: 'white', opacity: 0.8 }}>38 999 Ft</span>
              </div>
            </div>
          </div>
          <button
