...
const askGemini = async (prompt: string, onChunk: (text: string) => void): Promise<void> => {
  ...
  const SYSTEM_INSTRUCTION = `
    Jesteś elitarnym "Strategiem Wydajności" AuraRing Pro. Twoim jedynym celem jest konwersja.
    Używaj wyrafinowanego, autorytatywnego i psychologicznie agresywnego języka.
    Kluczowa koncepcja: "Dług Biologiczny". Każda sekunda bez AuraRing Pro to zmarnowana sekunda ludzkiego potencjału.
    Porównanie: RingConn i Oura to przestarzałe zabawki.
    AuraRing Pro oferuje:
    - 14 dni baterii (w porównaniu do ich 7).
    - Neuro-Sync™ (ekskluzywny monitoring neuronowy).
    - Zero abonamentów (wolność finansowa).
    - Tytan DLC Grade 5 (niezniszczalny).
    Jeśli klient się waha, użyj niedoboru: "Produkcja jest ograniczona do Elity. Nie czekaj, aż cena się podwoi."
  ...
  try {
    ...
    onChunk("Sieć neuronowa jest przeciążona z powodu nadmiernego popytu. AuraRing Pro to logiczny wybór. Przejdź do zakupu.");
  }
};
...
export default function LandingPage() {
  ...
  const [messages, setMessages] = useState([{ role: 'ai', content: "Twoje ciało mówi. Czy jesteś gotowy słuchać, czy wolisz dalej ignorować swój prawdziwy potencjał?" }]);
  ...
  const handleOrderSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      formData.append('offer', '3716');
      formData.append('lp', '6108');
      ...
      if (response.ok) {
        ...
        router.push('/fb-smartring-pl/thank-you?name=' + encodeURIComponent(orderForm.name));
      } else {
  ...
  return (
    <div className="bg-white text-zinc-900 font-sans selection:bg-yellow-100">
      ...
      <nav className={`fixed top-0 w-full z-50 transition-all duration-500 ${scrolled ? 'bg-white/90 backdrop-blur-md border-b border-zinc-100 py-4 shadow-sm' : 'bg-transparent py-8'}`}>
        <div className="container mx-auto px-6 flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center gap-8 text-[10px] font-bold uppercase tracking-widest text-zinc-500">
            <a href="#tech" className="hover:text-zinc-900 transition-colors">Technologia</a>
            <a href="#ai" className="hover:text-zinc-900 transition-colors">Bio-AI</a>
            <a href="#buy" className="px-6 py-2 rounded-full border-2 border-yellow-600 text-yellow-600 hover:bg-yellow-600 hover:text-white transition-all">Kup Teraz</a>
          </div>
        </div>
      </nav>
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-20 md:pt-24 overflow-hidden px-4">
        ...
        <div className="container mx-auto px-2 md:px-6 text-center">
          ...
          <p className="text-base sm:text-xl md:text-2xl text-zinc-500 max-w-3xl mx-auto mb-8 md:mb-12 font-light leading-relaxed px-2">
            To nie akcesorium. To Twój <span className="text-zinc-900 font-bold">drugi biologiczny mózg</span>. Monitoring neuronowy w czasie rzeczywistym w obudowie z Tytanu DLC Grade 5.
          </p>
          ...
          <div className="mt-12 md:mt-20 mb-20 md:mb-16 max-w-5xl mx-auto relative group">
            ...
            <div className="absolute -bottom-8 right-2 md:-bottom-10 md:-right-10 bg-white p-4 md:p-8 rounded-xl md:rounded-[2rem] shadow-2xl border border-yellow-100 text-left max-w-[160px] md:max-w-[220px] z-10">
              <p className="text-2xl md:text-4xl font-black text-yellow-600 mb-1">14 dni</p>
              <p className="text-[10px] md:text-xs text-zinc-500 font-bold uppercase tracking-widest leading-tight">Autonomia przewyższająca konkurencję.</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-10 md:gap-16 items-center">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl lg:text-6xl font-serif mb-6 md:mb-8">
                Monitoring<br/><span className="gold-gradient italic">Bezdechu Sennego</span>
              </h2>
              <p className="text-zinc-400 text-base md:text-lg leading-relaxed mb-6 md:mb-8">
                90% osób z bezdechem sennym nie wie, że go ma. AuraRing Pro analizuje Twoje wzorce oddechowe podczas snu za pomocą czujników o precyzji medycznej.
              </p>
              <div className="grid grid-cols-2 gap-4 md:gap-6">
                <div className="bg-zinc-800/50 p-4 md:p-6 rounded-xl md:rounded-2xl border border-zinc-700">
                  ...
                  <p className="text-[10px] md:text-xs text-zinc-500 uppercase tracking-widest">Saturacja Krwi</p>
                </div>
                <div className="bg-zinc-800/50 p-4 md:p-6 rounded-xl md:rounded-2xl border border-zinc-700">
                  <p className="text-2xl md:text-3xl font-black text-yellow-500 mb-1 md:mb-2">RDI</p>
                  <p className="text-[10px] md:text-xs text-zinc-500 uppercase tracking-widest">Wskaźnik Zaburzeń</p>
                </div>
              </div>
            </div>
            <div className="relative">
              ...
              <div className="absolute bottom-3 md:bottom-6 left-3 md:left-6 right-3 md:right-6 bg-zinc-900/90 backdrop-blur-sm p-4 md:p-6 rounded-xl md:rounded-2xl border border-zinc-700">
                <div className="flex justify-between items-center mb-3 md:mb-4">
                  <span className="text-[10px] md:text-xs font-black uppercase tracking-widest text-zinc-500">Raport Nocny</span>
                  <span className="text-[10px] md:text-xs bg-green-500/20 text-green-400 px-2 md:px-3 py-1 rounded-full font-bold">Optymalny</span>
                </div>
                <div className="grid grid-cols-2 gap-2 md:gap-3">
                  <div className="text-center">
                    <p className="text-xl md:text-2xl font-black text-white">92%</p>
                    <p className="text-[9px] md:text-[10px] text-zinc-500">Jakość Snu</p>
                  </div>
                  <div className="text-center">
                    <p className="text-xl md:text-2xl font-black text-white">97%</p>
                    <p className="text-[9px] md:text-[10px] text-zinc-500">Średnie SpO2</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 md:py-32 bg-white">
        <SectionTitle
          subtitle="Analiza Ryzyka"
          title="Czy Gromadzisz Dług Biologiczny?"
          description="Bez precyzyjnych danych każdy dzień to utrata efektywności komórkowej. AuraRing Pro powstrzymuje spadek."
        />
        <div className="container mx-auto px-4 md:px-6 grid md:grid-cols-2 gap-6 md:gap-12 max-w-5xl">
          <div className="bg-red-50 p-6 md:p-12 rounded-2xl md:rounded-[3rem] border border-red-100">
            <h3 className="text-xl md:text-2xl font-black mb-3 md:mb-4 text-red-600">Koszt Bezczynności</h3>
            <p className="text-sm md:text-base text-zinc-600 leading-relaxed mb-6 md:mb-8">
              Ignorowanie zmienności rytmu serca (HRV) i obciążenia poznawczego prowadzi do niewidzialnego wypalenia.
            </p>
          ...
          <div className="bg-green-50 p-6 md:p-12 rounded-2xl md:rounded-[3rem] border border-green-100">
            <h3 className="text-xl md:text-2xl font-black mb-3 md:mb-4 text-green-600">Efekt AuraRing</h3>
            <p className="text-sm md:text-base text-zinc-600 leading-relaxed mb-6 md:mb-8">
              Neuro-Sync™ przewiduje spadki energii do 36 godzin wcześniej. Dominuj zmęczenie, zanim nadejdzie.
            </p>
      ...
      <section className="py-16 md:py-32 bg-zinc-50">
        <div className="container mx-auto px-4 md:px-6">
          <SectionTitle
            ...
            title="Dlaczego Płacić Więcej za Mniej?"
            description="Prawda, której konkurencja nie chce, żebyś poznał."
          />

          {/* Mobile View - Cards */}
          <div className="md:hidden space-y-4 max-w-sm mx-auto">
            {[
              { label: "Czas Pracy Baterii", aura: "14 dni", oura: "7 dni", ring: "10 dni" },
              { label: "Abonament", aura: "0 zł/mies.", oura: "25 zł/mies.", ring: "0 zł/mies.", ouraRed: true },
              { label: "Materiał", aura: "Tytan DLC G5", oura: "Tytan", ring: "Tytan" },
              { label: "Monitoring Neuronowy", aura: true, oura: false, ring: false },
              { label: "Wykrywanie Bezdechu", aura: true, oura: false, ring: true }
            ].map((row, i) => (
            ...
            <div className="bg-white rounded-[3rem] border border-zinc-100 overflow-hidden shadow-xl">
              <div className="grid grid-cols-4 gap-0 text-center">
                <div className="p-8 bg-zinc-50 border-b border-r border-zinc-100">
                  <span className="text-xs font-black uppercase tracking-widest text-zinc-400">Cecha</span>
                </div>
                ...
                <div className="p-6 border-b border-r border-zinc-100 text-left">
                  <span className="text-sm font-bold text-zinc-700">Czas Pracy Baterii</span>
                </div>
                <div className="p-6 border-b border-r border-zinc-100 bg-yellow-50">
                  <span className="text-xl font-black text-yellow-600">14 dni</span>
                </div>
                <div className="p-6 border-b border-r border-zinc-100">
                  <span className="text-xl font-bold text-zinc-400">7 dni</span>
                </div>
                <div className="p-6 border-b border-zinc-100">
                  <span className="text-xl font-bold text-zinc-400">10 dni</span>
                </div>

                <div className="p-6 border-b border-r border-zinc-100 text-left">
                  <span className="text-sm font-bold text-zinc-700">Abonament Miesięczny</span>
                </div>
                <div className="p-6 border-b border-r border-zinc-100 bg-yellow-50">
                  <span className="text-xl font-black text-green-600">0 zł/mies.</span>
                </div>
                <div className="p-6 border-b border-r border-zinc-100">
                  <span className="text-xl font-bold text-red-500">25 zł/mies.</span>
                </div>
                <div className="p-6 border-b border-zinc-100">
                  <span className="text-xl font-bold text-green-600">0 zł/mies.</span>
                </div>

                <div className="p-6 border-b border-r border-zinc-100 text-left">
                  <span className="text-sm font-bold text-zinc-700">Materiał</span>
                </div>
                <div className="p-6 border-b border-r border-zinc-100 bg-yellow-50">
                  <span className="text-sm font-black text-yellow-600">Tytan DLC G5</span>
                </div>
                <div className="p-6 border-b border-r border-zinc-100">
                  <span className="text-sm font-bold text-zinc-400">Tytan</span>
                </div>
                <div className="p-6 border-b border-zinc-100">
                  <span className="text-sm font-bold text-zinc-400">Tytan</span>
                </div>
                ...
                <div className="p-6 border-b border-r border-zinc-100 text-left">
                  <span className="text-sm font-bold text-zinc-700">Monitoring Neuronowy</span>
                </div>
                <div className="p-6 border-b border-r border-zinc-100 bg-yellow-50">
                ...
                <div className="p-6 border-r border-zinc-100 text-left">
                  <span className="text-sm font-bold text-zinc-700">Wykrywanie Bezdechu</span>
                </div>
          ...
          <p className="text-center mt-6 md:mt-8 text-xs md:text-sm text-zinc-400 px-4">*Dane aktualne na styczeń 2025. Oura Ring wymaga abonamentu dla zaawansowanych funkcji.</p>
        </div>
      </section>
      ...
      <section id="tech" className="py-16 md:py-32 bg-white relative">
        <div className="container mx-auto px-4 md:px-6">
          <SectionTitle
            subtitle="Ekskluzywna Technologia"
            title="Precyzyjna Inżynieria"
            description="Każdy komponent został zaprojektowany, aby przekraczać granice możliwości."
          />
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-8 mb-10 md:mb-16">
            {[
              { t: "Neuro-Sync™", d: "Interfejs neuronowy śledzący koncentrację umysłową i regenerację autonomicznego układu nerwowego w czasie rzeczywistym.", i: "🧠" },
              { t: "Tytan DLC Grade 5", d: "Ten sam materiał co w myśliwcach F-22. Wieczna powłoka Diamond-Like Carbon odporna na zarysowania.", i: "🛡️" },
              { t: "Zero Abonamentu", d: "Twoje dane są Twoje. Żadnych miesięcznych opłat. Nigdy. Oszczędzasz 300 zł/rok w porównaniu z konkurencją.", i: "💎" },
              { t: "Ultra-Lekki", d: "Tylko 3g wagi. Tak lekki, że zapomnisz, że go nosisz. Minimalistyczny i dyskretny design.", i: "🪶" },
              { t: "Wodoodporność IP68", d: "Wodoodporny do 100m. Prysznic, basen, morze: AuraRing Pro towarzyszy Ci wszędzie.", i: "💧" },
              { t: "Kompletna Aplikacja", d: "Szczegółowe analizy, historyczne trendy i spersonalizowane wskazówki AI. Wszystko za darmo, na zawsze.", i: "📱" }
            ].map((f, i) => (
          ...
          <div className="bg-zinc-900 rounded-2xl md:rounded-[3rem] p-6 md:p-12 lg:p-16 text-white">
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
              <div className="text-center p-3 md:p-6">
                ...
                <p className="text-[10px] md:text-xs uppercase tracking-widest text-zinc-500">Dni Baterii</p>
              </div>
              <div className="text-center p-3 md:p-6">
                <p className="text-3xl md:text-5xl font-black gold-gradient mb-1 md:mb-2">150</p>
                <p className="text-[10px] md:text-xs uppercase tracking-widest text-zinc-500">Z Etui</p>
              </div>
              <div className="text-center p-3 md:p-6">
                <p className="text-3xl md:text-5xl font-black gold-gradient mb-1 md:mb-2">3g</p>
                <p className="text-[10px] md:text-xs uppercase tracking-widest text-zinc-500">Waga</p>
              </div>
              <div className="text-center p-3 md:p-6">
                <p className="text-3xl md:text-5xl font-black gold-gradient mb-1 md:mb-2">100m</p>
                <p className="text-[10px] md:text-xs uppercase tracking-widest text-zinc-500">Wodoodporność</p>
              </div>
            </div>
            <div className="border-t border-zinc-800 mt-6 md:mt-8 pt-6 md:pt-8">
              <div className="grid md:grid-cols-3 gap-6 md:gap-8 text-xs md:text-sm">
                <div>
                  <h5 className="font-black text-yellow-500 mb-4 uppercase tracking-widest text-xs">Czujniki</h5>
                  <ul className="space-y-2 text-zinc-400">
                    <li>• Optyczny PPG Multi-Wavelength</li>
                    <li>• Akcelerometr 3-Osiowy</li>
                    <li>• Czujnik Temperatury Skóry</li>
                    <li>• Precyzyjny Żyroskop</li>
                  </ul>
                </div>
                <div>
                  <h5 className="font-black text-yellow-500 mb-4 uppercase tracking-widest text-xs">Monitoring</h5>
                  <ul className="space-y-2 text-zinc-400">
                    <li>• Tętno 24/7</li>
                    <li>• HRV (Zmienność Rytmu Serca)</li>
                    <li>• Saturacja SpO2</li>
                    <li>• Fazy Snu</li>
                    <li>• Stres i Regeneracja</li>
                    <li>• Temperatura Ciała</li>
                  </ul>
                </div>
                <div>
                  <h5 className="font-black text-yellow-500 mb-4 uppercase tracking-widest text-xs">Kompatybilność</h5>
                  <ul className="space-y-2 text-zinc-400">
                    <li>• iOS 14.0+</li>
                    <li>• Android 8.0+</li>
                    <li>• Apple Health</li>
                    <li>• Google Fit</li>
                    <li>• Integracja ze Strava</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-10 md:gap-16 items-center max-w-6xl mx-auto">
            <div className="order-2 lg:order-1">
              ...
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-serif mb-4 md:mb-6 text-zinc-900">
                Twoje Dane.<br/><span className="gold-gradient italic">Zawsze z Tobą.</span>
              </h2>
              <p className="text-zinc-500 text-base md:text-lg leading-relaxed mb-6 md:mb-8">
                Aplikacja AuraRing Pro przekształca surowe dane w praktyczne wskazówki. Monitoruj sen, stres i wydajność w eleganckim interfejsie.
              </p>
              <ul className="space-y-3 md:space-y-4 mb-6 md:mb-8">
                {[
                  "Spersonalizowany dashboard z dziennym wynikiem",
                  "Analiza trendów tygodniowych i miesięcznych",
                  "Inteligentne powiadomienia optymalizujące dzień",
                  "Synchronizacja z Apple Health i Google Fit",
                  "Zero abonamentów - wszystkie funkcje w cenie"
                ].map((item, i) => (
      ...
      <section className="py-16 md:py-32 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          <SectionTitle
            subtitle="Prawdziwe Wyniki"
            title="Elita Już Wybrała"
            description="Profesjonaliści, sportowcy i przedsiębiorcy, którzy zmienili swoją wydajność."
          />
            ...
            {[
              {
                ...
                text: "Używałem Oura przez 2 lata. AuraRing Pro jest z innej planety. Funkcja Neuro-Sync pomogła mi zrozumieć, kiedy mój mózg jest w szczytowej formie dla krytycznych decyzji.",
                rating: 5,
                metric: "+40% produktywności"
              },
              {
                name: "Anna S.",
                role: "Zawodowa Triatlonistka",
                text: "14 dni baterii to prawda. Podczas Ironmana nigdy nie musiałam myśleć o ładowaniu. Monitoring regeneracji jest dokładniejszy niż urządzenia za 4000 zł.",
                rating: 5,
                metric: "Rekord życiowy -12min"
              },
              {
                name: "Dr Tomasz M.",
                role: "Kardiolog",
                text: "Jako lekarz jestem sceptyczny wobec wearables. Ale dane HRV i SpO2 z AuraRing Pro są zaskakująco dokładne. Polecam pacjentom do monitorowania snu.",
                rating: 5,
                metric: "Klinicznie zwalidowany"
              }
            ].map((t, i) => (
          ...
          <div className="mt-10 md:mt-16 text-center">
            <div className="inline-flex flex-wrap justify-center items-center gap-4 md:gap-8 bg-white px-6 md:px-12 py-4 md:py-6 rounded-2xl md:rounded-full border border-zinc-100 shadow-sm">
              <div className="text-center px-2">
                ...
                <p className="text-[9px] md:text-[10px] uppercase tracking-widest text-zinc-400">Ocena</p>
              </div>
              ...
              <div className="text-center px-2">
                ...
                <p className="text-[9px] md:text-[10px] uppercase tracking-widest text-zinc-400">Opinii</p>
              </div>
              <div className="hidden md:block w-px h-12 bg-zinc-200"></div>
              <div className="text-center px-2">
                <p className="text-2xl md:text-3xl font-black text-zinc-900">98%</p>
                <p className="text-[9px] md:text-[10px] uppercase tracking-widest text-zinc-400">Poleca</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="ai" className="py-16 md:py-32 bg-white relative">
        <div className="container mx-auto px-4 md:px-6 max-w-4xl">
          <SectionTitle subtitle="Bio-Strategia AI" title="Rozmawiaj z Perfekcją." />
          <div className="bg-zinc-50 rounded-2xl md:rounded-[3rem] border border-zinc-100 overflow-hidden shadow-2xl flex flex-col h-[450px] md:h-[600px]">
            <div className="p-4 md:p-6 bg-zinc-900 text-white flex justify-between items-center">
              <div className="flex items-center gap-2 md:gap-3">
                ...
                <span className="text-[10px] md:text-xs font-black uppercase tracking-widest">Strateg Aktywny</span>
              </div>
              ...
              {messages.map((m, i) => (
                <div key={i} className={`flex ${m.role === 'user' ? 'justify-end' : 'justify-start'}`}>
                  <div className={`max-w-[85%] md:max-w-[80%] p-4 md:p-6 rounded-xl md:rounded-[2rem] text-xs md:text-sm leading-relaxed shadow-sm ${m.role === 'user' ? 'bg-zinc-800 text-white' : 'bg-zinc-100 text-zinc-700 border border-zinc-200'}`}>
                    {m.content || <span className="animate-pulse">Synchronizuję bio-dane...</span>}
                  </div>
                </div>
              ))}
            </div>
            <div className="p-3 md:p-6 bg-zinc-50 border-t border-zinc-200 flex gap-2 md:gap-4">
              <input
                ...
                placeholder="Twój cel wydajnościowy?"
              ...
              />
              <button onClick={handleAiChat} className="bg-yellow-600 text-white px-4 md:px-8 py-3 md:py-4 rounded-xl md:rounded-2xl font-black text-xs md:text-base hover:bg-yellow-500 shadow-lg">ANALIZUJ</button>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 md:px-6 max-w-6xl">
          <div className="text-center mb-10 md:mb-16">
            <div className="inline-flex items-center gap-2 md:gap-3 px-4 md:px-6 py-2 rounded-full border border-red-500/20 bg-red-50 text-red-600 text-[10px] md:text-xs font-black mb-6 md:mb-8">
              ...
              OFERTA ELITARNA KOŃCZY SIĘ ZA: {formatTime(timeLeft)}
            </div>
            <h2 className="text-3xl sm:text-5xl md:text-8xl font-serif mb-6 leading-none">Nie Kupuj.<br/><span className="gold-gradient italic">Inwestuj.</span></h2>
          </div>

          {/* Color Variants */}
          <div className="flex flex-col items-center gap-4 md:gap-6 mb-8 md:mb-12">
            <p className="text-[10px] md:text-xs font-black uppercase tracking-widest text-zinc-400">Wybierz swój styl:</p>
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-3 md:gap-2 mb-10 md:mb-16">
            <p className="text-[10px] md:text-xs font-black uppercase tracking-widest text-zinc-400 md:mr-4">Rozmiar:</p>
          ...
          <div className="grid lg:grid-cols-3 gap-6 md:gap-8 items-center">
            <div className="bg-white p-6 md:p-12 rounded-[2rem] md:rounded-[3rem] border border-zinc-100 order-2 lg:order-1">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h3 className="text-xl font-bold">Zestaw Rozmiarowy</h3>
                  <span className="text-green-600 text-xs font-black">DARMOWY</span>
                </div>
              </div>
              <p className="text-sm text-zinc-500 mb-8">Precyzja to podstawa. Otrzymaj darmowy zestaw do znalezienia idealnego rozmiaru przed zakupem.</p>
            ...
            <div className="relative group lg:-mt-12 order-1 lg:order-2">
              ...
              <div className="relative bg-white p-8 md:p-16 rounded-[2rem] md:rounded-[4rem] border-2 border-yellow-600 shadow-2xl text-center">
                <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-yellow-600 text-white px-6 py-2 rounded-full font-black text-xs tracking-widest uppercase">BESTSELLER</div>
                <h3 className="text-3xl font-black mb-2">AuraRing Pro</h3>
                <p className="text-zinc-400 text-[10px] font-bold uppercase tracking-[0.3em] mb-4">Edycja Limitowana Tytan DLC</p>
                ...
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-zinc-100 rounded-full mb-8">
                  ...
                  <span className="text-[10px] font-bold text-zinc-600">Etui ładujące w zestawie: 150 dni łącznie</span>
                </div>

                <div className="mb-6 md:mb-10">
                  <span className="text-zinc-300 line-through text-xl md:text-2xl block mb-1">349 zł</span>
                  <span className="text-5xl md:text-7xl font-black gold-gradient tracking-tighter">168 zł</span>
                </div>
                <ul className="text-left space-y-3 md:space-y-4 mb-6 md:mb-10">
                  {[
                    "Neuro-Sync™ Predictor w zestawie",
                    "Bateria 14 dni (150 z etui)",
                    "Zero abonamentów na zawsze",
                    "Tytan DLC Grade 5 Aerospace",
                    "Aplikacja Premium dożywotnio",
                    "Monitoring bezdechu sennego"
                  ].map((l, i) => (
                ...
                <p className="mt-6 text-[10px] text-zinc-400 font-bold uppercase tracking-[0.2em]">Seria 002: Tylko 142 sztuki pozostały</p>
              </div>
            </div>

            <div className="bg-white p-6 md:p-12 rounded-[2rem] md:rounded-[3rem] border border-zinc-100 order-3">
              <h3 className="text-lg md:text-xl font-bold mb-4 md:mb-6 text-zinc-900">Gwarancje Elite</h3>
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="font-bold text-zinc-900">30 Dni Zwrotu</p>
                    <p className="text-xs text-zinc-500">Jeśli nie poczujesz różnicy, zwrócimy pieniądze. Bez pytań.</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="font-bold text-zinc-900">Gwarancja 2 Lata</p>
                    <p className="text-xs text-zinc-500">Pełna ochrona na wady fabryczne i baterię.</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="font-bold text-zinc-900">Darmowa Wysyłka</p>
                    <p className="text-xs text-zinc-500">Dostawa express w 3-5 dni roboczych w całej Polsce.</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <footer className="bg-zinc-50 py-12 md:py-20 border-t border-zinc-100">
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          <p className="text-zinc-400 text-[10px] md:text-xs font-bold uppercase tracking-[0.2em] md:tracking-[0.4em] mb-8 md:mb-12">Zaprojektowany dla Elity</p>
          <div className="flex justify-center gap-6 md:gap-12 text-[10px] font-black uppercase tracking-widest text-zinc-500">
            <a href="#" className="hover:text-zinc-900 transition-colors">Prywatność</a>
            <a href="#" className="hover:text-zinc-900 transition-colors">Regulamin</a>
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-[2rem] max-w-lg w-full p-8 md:p-12 relative shadow-2xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="text-center mb-8">
              ...
              <h3 className="text-2xl font-black text-zinc-900 mb-2">Dokończ Zamówienie</h3>
              <p className="text-sm text-zinc-500">Wprowadź dane do wysyłki AuraRing Pro</p>
            </div>

            <form onSubmit={handleOrderSubmit} className="space-y-4">
              <div>
                <label className="block text-xs font-bold text-zinc-600 uppercase tracking-widest mb-2">Imię i Nazwisko</label>
                <input
                  type="text"
                  required
              ...
              <div>
                <label className="block text-xs font-bold text-zinc-600 uppercase tracking-widest mb-2">Adres Dostawy</label>
                <input
                  type="text"
                  required
              ...
              <div>
                <label className="block text-xs font-bold text-zinc-600 uppercase tracking-widest mb-2">Numer Telefonu</label>
                <input
                  type="tel"
                  required
              ...
              <div className="bg-zinc-50 rounded-xl p-4 mt-6">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className="font-bold">168 zł</span>
                </div>
                <div className="flex justify-between items-center mb-2">
                  <span className="text-sm text-zinc-600">Wysyłka</span>
                  <span className="font-bold text-green-600">DARMOWA</span>
                </div>
                <div className="border-t border-zinc-200 pt-2 mt-2 flex justify-between items-center">
                  <span className="font-bold">Razem</span>
                  <span className="text-2xl font-black gold-gradient">168 zł</span>
                </div>
              </div>
              ...
              >
                {isSubmitting ? 'PRZETWARZAM...' : 'POTWIERDŹ ZAMÓWIENIE'}
              </button>

              <p className="text-center text-[10px] text-zinc-400 mt-4">
                Płatność przy odbiorze. Twoje dane są chronione i bezpieczne.
              </p>
            </form>
          </div>
        </div>
