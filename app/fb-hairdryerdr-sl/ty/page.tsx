    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{
          ...
          {"Va\u0161 AuraStyler\u2122 Kompletni set se pripravlja in bo kmalu poslan."}
        </p>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '0.8rem', color: '#9f1239', fontWeight: 600, marginBottom: '0.25rem' }}>{"KODA NARO\u010cILA"}</div>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: '0.75rem', marginBottom: '0.75rem' }}>
            ...
            <div>
              <div style={{ fontWeight: 600, color: '#1E293B', fontSize: '0.9rem' }}>{"Po\u0161iljanje paketa"}</div>
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontWeight: 600, color: '#92400e', fontSize: '0.9rem' }}>{"Pla\u010dilo po prevzemu: 59,00\u20ac"}</div>
            <div style={{ color: '#a16207', fontSize: '0.8rem' }}>{"Pripravite to\u010den znesek za kurjerja"}</div>
          </div>
        </div>
        ...
        <div style={{
          ...
          {"Imate vpra\u0161anja? Pi\u0161ite nam: "}<a href="mailto:info@purchstar.com" style={{ color: '#e11d48', fontWeight: 600, textDecoration: 'none' }}>info@purchstar.com</a>
        </div>

        <a href="/fb-hairdryerdr-sl" style={{
