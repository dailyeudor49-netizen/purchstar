    ...
    <div className="border-2 border-orange-400 rounded-2xl p-5 md:p-4 bg-white shadow-xl">
      ...
      <div className="bg-red-600 text-white text-center py-2 px-3 rounded-xl mb-4 animate-pulse">
        <span className="text-base md:text-sm font-bold flex items-center justify-center gap-2">
          ...
          POZOR: Na sklade zostáva len 7 kusov!
        </span>
      </div>

      {/* Price - NEURO: Anchoring with big crossed price */}
      <div className="mb-5 text-center">
        <div className="text-gray-400 line-through text-2xl md:text-xl mb-1">160 €</div>
        <div className="flex items-baseline justify-center gap-2">
          <span className="text-5xl md:text-4xl font-black text-green-600">69</span>
      ...
      <div className="bg-green-50 border-2 border-green-400 rounded-xl p-4 mb-5">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="font-bold text-green-800 text-lg md:text-base">DARČEK: Omni Stanica</p>
            <p className="text-green-700 text-base md:text-sm">Hodnota 160 € - Dnes 0 €!</p>
          </div>
        </div>
      </div>
      ...
      <div className="mb-5">
        <div className="flex justify-between text-base md:text-sm mb-2">
          <span className="text-red-600 font-bold">Zostáva len 7 kusov!</span>
      ...
      >
        OBJEDNÁVAM - PLATÍM PRI PREVZATÍ
      </button>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-xl p-3 mb-4">
        <div className="flex items-center justify-center gap-3 text-blue-800">
          <CreditCard size={22} />
          <span className="font-bold text-base md:text-sm">Platba LEN pri prevzatí</span>
        </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <div className="flex items-center gap-2 bg-gray-50 p-3 rounded-xl">
          ...
          <span className="text-sm font-semibold text-gray-700">CE certifikát</span>
        </div>
      </div>
    </div>
  );
...
const ProductInfo: React.FC = () => (
  <div className="space-y-5">
    ...
    <h1 className="text-3xl md:text-3xl font-black text-gray-900 leading-tight">
      NovaClean X1 - Robot, ktorý sa <span className="text-orange-500">Sám Čistí</span> a <span className="text-green-600">Šetrí Váš Čas</span>
    </h1>
    ...
    <div className="space-y-4">
      ...
      <ul className="space-y-4">
        <li className="flex items-start gap-4 bg-green-50 p-4 rounded-xl border-l-4 border-green-500">
          ...
          <div>
            <span className="font-bold text-lg md:text-base text-gray-900 block">Získajte 2-3 hodiny DENNE</span>
        ...
        <li className="flex items-start gap-4 bg-blue-50 p-4 rounded-xl border-l-4 border-blue-500">
          ...
          <div>
            <span className="font-bold text-lg md:text-base text-gray-900 block">NULOVÝ kontakt so špinou</span>
            <span className="text-gray-600 text-base md:text-sm">Omni Stanica automaticky vyprázdňuje, umýva a suší - 60 dní sa nedotýkate prachu!</span>
          </div>
        </li>
        <li className="flex items-start gap-4 bg-purple-50 p-4 rounded-xl border-l-4 border-purple-500">
          ...
          <div>
            <span className="font-bold text-lg md:text-base text-gray-900 block">Domov VŽDY pripravený na hostí</span>
            <span className="text-gray-600 text-base md:text-sm">360° LiDAR navigácia - upratuje pod nábytkom, obchádza prekážky, nepadá zo schodov</span>
          </div>
        </li>
        <li className="flex items-start gap-4 bg-yellow-50 p-4 rounded-xl border-l-4 border-yellow-500">
          ...
          <div>
            <span className="font-bold text-lg md:text-base text-gray-900 block">Ideálne pre alergikov a majiteľov zvierat</span>
            <span className="text-gray-600 text-base md:text-sm">HEPA H13 filter zachytáva 99,97% alergénov - dýchate čistý vzduch</span>
          </div>
        </li>
        <li className="flex items-start gap-4 bg-orange-50 p-4 rounded-xl border-l-4 border-orange-500">
          ...
          <div>
            ...
            <span className="text-gray-600 text-base md:text-sm">Iba 55dB - môžete spať, pozerať TV alebo pracovať bez rušenia</span>
          </div>
        </li>
      </ul>
    </div>
    ...
    <div className="bg-gradient-to-br from-orange-50 to-yellow-50 border-2 border-orange-300 rounded-2xl p-5 md:p-4">
      <h3 className="font-black text-xl md:text-lg text-gray-900 mb-4 flex items-center gap-2">
        ...
        Kompletný balík obsahuje:
      </h3>
      <div className="grid grid-cols-1 gap-3">
        <div className="flex items-center gap-3 bg-white p-3 rounded-xl shadow-sm">
          <CheckCircle size={24} className="text-orange-500" />
          <span className="font-bold text-base text-gray-900">NovaStation Omni (hodnota 160 €) - DARČEK!</span>
        </div>
        <div className="flex items-center gap-3 bg-white p-3 rounded-xl shadow-sm">
          <CheckCircle size={24} className="text-green-500" />
          <span className="text-base text-gray-700">NovaClean X1 Robot s LiDAR navigáciou</span>
        </div>
        <div className="flex items-center gap-3 bg-white p-3 rounded-xl shadow-sm">
          <CheckCircle size={24} className="text-green-500" />
          <span className="text-base text-gray-700">Diaľkový ovládač + batérie</span>
        </div>
        <div className="flex items-center gap-3 bg-white p-3 rounded-xl shadow-sm">
          <CheckCircle size={24} className="text-green-500" />
          <span className="text-base text-gray-700">2x bočné kefy + 2x 3L vrecká</span>
        </div>
        <div className="flex items-center gap-3 bg-white p-3 rounded-xl shadow-sm">
          <CheckCircle size={24} className="text-green-500" />
          <span className="text-base text-gray-700">Návod v slovenčine</span>
        </div>
      </div>
    </div>
  </div>
...
const SpecsTable: React.FC = () => {
  const specs = [
    { label: 'Sací výkon', value: '6000 Pa', detail: 'Nidec Brushless motor (Japonsko)' },
    { label: 'Batéria', value: '5200 mAh', detail: 'Až 180 min prevádzky' },
    { label: 'Navigácia', value: 'LiDAR LDS 4.0', detail: '360° mapovanie + SLAM AI' },
    { label: 'Hlučnosť', value: '< 55 dB', detail: 'Ultra-tichý nočný režim' },
    { label: 'Pripojenie', value: 'WiFi 2.4/5 GHz', detail: 'Alexa, Google Home, App' },
    { label: 'Nádoba na prach', value: '3L (stanica) / 400ml (robot)', detail: 'Automatické vyprázdňovanie 60 dní' },
    { label: 'Prekážky', value: 'Do 20 mm', detail: 'Off-Road kolesá' },
  ...
  return (
    <div className="border border-gray-200 rounded-2xl overflow-hidden">
      <div className="bg-gray-100 px-5 py-4 border-b border-gray-200">
        <h3 className="font-black text-xl md:text-lg text-gray-900">Technické špecifikácie</h3>
      </div>
  ...
  const features = [
    {
      ...
      title: "2-v-1: Vysávanie a Mopovanie",
      desc: "Cyklónový motor vysáva prach, handrička z mikrovlákna odstraňuje odolné škvrny. Jeden prejazd, dvojitý efekt."
    },
    {
      icon: <Navigation className="w-8 h-8" />,
      title: "Smart 3.0 Navigácia",
      desc: "Nepadá zo schodov a nenarráža prudko. IR senzory mapujú miestnosť a obchádzajú prekážky."
    },
    {
      icon: <Smartphone className="w-8 h-8" />,
      title: "Kompletné Ovládanie z Telefónu",
      desc: "Použite diaľkový ovládač alebo priloženú aplikáciu. Spustite upratovanie z kancelárie a príďte do žiarivého domu."
    },
    {
      icon: <Battery className="w-8 h-8" />,
      title: "Automatické Nabíjanie",
      desc: "Keď sa batéria vybije, sám sa vráti na NovaStation, nabije sa, vyprázdni a pokračuje."
    },
    {
      icon: <Wind className="w-8 h-8" />,
      title: "Super Tichý - 55dB",
      desc: "Menej ako 65dB. Môžete pozerať TV alebo uspávať deti, zatiaľ čo ticho pracuje."
    },
    {
      icon: <ShieldCheck className="w-8 h-8" />,
      title: "HEPA H13 Filter",
      desc: "Zachytáva 99,9% alergénov a jemného prachu. Ideálne pre alergikov a majiteľov zvierat."
    }
  ];
  ...
  <div className="border-2 border-orange-400 rounded-2xl overflow-hidden shadow-lg">
    <div className="bg-gradient-to-r from-orange-500 to-red-500 px-5 py-4">
      <h3 className="font-black text-xl md:text-lg text-white flex items-center gap-3">
        <Gift size={24} />
        DARČEK: NovaStation Omni Stanica (hodnota 160 €)
      </h3>
    </div>
      ...
      <div className="flex flex-col md:flex-row gap-6">
        ...
        <div className="md:w-2/3 grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="flex gap-4 p-4 bg-white rounded-xl shadow-sm border border-orange-100">
            ...
            <div>
              <h4 className="font-bold text-gray-900 text-lg md:text-base">Automatické Vyprázdňovanie</h4>
              <p className="text-gray-600 text-base md:text-sm">3L vrecko vystačí na 2 mesiace!</p>
            </div>
          </div>
          <div className="flex gap-4 p-4 bg-white rounded-xl shadow-sm border border-orange-100">
          ...
          <div className="flex gap-4 p-4 bg-white rounded-xl shadow-sm border border-orange-100">
            ...
            <div>
              <h4 className="font-bold text-gray-900 text-lg md:text-base">Sušenie pri 45°C</h4>
          ...
          <div className="flex gap-4 p-4 bg-white rounded-xl shadow-sm border border-orange-100">
            ...
            <div>
              ...
              <p className="text-gray-600 text-base md:text-sm">+30% rýchlejšie pripravený na prácu</p>
            </div>
          </div>
        </div>
      </div>
  ...
  const reviews = [
    {
      ...
      text: "Úprimne, bol som skeptický kvôli cene. Ale vysáva lepšie ako môj starý iRobot za 400 €. Psie chlpy už nie sú problém.",
      helpful: 47
    },
    {
      name: "Anna M.",
      ...
      rating: 5,
      date: "pred týždňom",
      title: "Rýchle doručenie, super produkt",
      text: "Prišiel do 24 hodín. Mopovanie nie je také hlboké ako ručné, ale na denné udržiavanie čistoty je ideálny. Odporúčam!",
      helpful: 32
    },
    {
      name: "Peter N.",
      ...
      rating: 5,
      date: "pred 3 dňami",
      title: "Najlepší nákup roka",
      text: "Batéria je neuveriteľná. Vyčistí celý môj 80m² byt a ešte zostane nabitie. Najlepší nákup roka pre manželku (a pre mňa).",
      helpful: 28
    }
  ];
          ...
          <div key={index} className="p-5">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-500 mb-2">Dátum recenzie: {review.date}</p>
...
const FAQSection: React.FC = () => {
  ...
  const faqs = [
    {
      question: "Zvláda dobre chlpy domácich zvierat?",
      answer: "Absolútne áno. Centrálna kefa v tvare V a silné cyklónové sanie boli navrhnuté špeciálne na zbieranie psích a mačacích chlpov bez zamotania."
    },
    {
      question: "Kde nájdem náhradné diely?",
      answer: "Ponúkame sady náhradných dielov (kefy, HEPA filtre, handričky) priamo na našej stránke za výrobné ceny. Okrem toho sú komponenty univerzálne a ľahko dostupné."
    },
    {
      question: "Vzťahuje sa záruka na poruchy?",
      answer: "Áno, ponúkame 2-ročnú Priamu Záruku. Ak má robot technickú chybu, vymeníme ho zadarmo za nový. 100% slovenská podpora."
    },
    {
      question: "Ako funguje platba pri prevzatí?",
      answer: "Veľmi jednoducho. Teraz objednáte vyplnením formulára, nič neplatíte online. Zaplatíte hotovosťou priamo kuriérovi pri doručení balíka (zvyčajne do 24/48 hodín)."
    },
    {
      question: "Potrebujem WiFi na fungovanie?",
      answer: "Nie! Robot funguje perfektne jednoducho stlačením tlačidla 'Štart' alebo pomocou priloženého diaľkového ovládača. WiFi aplikácia je voliteľný bonus pre tých, ktorí ho chcú programovať mimo domu."
    }
  ];
...
const OrderForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      router.push('/ty/ty-fb-robotvacisl-sk');
    } catch (error) {
  ...
  return (
    <div id="order-form" className="border-4 border-orange-500 rounded-2xl overflow-hidden bg-white shadow-2xl">
      <div className="bg-gradient-to-r from-orange-500 to-red-500 px-5 py-4">
        ...
        <p className="text-orange-100 text-center text-base md:text-sm mt-1">Platba LEN pri prevzatí - 0 € rizika!</p>
      </div>
      <div className="p-6">
        <form onSubmit={handleSubmit} className="space-y-5">
          <input type="hidden" name="tmfp" />
          <input type="hidden" name="offer" value="2664" />
          ...
          <div>
            ...
            <input
              ...
              required
              className="w-full p-4 text-lg border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-orange-500 outline-none"
              placeholder="Príkladná ulica 10, 811 01 Bratislava"
          ...
          <div className="bg-green-50 border-2 border-green-400 rounded-xl p-4 flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-base text-gray-600">Hotovosťou alebo kartou kuriérovi</p>
            </div>
          </div>
...
/* --- MAIN PAGE --- */
export default function NovaCleanFBRobotVacISLSK() {
  const scrollToOrder = () => {
  ...
  return (
    <>
      ...
      <img
        src="https://offers.islaffiliate.com/forms/api/ck/?o=2664&uid=019bbd3b-0068-7ba3-b472-c0cccc3adcea&lp=4916"
      ...
      <div className="min-h-screen bg-white font-sans" suppressHydrationWarning>
        ...
        <div className="bg-gradient-to-r from-red-600 to-orange-500 text-white text-center py-3 px-4">
          <span className="text-base md:text-sm font-bold animate-pulse block">
            POSLEDNÉ KUSY! Omni Stanica DARČEK (160 €) - Len dnes!
          </span>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 py-6">
          ...
          <div className="mt-12 bg-gradient-to-r from-green-50 to-blue-50 border-2 border-green-300 rounded-2xl p-6 md:p-8">
            <div className="flex flex-col md:flex-row items-center gap-6 text-center md:text-left">
              ...
              <div className="flex-1">
                <h3 className="font-black text-2xl md:text-xl text-gray-900 mb-2">100% Garancia Spokojnosti</h3>
                <p className="text-lg md:text-base text-gray-600">
                  Ak NovaClean X1 nesplní vaše očakávania, prevezmeme ho a vrátime každé euro. <span className="font-bold text-green-700">Bez otázok, bez rizika.</span>
                </p>
              </div>
              <div className="flex-shrink-0 flex gap-6 md:gap-4">
                ...
                <div className="text-center">
                  ...
                  <span className="text-sm font-semibold text-gray-600 block mt-1">Bezplatné vrátenie</span>
                </div>
                <div className="text-center">
        ...
        <div className="lg:hidden fixed bottom-0 left-0 right-0 bg-white border-t-2 border-orange-400 p-4 shadow-2xl z-50">
          <div className="flex items-center gap-4">
            <div className="flex-1">
              <div className="text-sm text-gray-400 line-through">160 €</div>
              <div className="text-2xl font-black text-green-600">69 €</div>
            </div>
            <button
