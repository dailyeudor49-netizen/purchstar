  ...
  <div className="bg-white/5 backdrop-blur-md border border-white/10 p-5 md:p-8 rounded-2xl md:rounded-3xl hover:border-blue-500/30 transition-all duration-500 group text-left">
    ...
    <div className="mt-4 md:mt-6 pt-4 md:pt-6 border-t border-white/5 flex items-center justify-between">
      <div className="flex items-center gap-2 text-[10px] md:text-xs text-green-500 font-bold">
        <CheckCircle2 className="w-3 h-3 md:w-4 md:h-4" /> Ověřený nákup
      </div>
    </div>
  </div>
);
...
function LandingPageContent() {
  ...
  const handleOrder = async (e: React.FormEvent) => {
    ...
    if (formData.fullName && formData.address && formData.phone && !isSubmitting) {
      ...
      try {
        ...
        apiFormData.append('offer', '121');
        apiFormData.append('lp', '121');
        ...
        router.push('/fb-miniphonerk-cz/ty');
      } catch (error) {
  ...
  return (
    <div className="min-h-screen bg-black text-white selection:bg-blue-500 selection:text-white font-sans overflow-x-hidden">
      ...
      <img
        src="https://offers.supertrendaffiliateprogram.com/forms/api/ck/?o=121&uid=0198088f-a4bc-7ed8-89aa-83089fe0180e&lp=121"
      ...
      <div className="bg-blue-600 text-white text-[10px] md:text-xs py-2 text-center font-bold uppercase tracking-widest z-[60] relative">
        ⚡ PRÉMIOVÁ NABÍDKA: Zbývá pouze 14 kusů na skladě ⚡
      </div>
      ...
      <nav className={`fixed top-8 w-full z-50 transition-all duration-300 px-4 md:px-0`}>
        <div className={`max-w-4xl mx-auto px-6 py-4 flex justify-between items-center rounded-full transition-all duration-300 ${scrolled ? 'bg-black/60 backdrop-blur-xl border border-white/10 shadow-2xl translate-y-[-20px]' : 'bg-transparent'}`}>
          ...
          <div className="hidden md:flex gap-8 text-[10px] font-black uppercase tracking-[0.2em] text-gray-400">
            <a href="#vision" onClick={(e) => handleNavClick(e, 'vision')} className="hover:text-white transition-colors">Vize</a>
            <a href="#confronto" onClick={(e) => handleNavClick(e, 'confronto')} className="hover:text-white transition-colors">Srovnání</a>
            <a href="#recensioni" onClick={(e) => handleNavClick(e, 'recensioni')} className="hover:text-white transition-colors">Recenze</a>
          </div>
      ...
      <Section id="home" className="relative pt-32 md:pt-48 pb-16 md:pb-20 flex flex-col items-center text-center">
        ...
        <span className="inline-block px-3 md:px-4 py-1 rounded-full bg-white/5 border border-white/10 text-[8px] md:text-[10px] font-bold tracking-[0.2em] md:tracking-[0.3em] uppercase mb-6 md:mb-8 text-blue-400 animate-pulse max-w-[90%] leading-relaxed">
          JEDINÝ SMARTPHONE, KTERÝ VÁM VRÁTÍ SVOBODU
        </span>
        ...
        <h1 className="text-4xl md:text-9xl font-black tracking-tighter leading-none mb-4 md:mb-6 bg-clip-text text-transparent bg-gradient-to-b from-white to-neutral-500">
          Budoucnost.<br /><span className="text-blue-500">V Kapse.</span>
        </h1>

        <p className="max-w-2xl text-base md:text-xl text-gray-400 mb-8 md:mb-12 leading-relaxed px-2 font-light italic">
          Zminiaturizovali jsme dokonalost. Mini 17 Pro není kompromis, je to prohlášení nezávislosti od obrovských telefonů.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 md:gap-6 mb-12 md:mb-24">
          ...
          >
            CHCI SVŮJ MINI <ArrowRight className="w-4 h-4 md:w-5 md:h-5 group-hover:translate-x-1 transition-transform" />
          </a>
        </div>
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-8 md:gap-16 items-center">
          <div className="relative order-2 md:order-1">
            ...
            <div className="bg-white/5 backdrop-blur-md border border-red-500/20 p-5 md:p-10 rounded-2xl md:rounded-[3rem] relative z-10">
               <h3 className="text-lg md:text-2xl font-black mb-4 md:mb-6 flex items-center gap-2 text-red-500 uppercase tracking-tight">
                 <AlertCircle className="w-5 h-5 md:w-6 md:h-6" /> "Past" Gigantů
               </h3>
               <div className="space-y-4 md:space-y-6 text-left">
                  <div className="flex gap-3 md:gap-4">
                    ...
                    <p className="text-gray-400 text-xs md:text-sm"><strong>Chronická bolest:</strong> Unavená zápěstí a deformovaný "malíček od smartphonu".</p>
                  </div>
                  <div className="flex gap-3 md:gap-4">
                    ...
                    <p className="text-gray-400 text-xs md:text-sm"><strong>Neustálé rozptýlení:</strong> Obrovské obrazovky, aby vás držely přilepené k médiím.</p>
                  </div>
                  <div className="flex gap-3 md:gap-4">
                    ...
                    <p className="text-gray-400 text-xs md:text-sm"><strong>Nepraktičnost:</strong> Deformované kapsy a nemožná obsluha jednou rukou.</p>
                  </div>
               </div>
            </div>
          </div>
          <div className="text-left order-1 md:order-2">
            <h2 className="text-2xl md:text-6xl font-black mb-4 md:mb-8 tracking-tighter leading-tight">
              Navrženo pro <br /> <span className="text-blue-500 italic">Lidskou Ruku.</span>
            </h2>
            <p className="text-base md:text-xl text-gray-400 mb-6 md:mb-8 font-light leading-relaxed">
              "Zóna palce" Mini 17 Pro pokrývá 100% obrazovky. Už nikdy nebudete potřebovat dvě ruce k odeslání zprávy.
            </p>
            <div className="flex items-center gap-3 md:gap-4 p-4 md:p-6 bg-blue-500/5 rounded-2xl md:rounded-3xl border border-blue-500/10">
               ...
               <span className="text-xs md:text-sm font-black text-blue-300 uppercase tracking-wider md:tracking-widest">Motorická efektivita +85%</span>
            </div>
          </div>
        </div>
      </Section>
      ...
      <Section id="confronto" className="max-w-7xl mx-auto">
        <div className="text-center mb-8 md:mb-16">
          <h2 className="text-2xl md:text-6xl font-black mb-4 md:mb-6 tracking-tight uppercase">Proč je Mini Lepší.</h2>
          <p className="text-gray-400 text-sm md:text-lg font-light">Srovnání, které velké značky skrývají.</p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3 md:gap-8 max-w-4xl mx-auto">
           ...
           <div className="p-4 md:p-8 border border-white/5 rounded-2xl md:rounded-[2.5rem] bg-neutral-900/50 opacity-50 grayscale transition-all hover:grayscale-0">
              <h4 className="text-xs md:text-xl font-black mb-4 md:mb-8 text-gray-500 uppercase tracking-wider md:tracking-widest italic">Běžní "Velcí"</h4>
              <ul className="space-y-3 md:space-y-6 font-medium">
                 ...
                 <li className="flex items-center justify-between text-[10px] md:text-sm">
                    ...
                    <span className="text-red-500 uppercase font-black">Ne</span>
                 </li>
                 <li className="flex items-center justify-between text-[10px] md:text-sm">
                    <span>Praktičnost</span>
                    <span className="text-gray-400 italic">Špatná</span>
                 </li>
                 <li className="flex items-center justify-between text-[10px] md:text-sm">
                    <span>Cena</span>
                    <span className="text-gray-300">12000Kč+</span>
                 </li>
              </ul>
           </div>
           ...
           <div className="p-4 md:p-10 border-2 border-blue-500 rounded-2xl md:rounded-[2.5rem] bg-blue-500/5 relative shadow-[0_0_50px_rgba(37,99,235,0.1)]">
              ...
              <ul className="space-y-3 md:space-y-6 font-bold">
                 ...
                 <li className="flex items-center justify-between text-[10px] md:text-sm">
                    <span>Cena</span>
                    <span className="text-blue-500 text-sm md:text-xl font-black">1999 Kč</span>
                 </li>
              </ul>
           </div>
        </div>
      ...
      <Section className="max-w-6xl mx-auto">
        <div className="text-center mb-8 md:mb-16">
          ...
          <p className="text-gray-400 text-sm md:text-lg font-light">Každý detail byl dotažen k dokonalosti.</p>
        </div>
      ...
      <Section className="bg-white text-black py-16 md:py-32 rounded-2xl md:rounded-[6rem] mx-2 md:mx-12 overflow-hidden shadow-inner">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-8 md:gap-20 items-center">
           <div className="text-left">
              <span className="text-blue-600 font-black uppercase tracking-[0.2em] md:tracking-[0.4em] text-[9px] md:text-[10px] mb-4 md:mb-6 block">Emoce Vlastnictví</span>
              <h2 className="text-3xl md:text-7xl font-black mb-4 md:mb-8 tracking-tighter leading-[0.9] uppercase">Rozbalte <br />Dokonalost.</h2>
              <p className="text-sm md:text-xl text-gray-600 mb-6 md:mb-10 leading-relaxed font-light italic">
                Od okamžiku dotyku soft-touch obalu po pocit titanu na kůži. Elitní senzorický zážitek.
              </p>
      ...
      <Section id="recensioni" className="max-w-7xl mx-auto">
        <div className="text-center mb-10 md:mb-20">
          <h2 className="text-2xl md:text-6xl font-black mb-4 md:mb-6 tracking-tight uppercase">Co o nás říkají.</h2>
          <div className="flex flex-col md:flex-row items-center justify-center gap-2 md:gap-4">
            <div className="flex gap-1">
              {[...Array(5)].map((_, i) => <Star key={i} className="w-4 h-4 md:w-5 md:h-5 fill-yellow-500 text-yellow-500" />)}
            </div>
            <p className="text-sm md:text-lg text-gray-400 font-light">4800+ 5-hvězdičkových recenzí</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8">
          <ReviewCard
            ...
            text="Neuvěřitelné. Zaplatil jsem při převzetí, dostal jsem za 24 hodin. Už se nikdy nevrátím k obrovskému telefonu. Kvalita titanu je úžasná."
          />
          <ReviewCard
            name="Jana M."
            date="Včera"
            ...
            text="Konečně mohu dělat vše jednou rukou držíc kávu. Fotoaparát dělá úžasné fotky v noci. Lepší než originál."
          />
          <ReviewCard
            name="Martin V."
            date="Minulý týden"
            ...
            text="Technologický klenot. Design je bezchybný a rychlost působivá. Nejlepší nákup roku, bez pochyb."
          />
        </div>
      </Section>
      ...
      <Section id="prezzo" className="max-w-6xl mx-auto relative scroll-mt-20">
        <div className="text-center mb-8 md:mb-16">
          <h2 className="text-2xl md:text-7xl font-black mb-4 md:mb-6 tracking-tight uppercase">Získejte Budoucnost.</h2>
          <p className="text-gray-400 text-sm md:text-xl font-light leading-relaxed max-w-2xl mx-auto italic px-2">
            Žádná platba předem. Plaťte až když <span className="text-white font-bold underline decoration-blue-500">se dotknete dokonalosti</span> na vlastní oči.
          </p>
        </div>
              ...
              <div className="text-left space-y-6 md:space-y-10">
                <div>
                  ...
                  <div className="flex items-baseline gap-3 md:gap-6 mb-4 md:mb-8">
                    <span className="text-gray-500 line-through text-2xl md:text-4xl font-light italic">7999 Kč</span>
                    <span className="text-5xl md:text-8xl font-black text-white tracking-tighter">1999<span className="text-2xl md:text-4xl"> Kč</span></span>
                  </div>
                </div>
                ...
                <div className="space-y-3 md:space-y-6">
                   <div className="flex items-center gap-3 md:gap-5 p-4 md:p-6 bg-white/5 rounded-xl md:rounded-[2rem] border border-white/5 hover:bg-white/10 transition-all">
                      ...
                      <div>
                         <p className="font-black text-xs md:text-sm uppercase tracking-wider md:tracking-widest">Doprava Zdarma Express</p>
                         <p className="text-[10px] md:text-xs text-gray-500">Po celé ČR za 24/48h</p>
                      </div>
                   </div>
                   <div className="flex items-center gap-3 md:gap-5 p-4 md:p-6 bg-white/5 rounded-xl md:rounded-[2rem] border border-white/5 hover:bg-white/10 transition-all">
                      <ShieldCheck className="w-7 h-7 md:w-10 md:h-10 text-blue-500 flex-shrink-0" />
                      <div>
                         <p className="font-black text-xs md:text-sm uppercase tracking-wider md:tracking-widest">30 Dní na Vyzkoušení</p>
                         <p className="text-[10px] md:text-xs text-gray-500">Spokojenost nebo Vrácení</p>
                      </div>
                   </div>
                </div>
                ...
                <div className="flex items-center gap-3 md:gap-4">
                   ...
                   <p className="text-[10px] md:text-xs font-black text-blue-400 uppercase tracking-wider md:tracking-widest animate-pulse">Kusů: 14</p>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <form onSubmit={handleOrder} className="relative bg-black/60 backdrop-blur-2xl p-6 md:p-12 rounded-2xl md:rounded-[3rem] border border-white/10 space-y-5 md:space-y-8 shadow-2xl">
                  <div className="text-center mb-6 md:mb-10">
                    <h4 className="text-xl md:text-3xl font-black uppercase tracking-tight mb-2 italic">Údaje pro Doručení</h4>
                    <p className="text-[9px] md:text-[10px] text-gray-500 font-bold uppercase tracking-[0.2em] md:tracking-[0.3em]">Zaplatíte kurýrovi v hotovosti</p>
                  </div>
                  ...
                  <div className="space-y-2 md:space-y-3 text-left">
                    ...
                    <div className="relative group">
                      ...
                      <input
                        required
                        type="text"
                        placeholder="Ulice, Číslo, Město a PSČ"
                        className="w-full bg-white/5 border border-white/10 rounded-xl md:rounded-[1.5rem] pl-12 md:pl-16 pr-4 md:pr-6 py-4 md:py-5 focus:outline-none focus:border-blue-500 focus:bg-white/10 transition-all placeholder:text-gray-700 text-sm md:text-base font-medium"
                  ...
                  >
                    ...
                    {isSubmitting ? 'ODESÍLÁM...' : 'POTVRDIT NYNÍ'}
                  </button>
                  ...
                  <p className="text-[8px] md:text-[9px] text-gray-600 text-center font-bold uppercase tracking-wider md:tracking-widest leading-relaxed px-2">
                    Kliknutím potvrzujete seznámení s podmínkami a souhlas s platbou na dobírku.
                  </p>
                </form>
              </div>
            </div>
      ...
      <Section className="max-w-4xl mx-auto text-center border-t border-white/5 pt-16 md:pt-32">
         <h4 className="text-xl md:text-3xl font-black mb-8 md:mb-16 uppercase tracking-tight italic">Žádné Pochybnosti, Jen Jistoty.</h4>
         <div className="grid md:grid-cols-2 gap-8 md:gap-20 text-left">
            <div className="space-y-3 md:space-y-6">
               ...
               <p className="text-sm md:text-base text-gray-400 leading-relaxed font-light">Odpověď je kategorické ne. Platíte pouze kurýrovi, když máte balík v rukou. Můžete zkontrolovat obal před zaplacením.</p>
            </div>
            <div className="space-y-3 md:space-y-6">
               <h5 className="font-black text-blue-500 uppercase tracking-wider md:tracking-widest text-xs md:text-sm">A co když se nezamiluji?</h5>
               <p className="text-sm md:text-base text-gray-400 leading-relaxed font-light">Máte 30 dní na vyzkoušení Mini 17 Pro. Pokud raději chcete velký telefon, vrátíme vám vše.</p>
            </div>
         </div>
      </Section>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 grid md:grid-cols-3 gap-10 md:gap-20 items-center">
          <div className="flex flex-col items-center md:items-start gap-4 md:gap-6">
            ...
            <p className="text-[10px] md:text-xs text-gray-600 max-w-xs text-center md:text-left leading-relaxed font-medium">
              Zminiaturizovaná inovace pro ty, kteří nedělají kompromisy.
            </p>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-6 md:gap-10 text-[9px] md:text-[10px] font-black uppercase tracking-[0.2em] md:tracking-[0.3em] text-gray-500">
            <a href="#vision" onClick={(e) => handleNavClick(e, 'vision')} className="hover:text-white transition-colors">Vize</a>
            <a href="#recensioni" onClick={(e) => handleNavClick(e, 'recensioni')} className="hover:text-white transition-colors">Recenze</a>
            <a href="#prezzo" onClick={(e) => handleNavClick(e, 'prezzo')} className="hover:text-white transition-colors">Objednat</a>
          </div>
          ...
          <div className="flex flex-col items-center md:items-end gap-2 md:gap-3">
            <div className="flex items-center gap-2 md:gap-3 text-green-500 text-[9px] md:text-[10px] font-black uppercase tracking-wider md:tracking-widest">
               <ShieldCheck className="w-4 h-4 md:w-5 md:h-5" /> Záruka 24 Měsíců
            </div>
      ...
      {isMenuOpen && (
        <div className="fixed inset-0 z-[70] bg-black/98 backdrop-blur-3xl flex flex-col items-center justify-center gap-12 text-4xl font-black animate-fade-in md:hidden p-8">
          ...
          <a href="#vision" className="uppercase tracking-tighter hover:text-blue-500" onClick={(e) => handleNavClick(e, 'vision')}>VIZE</a>
          <a href="#confronto" className="uppercase tracking-tighter hover:text-blue-500" onClick={(e) => handleNavClick(e, 'confronto')}>SROVNÁNÍ</a>
          <a href="#recensioni" className="uppercase tracking-tighter hover:text-blue-500" onClick={(e) => handleNavClick(e, 'recensioni')}>RECENZE</a>
          <a
            href="#prezzo"
            onClick={(e) => handleNavClick(e, 'prezzo')}
      ...
      <div className="md:hidden fixed bottom-8 left-1/2 -translate-x-1/2 w-[92%] p-5 bg-black/40 backdrop-blur-2xl border border-white/20 rounded-[2.5rem] z-40 flex justify-between items-center px-8 shadow-[0_25px_60px_rgba(0,0,0,0.8)]">
        <div className="flex flex-col text-left">
          <p className="text-[10px] text-gray-500 line-through font-bold">7999 Kč</p>
          <p className="text-2xl font-black text-white leading-none tracking-tighter">1999 Kč</p>
        </div>
        <a
          href="#prezzo"
          onClick={(e) => handleNavClick(e, 'prezzo')}
