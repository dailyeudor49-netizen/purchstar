    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{
          ...
          Váš Mini 17 Pro Titanium se připravuje a brzy bude odeslán.
        </p>
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontWeight: 600, color: '#92400e', fontSize: '0.9rem' }}>Platba na dobírku: 1999 Kč</div>
        ...
        <div style={{
          ...
          Máte dotazy? Napište nám: <a href="mailto:info@purchstar.com" style={{ color: '#2563eb', fontWeight: 600, textDecoration: 'none' }}>info@purchstar.com</a>
        </div>
