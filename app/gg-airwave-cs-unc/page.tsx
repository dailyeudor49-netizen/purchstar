...
export default function LandingPage() {
  ...
  const handleFormSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      router.push('/ty/ty-gg-airwave-cs-unc');
    } catch (error) {
  ...
  return (
    <>
      ...
      {/* Click Pixel */}
      <img
        src="https://offers.uncappednetwork.com/forms/api/ck/?o=2920&uid=0191dbf2-738a-7d28-82a0-18c3859d5e8f&lp=2953"
        ...
        <div className="product-container">
          ...
          <div className="product-images" id="productImages" ref={productImagesRef} style={imagesStyle}>
                ...
                <div className="slider-images" id="mainSlider" style={{ transform: `translateX(-${currentSlide * 100}%)` }}>
                  {[
                    ...
                    <div className="slider-image" key={index}>
                      <img src={src} alt={`Klimatizace Air Wave Smart pohled ${index + 1}`} style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                    </div>
                  ))}
                </div>
              </div>
            ...
            <div className="thumbnails">
              {[
                ...
                >
                  <img src={src} alt={`Náhled klimatizace ${index + 1}`} style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="product-info">
            ...
            <div className="product-header">
              <h1 className="product-title">Přenosná Klimatizace Air Wave Smart™ 3v1 - Vytápí, Ochlazuje a Odvlhčuje</h1>
              <p className="product-subtitle">Topí, Chladí a Odvlhčuje • Systém ThermoPanel eliminující CO2 • Bez Vnější Jednotky • 12 000 BTU • Extrémně Tichý Provoz</p>
            </div>
            ...
            <div className="product-rating">
              ...
              <span className="rating-text">4.9 (318 hodnocení)</span>
            </div>
            ...
            <div className="product-price">
              <div className="price-row">
                ...
                <span className="price-original">2 999 Kč</span>
                <span className="price-save">-33%</span>
              </div>
            </div>
            ...
            <div className="product-cta">
              <button className="btn-add-to-cart btn-add-to-cart-mobile" onClick={scrollToForm}>
                ...
                <span style={{ display: 'block', fontWeight: 400 }} className="btn-text-sub">
                  Platba na Dobírku - Doručení Zdarma
                </span>
              </button>
            ...
            <div className="product-description">
              ...
              <ul>
                <li><span className="icon">✓</span><span><strong>Výkon 12 000 BTU</strong> – Rychle topí, chladí a odvlhčuje místnosti do 60 m²</span></li>
                <li><span className="icon">✓</span><span><strong>Tři režimy v jednom</strong> – Vytápění v zimě, ochlazování v létě a odvlhčování</span></li>
                <li><span className="icon">✓</span><span><strong>Precizní regulace teploty 16-32°C</strong> – Elektronický termostat zajišťující optimální komfort</span></li>
                <li><span className="icon">✓</span><span><strong>Třída účinnosti A+++</strong> – Snížení účtů o 60% oproti konvenčním systémům</span></li>
                <li><span className="icon">✓</span><span><strong>Systém ThermoPanel bez vnějšího agregátu</strong> – Recykluje vzduch eliminující CO2, bez venkovního motoru</span></li>
                <li><span className="icon">✓</span><span><strong>Ovládání telefonem</strong> – Dedikovaná aplikace pro iOS a Android, zapněte vytápění odkudkoliv</span></li>
                <li><span className="icon">✓</span><span><strong>Regulace vlhkosti</strong> – Snižuje artritidu a plíseň, zdravé prostředí</span></li>
                <li><span className="icon">✓</span><span><strong>Jednoduchá montáž</strong> – Montáž na zeď nebo podlahu, bez potřeby technika</span></li>
                <li><span className="icon">✓</span><span><strong>Velmi tichý</strong> – Ideální i do ložnice</span></li>
              </ul>
            </div>

            {/* Trust Section */}
            <div className="trust-section">
              <h3 className="trust-title">Zabezpečení a Servis</h3>
              <div className="trust-items">
                ...
                <div className="trust-item">
                  ...
                  <div className="trust-content">
                    <h4>Záruka 24 Měsíců</h4>
                    <p>Kompletní ochrana před výrobními vadami po dobu 2 let</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="info-boxes">
              ...
              <div className="info-box green">
                ...
                <div className="info-box-content">
                  <p>Bez Souhlasu</p>
                  <span>Montáž bez souhlasu společenství</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section id="whyItWorks" style={{ background: 'white', padding: '4rem 1rem' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <p style={{ textAlign: 'center', color: '#6b7280', maxWidth: '600px', margin: '0 auto 1.5rem', fontSize: '0.8125rem', lineHeight: 1.4 }}>
            Inovativní řešení zajišťující úspory a dokonalý celoroční komfort
          </p>
          ...
          <div className="timeline-container" style={{ position: 'relative', maxWidth: '800px', margin: '0 auto', padding: '2rem 0' }}>
            ...
            <div ref={whyItem1.ref} className="timeline-item timeline-item-left" style={{ display: 'grid', gridTemplateColumns: '1fr auto 1fr', gap: '2rem', alignItems: 'center', marginBottom: '3rem', position: 'relative' }}>
              <div className="timeline-content timeline-content-left" style={{
                ...
                <h3 style={{ fontSize: '1.25rem', fontWeight: 700, color: '#CC6600', marginBottom: '0.5rem' }}>Systém ThermoPanel</h3>
                <p style={{ fontSize: '0.9375rem', color: '#995200', lineHeight: 1.6 }}>
                  Bez <strong style={{ color: '#663300' }}>venkovního motoru</strong>, bez souhlasu. Recykluje a čistí vzduch eliminující CO2 a znečištění.
                </p>
              </div>
            ...
            <div ref={whyItem2.ref} className="timeline-item timeline-item-right" style={{ display: 'grid', gridTemplateColumns: '1fr auto 1fr', gap: '2rem', alignItems: 'center', marginBottom: '3rem', position: 'relative' }}>
              ...
              <div className="timeline-content timeline-content-right" style={{
                ...
                <h3 style={{ fontSize: '1.25rem', fontWeight: 700, color: '#CC6600', marginBottom: '0.5rem' }}>Skutečné Úspory Elektřiny</h3>
                <p style={{ fontSize: '0.9375rem', color: '#995200', lineHeight: 1.6 }}>
                  <strong style={{ color: '#663300' }}>Chytrý termostat</strong> kontrolující teplotu. <strong style={{ color: '#663300' }}>Snížení nákladů až o 60%</strong> na fakturách.
                </p>
              </div>
            </div>
            ...
            <div ref={whyItem3.ref} className="timeline-item timeline-item-left timeline-item-last" style={{ display: 'grid', gridTemplateColumns: '1fr auto 1fr', gap: '2rem', alignItems: 'center', position: 'relative' }}>
              <div className="timeline-content timeline-content-left" style={{
                ...
                <h3 style={{ fontSize: '1.25rem', fontWeight: 700, color: '#CC6600', marginBottom: '0.5rem' }}>Tři Funkce v Jednom Přístroji</h3>
                <p style={{ fontSize: '0.9375rem', color: '#995200', lineHeight: 1.6 }}>
                  <strong style={{ color: '#663300' }}>Topí</strong> v zimě, <strong style={{ color: '#663300' }}>chladí</strong> v létě a <strong style={{ color: '#663300' }}>odvlhčuje</strong>. Perfektní komfort po všechna roční období.
                </p>
              </div>
              <div className="timeline-circle" style={{
                borderRadius: '50%',
            ...
            >
              ...
              >
                ...
                <div className="why-choose-slide">
                    <div className="why-choose-slide-content">
                        <div className="why-choose-slide-text">
                            ...
                            <p>Systém ThermoPanel, která <strong>bleskově ohřívá</strong> Váš byt bez venkovního motoru. <strong>Konstantní teplo</strong>, bez úniků, <strong>garantované úspory</strong> na fakturách.</p>
                        </div>
                ...
                <div className="why-choose-slide">
                    <div className="why-choose-slide-content">
                        <div className="why-choose-slide-text">
                            <h3>S Montáží nebo Bez</h3>
                            <p><strong>Nekomplikovaná montáž</strong> na zeď nebo podlahu. <strong>Bez instalatéra</strong>, <strong>zapoj a používej</strong>. Začněte používat během několika minut.</p>
                        </div>
                        <div className="why-choose-slide-image">
                            <img src="/images/condizionatore/installazione.webp" alt="Montáž klimatizace Air Wave" />
                        </div>
                    </div>
                </div>
                ...
                <div className="why-choose-slide">
                    <div className="why-choose-slide-content">
                        <div className="why-choose-slide-text">
                            <h3>Ochlazuje v Létě, Vytápí v Zimě</h3>
                            <p><strong>Tři režimy v jednom</strong>: výkonné vytápění v zimě, ochlazování v létě, odvlhčování po celý rok. <strong>Bez povolení</strong> společenství.</p>
                        </div>
                        <div className="why-choose-slide-image">
                            <img src="/images/condizionatore/caldo-freddo.webp" alt="Klimatizace tři v jednom" />
                        </div>
                    </div>
                </div>
                ...
                <div className="why-choose-slide">
                    <div className="why-choose-slide-content">
                        <div className="why-choose-slide-text">
                            <h3>Snížení nákladů až o 60% na Účtech</h3>
                            <p><strong>Účinnost A+++</strong> a chytrý termostat: spotřebujete jen to, co potřebujete. <strong>Bez ztrát</strong>, <strong>největší úspory</strong> oproti plynovým instalacím.</p>
                        </div>
                        <div className="why-choose-slide-image">
                            <img src="/images/condizionatore/risparmio.webp" alt="Úspora energie Air Wave" />
                        </div>
                    </div>
                </div>
                ...
                <div className="why-choose-slide">
                    <div className="why-choose-slide-content">
                        <div className="why-choose-slide-text">
                            <h3>Velmi tichý: Spěte v Klidu</h3>
                        ...
                        <div className="why-choose-slide-image">
                            <img src="/images/condizionatore/silenzioso.webp" alt="Tichý provoz klimatizace" />
                        </div>
                    </div>
                </div>
        ...
        <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
          ...
          <div className="tech-specs-container">
               ...
               <div className="tech-specs-row-3">
                    <div style={{
                      ...
                      transition: 'opacity 0.6s ease-out, transform 0.6s ease-out'
                        ...
                        <div style={{ fontSize: '0.875rem', color: '#6b7280' }}>Maximální plocha</div>
                    </div>
                    <div style={{
                      background: '#F5F5F5',
                      border: '2px solid transparent',
                      ...
                      transition: 'opacity 0.6s ease-out 0.2s, transform 0.6s ease-out 0.2s'
                        ...
                        <div style={{ fontSize: '0.875rem', color: '#6b7280' }}>Kapacita BTU</div>
                    </div>
                    <div style={{
                      background: '#F5F5F5',
                      border: '2px solid transparent',
                      ...
                      transition: 'opacity 0.6s ease-out 0.4s, transform 0.6s ease-out 0.4s'
                        ...
                        <div style={{ fontSize: '0.875rem', color: '#6b7280' }}>Teplotní rozsah</div>
                    </div>
                </div>
                    ...
                    <div style={{
                      ...
                      transition: 'opacity 0.6s ease-out 0.6s, transform 0.6s ease-out 0.6s'
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1rem' }}>
                            ...
                            <h3 style={{ fontSize: '1.125rem', fontWeight: 600, color: '#FF8C00' }}>Úspora Elektřiny</h3>
                        </div>
                        <p style={{ color: '#555555', fontSize: '0.9375rem', lineHeight: 1.6 }}>
                            <strong>Až o 60% nižší účty</strong> oproti jiným klimatizacím a plynovému vytápění díky systému ThermoPanel a třídě účinnosti A+++.
                        </p>
                    </div>
                    <div style={{
                      background: '#F5F5F5',
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.75rem' }}>
                    <div style={{
                      ...
                      transition: 'opacity 0.6s ease-out, transform 0.6s ease-out'
                        ...
                        <div style={{ fontSize: '0.75rem', color: '#6b7280' }}>Maximální plocha</div>
                    </div>
                    <div style={{
                      background: '#F5F5F5',
                      border: '2px solid transparent',
                      ...
                      transition: 'opacity 0.6s ease-out 0.2s, transform 0.6s ease-out 0.2s'
                        ...
                        <div style={{ fontSize: '0.75rem', color: '#6b7280' }}>Kapacita BTU</div>
                    </div>
                </div>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.75rem' }}>
                    <div style={{
                      ...
                      transition: 'opacity 0.6s ease-out 0.4s, transform 0.6s ease-out 0.4s'
                        ...
                        <div style={{ fontSize: '0.75rem', color: '#6b7280' }}>Teplotní rozsah</div>
                    </div>
                    <div style={{
                      background: '#F5F5F5',
                      border: '2px solid transparent',
                ...
                <div style={{
                  ...
                  transition: 'opacity 0.6s ease-out 0.8s, transform 0.6s ease-out 0.8s'
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '0.75rem' }}>
                        ...
                        <h3 style={{ fontSize: '1rem', fontWeight: 600, color: '#FF8C00', margin: 0 }}>Úspora Elektřiny</h3>
                    </div>
            ...
            <div className="tech-specs-image" style={{ background: 'linear-gradient(135deg, #FFF8F0, #FFE8CC)', border: '2px solid #FFD966', borderRadius: '16px', overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '400px' }}>
              <img src="/images/condizionatore/specifiche.webp" alt="Technické parametry Air Wave Smart" style={{ width: '100%', height: '100%', objectFit: 'contain' }} />
            </div>
          </div>
        </div>
      </section>
          ...
          <div style={{ position: 'relative', maxWidth: '900px', margin: '0 auto 2rem' }}>
            <div id="reviewsSlider" style={{ overflow: 'hidden', borderRadius: '12px' }}>
              <div id="reviewsTrack" style={{ display: 'flex', transition: 'transform 0.5s ease', transform: `translateX(-${currentReview * 100}%)` }}>
                {[
                    { t: 'Konečně skutečně šetřím', d: 'Používám ji asi 2 měsíce a musím říct, že účty značně klesly. Dříve se starou klimatizací jsem platil hodně, teď mnohem méně. Topí solidně a funguje výborně.', a: 'Petr K.', stars: 5 },
                    { t: 'Bleskové doručení!', d: 'Objednal jsem v pondělí, dorazilo ve středu. Kurýr také milý. Produkt vynikající, sám jsem namontoval na zeď bez volání někomu. Funguje dobře a rychle ohřeje pokoj.', a: 'Tomáš W.', stars: 5 },
                    { t: 'Skvělý do ložnice', d: 'Nainstaloval jsem v ložnici a téměř to není slyšet, stěží ho slyším. Se starým jsem nemohl spát, ale tento je ideální. Spotřebuje také málo elektřiny.', a: 'Anna M.', stars: 5 },
                    { t: 'Zatím je to dobré', d: 'Jsem velmi spokojená, rychle ohřívá a dům zůstává teplý. Nevím jak jsem dříve zvládala s radiátory, které se ohřívaly hodiny. To je úplně jiná třída. Dávám 4 hvězdičky, abych viděla jak to bude později.', a: 'Kateřina P.', stars: 4 },
                    { t: 'Jednoduchá montáž', d: 'Já a můj syn jsme ho namontovali za půl hodiny, jsou tam šrouby a všechno, stačí zavěsit a funguje hned. Není potřeba technik a ušetříte také ty peníze. Super.', a: 'Robert S.', stars: 5 },
                    { t: 'Super rychlá doprava', d: 'Dorazilo za 2 dny, pečlivě zabalené. Kurýr dokonce pomohl mi vynést nahoru protože bydlím ve třetím bez výtahu! Produkt vynikající, topí výborně a spotřebuje málo ve srovnání se starým.', a: 'Monika B.', stars: 5 },
                    { t: 'Skvělý poměr kvality a ceny', d: 'Za tuto cenu je opravdu dobrá. Vytápí a ochlazuje, já používám převážně v zimě a teplota je vždy taková jak chci. Nevrátím se k předchozímu.', a: 'Lukáš D.', stars: 5 },
                    { t: 'Byt vždy teplý', d: 'Koupil jsem do obývacího pokoje který má asi 50 m² a ohřeje všechno. I když je venku mráz, za 10 minut je byt teplý. Spotřebuje mnohem méně než starý a je to vidět na fakturách.', a: 'Marie G.', stars: 5 },
                    { t: 'Rychlá zásilka a skvělý produkt', d: 'Objednal jsem v úterý, dostal jsem ve čtvrtek, kurýr včasný. Produkt je vynikající, vytápí a ochlazuje, používám ho po celý rok. Velmi tichý a snadný v obsluze i pro mě který se nevyznám.', a: 'Antonín C.', stars: 5 },
                    { t: 'Opravdu potěšená', d: 'Obávala jsem se objednávat přes internet ale všechno přišlo ideálně během několika dnů. Funguje skvěle a spotřebuje velmi málo oproti mé předchozí klimatizaci. Účty klesly výrazně. Jsem velmi spokojená.', a: 'Štefanie L.', stars: 5 }
                ].map((review, i) => (
        ...
        <div id="reviewModal" style={{ display: 'flex', position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, background: 'rgba(0,0,0,0.5)', zIndex: 1000, alignItems: 'center', justifyContent: 'center' }} onClick={() => setIsModalOpen(false)}>
            <div style={{ background: 'white', borderRadius: '16px', padding: '2rem', maxWidth: '500px', width: '90%', margin: '0 auto', boxShadow: '0 20px 60px rgba(0,0,0,0.3)', position: 'relative' }} onClick={e => e.stopPropagation()}>
                ...
                <div style={{ textAlign: 'center' }}>
                    ...
                    <h3 style={{ fontSize: '1.25rem', fontWeight: 700, color: '#111827', marginBottom: '1rem' }}>Výhradně Potvrzené Nákupy</h3>
                    <p style={{ color: '#6b7280', fontSize: '0.9375rem', lineHeight: 1.6 }}>
                        Aby se předešlo nepravdivým recenzím, mohou napsat recenzi pouze zákazníci, kteří si tento produkt zakoupili.
                    </p>
      ...
      <section id="ordina" style={{ background: '#1E293B', padding: '5rem 1.5rem', color: 'white', position: 'relative' }}>
        ...
        <div className="checkout-grid" style={{ maxWidth: '1000px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))', gap: '4rem', alignItems: 'start' }}>
          ...
          <div>
            <h2 style={{ fontSize: '1.75rem', fontWeight: 800, marginBottom: '1rem' }}>Limitované Množství</h2>
            ...
            <div style={{ background: 'rgba(255,255,255,0.05)', padding: '2rem', borderRadius: '24px', border: '1px solid rgba(255,255,255,0.1)' }}>
              <div style={{ display: 'flex', gap: '1rem', marginBottom: '1.5rem', alignItems: 'center' }}>
                <img src="/images/condizionatore/specifiche.webp" alt="Klimatizace Air Wave Smart produkt" style={{ width: '80px', height: '80px', borderRadius: '12px', objectFit: 'cover' }} />
                <div>
              ...
              <ul style={{ color: '#cbd5e1', listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ display: 'flex', justifyContent: 'space-between', padding: '0.5rem 0', borderBottom: '1px solid rgba(255,255,255,0.1)' }}>
                  <span>Běžná cena</span> <span style={{ textDecoration: 'line-through' }}>2 999 Kč</span>
                </li>
                <li style={{ display: 'flex', justifyContent: 'space-between', padding: '0.5rem 0', borderBottom: '1px solid rgba(255,255,255,0.1)' }}>
                  <span>Sleva Black Friday</span> <span style={{ color: '#FFB800' }}>-1 000 Kč</span>
                </li>
                <li style={{ display: 'flex', justifyContent: 'space-between', padding: '0.5rem 0', borderBottom: '1px solid rgba(255,255,255,0.1)' }}>
                  <span>Doručení</span> <span style={{ color: '#4ADE80' }}>ZDARMA</span>
                </li>
                <li style={{ display: 'flex', justifyContent: 'space-between', padding: '1rem 0', fontSize: '1.25rem', fontWeight: 700, color: 'white' }}>
                  <span>Součet</span> <span>1 999 Kč</span>
                </li>
              </ul>
          ...
          <div style={{ background: 'white', borderRadius: '24px', padding: '2.5rem', color: '#1E293B' }}>
            <div style={{ marginBottom: '1.5rem', textAlign: 'center' }}>
              <h3 style={{ fontSize: '1.5rem', fontWeight: 800 }}>Bezpečná Transakce</h3>
            ...
            <form onSubmit={handleFormSubmit} style={{ display: 'grid', gap: '1rem' }}>
              ...
              <div>
                <label style={{ fontSize: '0.8rem', fontWeight: 700, color: '#64748b', marginBottom: '4px', display: 'block' }}>JMÉNO SPOLU S PŘÍJMENÍM</label>
              ...
              <div>
                <label style={{ fontSize: '0.8rem', fontWeight: 700, color: '#64748b', marginBottom: '4px', display: 'block' }}>KOMPLETNÍ ADRESA</label>
              ...
              <div style={{ margin: '1rem 0', padding: '1.5rem', background: '#F8FAFC', border: '2px solid #E2E8F0', borderRadius: '12px' }}>
                <div style={{ display: 'grid', gap: '0.75rem' }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                    ...
                    <span style={{ fontSize: '0.9rem', color: '#1E293B', fontWeight: 600 }}>Doručení zdarma 24-48h</span>
                  </div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                    ...
                    <span style={{ fontSize: '0.9rem', color: '#1E293B', fontWeight: 600 }}>30 dní na bezplatné vrácení</span>
                  </div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
          ...
          <div className="sticky-info" style={{
            ...
            <div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                ...
                <span style={{ fontSize: '0.875rem', textDecoration: 'line-through', color: 'white', opacity: 0.8 }}>2 999 Kč</span>
              </div>
            </div>
          </div>
          <button
