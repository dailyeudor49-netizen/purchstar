  ...
  const handleOrder = async (e: React.FormEvent) => {
    ...
    if (formData.fullName && formData.address && formData.phone) {
      try {
        ...
        if (result.success) {
          window.location.href = '/ty/ty-slimique-it';
        } else {
  ...
  return (
    <div className="min-h-screen bg-[#fcfcfd] text-slate-900 font-sans selection:bg-rose-100 selection:text-rose-900">
      ...
      <div className="bg-rose-600 text-white text-[10px] md:text-xs font-black uppercase tracking-[0.2em] py-2 px-4 text-center sticky top-0 z-[60]">
        ATTENZIONE: La nuova scoperta scientifica che sta rivoluzionando il fitness
      </div>
      ...
      <main className="max-w-4xl mx-auto px-4 md:px-8 py-12 md:py-20">
            ...
            <div className="relative z-10 flex flex-col md:flex-row gap-12 items-center">
              <div className="flex-1 space-y-8">
                ...
                <h3 className="text-4xl md:text-6xl font-black leading-none tracking-tighter italic">
                  Slimique: <span className="text-rose-500">L'Unica</span> Chiave del tuo Destino.
                </h3>
        ...
        <section className="mt-32 relative">
          ...
          <div className="relative bg-white border-4 border-slate-900 rounded-[4rem] p-8 md:p-20 text-center shadow-[0_40px_100px_rgba(0,0,0,0.1)]">
            <div className="absolute -top-10 left-1/2 -translate-x-1/2 bg-slate-900 text-white px-10 py-4 rounded-3xl font-black text-sm uppercase tracking-[0.3em] flex items-center gap-3 shadow-2xl">
               <AlertTriangle className="w-5 h-5 text-amber-400" /> Disponibilità Limitata <AlertTriangle className="w-5 h-5 text-amber-400" />
            </div>
            ...
            <p className="text-xl md:text-2xl text-slate-500 mb-16 max-w-2xl mx-auto leading-relaxed font-medium">
               Accedi oggi stesso al protocollo <strong>Slimique</strong> con l'agevolazione riservata esclusivamente alla nostra community scientifica.
        ...
        <section className="mt-40 p-10 md:p-16 bg-slate-50 rounded-[4rem] border border-slate-100 flex flex-col md:flex-row gap-12 items-center">
           ...
           <div>
              ...
              <p className="text-slate-600 text-lg md:text-xl leading-relaxed italic mb-6">
                "Ho dedicato la mia vita allo studio del metabolismo femminile perché ho visto troppe donne brillanti spegnersi a causa di insicurezze biologiche. Slimique non è solo un cerotto; è un manifesto di libertà. È il modo in cui diciamo basta a un'industria che trae profitto dai nostri fallimenti. Riprenditi il tuo corpo. Riprenditi il tuo sorriso."
              </p>
        ...
        {/* ORDER FORM SECTION */}
        <section id="ordine" className="mt-40 py-24 px-4 bg-gradient-to-b from-rose-50 to-white rounded-[4rem]">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
              ...
              <div className="space-y-8">
                <div className="bg-white p-8 rounded-[3rem] shadow-xl border border-slate-200 text-center">
                  <span className="inline-block px-4 py-1 rounded-full bg-rose-600 text-white text-xs font-black uppercase tracking-widest mb-4">Offerta Esclusiva</span>
                  <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-4">Pacco Promo: 2 Pack Slimique</h2>
                  ...
                  <div className="flex items-baseline gap-4 mb-8 justify-center">
                    ...
                    <span className="text-5xl md:text-7xl font-black text-rose-600">€49,00</span>
                  </div>
                  ...
                  <ul className="space-y-4 border-t border-slate-100 pt-8">
                    <li className="flex items-center justify-center gap-3 font-bold text-slate-700 text-sm md:text-base">
                      <Truck className="text-rose-600 w-5 h-5 flex-shrink-0" /> Spedizione Espressa Gratis (48h)
                    </li>
                    <li className="flex items-center justify-center gap-3 font-bold text-slate-700 text-sm md:text-base">
                      <ShieldCheck className="text-rose-600 w-5 h-5 flex-shrink-0" /> Pagamento alla Consegna (COD)
                    </li>
                    <li className="flex items-center justify-center gap-3 font-bold text-slate-700 text-sm md:text-base">
                      <CheckCircle className="text-rose-600 w-5 h-5 flex-shrink-0" /> Garanzia Soddisfatti o Rimborsati
                    </li>
                  </ul>
                </div>
              </div>
              ...
              {/* Form Right */}
              <div className="bg-white p-8 md:p-12 rounded-[3.5rem] shadow-2xl border-4 border-rose-600 relative overflow-hidden">
                {isSubmitted ? (
                  ...
                  <>
                    <div className="mb-10 text-center">
                      <h3 className="text-3xl font-black text-slate-900 mb-2">Ordina Ora</h3>
                    ...
                    <form onSubmit={handleOrder} className="space-y-6">
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            className="w-full bg-slate-50 border-2 border-slate-100 rounded-2xl py-4 pl-12 pr-4 focus:ring-4 focus:ring-rose-100 focus:border-rose-600 outline-none transition-all font-semibold"
                      ...
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            className={`w-full bg-slate-50 border-2 rounded-2xl py-4 pl-12 pr-4 focus:ring-4 focus:ring-rose-100 focus:border-rose-600 outline-none transition-all font-semibold ${errors.address ? 'border-red-400' : 'border-slate-100'}`}
                      ...
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            className={`w-full bg-slate-50 border-2 rounded-2xl py-4 pl-12 pr-4 focus:ring-4 focus:ring-rose-100 focus:border-rose-600 outline-none transition-all font-semibold ${errors.phone ? 'border-red-400' : 'border-slate-100'}`}
                      ...
                      <div className="pt-4">
                        <button
                          type="submit"
                          className="w-full bg-rose-600 hover:bg-rose-700 text-white text-2xl font-black py-6 rounded-2xl shadow-xl shadow-rose-200 transform hover:scale-[1.02] active:scale-95 transition-all flex items-center justify-center gap-3"
                        >
                          CONFERMA L'ORDINE <ChevronRight className="w-8 h-8" />
                        </button>
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 p-4 bg-white/95 backdrop-blur-md border-t border-slate-200 z-[100] flex items-center justify-between shadow-[0_-20px_40px_rgba(0,0,0,0.1)]">
         <div className="flex flex-col">
            ...
            <span className="text-base font-black text-slate-900 tracking-tighter">2x49€ - SPEDIZIONE GRATIS</span>
         </div>
         <a href="#ordine" className="bg-rose-600 text-white px-8 py-4 rounded-2xl font-black text-sm uppercase tracking-widest shadow-lg shadow-rose-600/30 active:scale-95 transition-all">ORDINA ORA</a>
      </div>
    </div>
  );
}
