    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{
          ...
          Tu Robot de Cocina Inteligente se esta preparando y sera enviado pronto.
        </p>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '0.8rem', color: '#9f1239', fontWeight: 600, marginBottom: '0.25rem' }}>CODIGO DE PEDIDO</div>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '0.85rem', fontWeight: 700, color: '#1E293B', marginBottom: '1rem' }}>📦 Proximos pasos:</div>
          ...
          <div style={{ display: 'flex', gap: '0.75rem', marginBottom: '0.75rem' }}>
            ...
            <div>
              <div style={{ fontWeight: 600, color: '#1E293B', fontSize: '0.9rem' }}>Procesamiento del pedido</div>
          ...
          <div style={{ display: 'flex', gap: '0.75rem', marginBottom: '0.75rem' }}>
            ...
            <div>
              <div style={{ fontWeight: 600, color: '#1E293B', fontSize: '0.9rem' }}>Envio del paquete</div>
          ...
          <div style={{ display: 'flex', gap: '0.75rem' }}>
            ...
            <div>
              ...
              <div style={{ color: '#64748b', fontSize: '0.8rem' }}>2-3 dias laborables</div>
            </div>
          </div>
        </div>
        ...
        <div style={{
          ...
          Tienes preguntas? Escribenos: <a href="mailto:info@purchstar.com" style={{ color: '#e11d48', fontWeight: 600, textDecoration: 'none' }}>info@purchstar.com</a>
        </div>
