...
const CONVERSION_LABEL = 'AW-17321474795/ixqQCI_w1c4bEOv1wsNA';
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ fontSize: '0.85rem', fontWeight: 700, color: '#1E293B', marginBottom: '1rem' }}>📦 Co následuje:</div>
            ...
            <div style={{ display: 'flex', gap: '0.75rem', marginBottom: '0.75rem' }}>
              ...
              <div>
                <div style={{ fontWeight: 600, color: '#1E293B', fontSize: '0.9rem' }}>Vyřízení objednávky</div>
            ...
            <div style={{ display: 'flex', gap: '0.75rem', marginBottom: '0.75rem' }}>
              ...
              <div>
                <div style={{ fontWeight: 600, color: '#1E293B', fontSize: '0.9rem' }}>Předání přepravci</div>
                <div style={{ color: '#64748b', fontSize: '0.8rem' }}>Během 24 hodin</div>
              </div>
            </div>
            ...
            <div style={{ display: 'flex', gap: '0.75rem' }}>
              ...
              <div>
                <div style={{ fontWeight: 600, color: '#1E293B', fontSize: '0.9rem' }}>Dodání</div>
                <div style={{ color: '#64748b', fontSize: '0.8rem' }}>2-3 pracovních dnů</div>
              </div>
            </div>
          </div>
          ...
          <div style={{
            ...
            <div>
              ...
              <div style={{ color: '#a16207', fontSize: '0.8rem' }}>Připravte si přesnou částku pro doručovatele</div>
            </div>
          </div>
