    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{
          ...
          Vaše VERTIX PRO se pripremaju i uskoro će biti poslane.
        </p>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '0.8rem', color: '#a16207', fontWeight: 600, marginBottom: '0.25rem' }}>BROJ NARUDŽBE</div>
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontWeight: 600, color: '#92400e', fontSize: '0.9rem' }}>Plaćanje pouzećem: €65,80</div>
        ...
        <div style={{
          ...
          Imate pitanja? Kontaktirajte nas: <a href="mailto:info@purchstar.com" style={{ color: '#ca8a04', fontWeight: 600, textDecoration: 'none' }}>info@purchstar.com</a>
        </div>
