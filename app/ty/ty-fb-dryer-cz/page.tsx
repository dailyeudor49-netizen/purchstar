      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            Váš DryPro 360 Ultra se připravuje a brzy bude odeslán.
          </p>
          ...
          <div style={{
            ...
            <div>
              <div style={{ fontWeight: 600, color: '#92400e', fontSize: '0.9rem' }}>Platba při doručení: 1 749 Kč</div>
          ...
          <div style={{
            ...
            Máte otázky? Napište nám: <a href="mailto:info@purchstar.com" style={{ color: '#16a34a', fontWeight: 600, textDecoration: 'none' }}>info@purchstar.com</a>
          </div>
