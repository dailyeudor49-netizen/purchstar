    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{
          ...
          Twoja Bio-Collagen Deep Mask jest przygotowywana i niedługo zostanie wysłana.
        </p>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '0.8rem', color: '#9f1239', fontWeight: 600, marginBottom: '0.25rem' }}>KOD ZAMÓWIENIA</div>
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontWeight: 600, color: '#92400e', fontSize: '0.9rem' }}>Zapłata przy doręczeniu</div>
        ...
        <div style={{
          ...
          Masz pytania? Napisz do nas: <a href="mailto:info@biocollagen.pl" style={{ color: '#e11d48', fontWeight: 600, textDecoration: 'none' }}>info@biocollagen.pl</a>
        </div>
