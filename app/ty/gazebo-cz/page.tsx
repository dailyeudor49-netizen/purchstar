...
export default function GazeboCzThankYou() {
  ...
  useEffect(() => {
    // Získat data objednávky z localStorage
    const storedData = localStorage.getItem('gazebo-cz-order');
    if (storedData) {
      try {
  ...
  const formattedDate = deliveryDate.toLocaleDateString('cs-CZ', {
    weekday: 'long',
    day: 'numeric',
    month: 'long'
  });
        ...
        <div className="max-w-2xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-gray-600 mb-2">
              Děkujeme{orderData.fullName ? `, ${orderData.fullName.split(' ')[0]}` : ''}! Vaše objednávka byla přijata.
            </p>
          ...
          <div className="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
            ...
            <div className="p-6 md:p-8 bg-gray-50 space-y-4">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="font-bold text-gray-900 text-sm uppercase tracking-wide mb-1">Předpokládané Doručení</p>
                  <p className="text-gray-600 capitalize">{formattedDate}</p>
                  <p className="text-green-600 font-bold text-sm mt-1">Doprava ZDARMA</p>
                </div>
              </div>
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <div>
                <h3 className="font-bold text-gray-900 mb-1">Potvrzení přes SMS</h3>
                <p className="text-gray-600 text-sm">
                  Obdržíte SMS potvrzení na číslo {orderData.phone || 'poskytnuté'} s detaily objednávky.
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div>
                <h3 className="font-bold text-gray-900 mb-1">Příprava a Odeslání</h3>
                <p className="text-gray-600 text-sm">
                  Váš altán bude připraven a odeslán do 24 hodin expresní kurýrní službou.
                </p>
              </div>
            </motion.div>
        ...
        <div className="max-w-2xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="bg-white rounded-xl p-4 text-center shadow border border-gray-100">
              ...
              <p className="text-xs font-bold text-gray-700 uppercase">Expresní Doručení</p>
            </div>
            <div className="bg-white rounded-xl p-4 text-center shadow border border-gray-100">
            ...
            <div className="bg-white rounded-xl p-4 text-center shadow border border-gray-100">
              ...
              <p className="text-xs font-bold text-gray-700 uppercase">Vrácení 30 Dní</p>
            </div>
            <div className="bg-white rounded-xl p-4 text-center shadow border border-gray-100">
              <Star className="text-yellow-500 mx-auto mb-2" size={28} />
              <p className="text-xs font-bold text-gray-700 uppercase">4.9/5 Hvězdiček</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="px-4 pb-12">
        <div className="max-w-2xl mx-auto">
          <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-3xl p-6 md:p-8 text-white text-center">
            ...
            <h3 className="text-xl md:text-2xl font-black mb-2 uppercase">Potřebujete Pomoc?</h3>
            <p className="text-gray-400 mb-4 text-sm md:text-base">
              Naše zákaznická služba je k dispozici od pondělí do pátku, 9:00 - 18:00
            </p>
            <a
        ...
        <div className="max-w-2xl mx-auto">
          <div className="bg-gradient-to-r from-yellow-400 to-orange-400 rounded-3xl p-6 md:p-8 text-center">
            ...
            <p className="text-white/90 mb-4 text-sm md:text-base">
              S vaší objednávkou dostanete <strong>ZDARMA</strong> extra sadu kolíků pro ukotvení na měkkém terénu!
            </p>
            <div className="inline-block bg-white/20 backdrop-blur-sm rounded-xl px-4 py-2">
              <span className="text-white font-bold">Hodnota: 490 Kč — ZDARMA</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <footer className="bg-gray-900 text-white py-10 px-4">
        <div className="max-w-7xl mx-auto text-center space-y-6">
          ...
          <div className="flex flex-wrap justify-center gap-6 text-xs font-bold uppercase text-gray-500 tracking-wide">
            <Link href="/privacy-policy" className="hover:text-white transition-colors">Ochrana Soukromí</Link>
            <Link href="/terms-of-service" className="hover:text-white transition-colors">Podmínky</Link>
            <Link href="/contact" className="hover:text-white transition-colors">Kontakt</Link>
          </div>
          <p className="text-xs text-gray-600">
            © 2024 Pop Up Gazebo Česká republika. Všechna práva vyhrazena.
          </p>
        </div>
      </footer>
    </div>
