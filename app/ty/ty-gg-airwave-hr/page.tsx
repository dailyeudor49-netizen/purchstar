...
const CONVERSION_LABEL = 'AW-17321474795/hS5uCN3_t80bEOv1wsNA';
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', gap: '0.75rem', marginBottom: '0.75rem' }}>
              ...
              <div>
                <div style={{ fontWeight: 600, color: '#1E293B', fontSize: '0.9rem' }}>Predaja kuriru</div>
            ...
            <div style={{ display: 'flex', gap: '0.75rem' }}>
              ...
              <div>
                <div style={{ fontWeight: 600, color: '#1E293B', fontSize: '0.9rem' }}>Isporuka</div>
