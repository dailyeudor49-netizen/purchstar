...
// --- GOOGLE CONVERSION CONFIG ---
const GOOGLE_CONVERSION = {
  id: 'AW-17806153053',
  label: 'IWydCIzl9eIbEN2q0apC'
};
...
export default function ThankYouPage() {
  ...
  useEffect(() => {
    ...
    if (stored) {
      ...
      const newCode = 'DRP-' + Math.floor(100000 + Math.random() * 900000).toString();
      sessionStorage.setItem('orderCode', newCode);
      setOrderCode(newCode);
    }
  }, []);

  // Fire conversion when gtag is ready
  useEffect(() => {
    ...
    const fireConversion = () => {
      if (typeof window !== 'undefined' && (window as any).gtag) {
        (window as any).gtag('event', 'conversion', {
          'send_to': `${GOOGLE_CONVERSION.id}/${GOOGLE_CONVERSION.label}`
        });
        setConversionFired(true);
        console.log('Google Conversion fired:', `${GOOGLE_CONVERSION.id}/${GOOGLE_CONVERSION.label}`);
      }
    };
    ...
    // Also try after a short delay in case gtag isn't ready yet
    const timer = setTimeout(fireConversion, 1000);
  ...
  return (
    <>
      {/* Google Tag (gtag.js) */}
      <Script
        src={`https://www.googletagmanager.com/gtag/js?id=${GOOGLE_CONVERSION.id}`}
      ...
      <Script id="google-analytics" strategy="afterInteractive">
        {`
          ...
          gtag('js', new Date());
          gtag('config', '${GOOGLE_CONVERSION.id}');
        `}
      </Script>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            DryPro 360 Ultra sa pripravuje a čoskoro bude odoslaný.
          </p>
          ...
          <div style={{
            ...
            <div style={{ fontSize: '0.8rem', color: '#166534', fontWeight: 600, marginBottom: '0.25rem' }}>KÓD OBJEDNÁVKY</div>
          ...
          <div style={{
            ...
            <div style={{ fontSize: '0.85rem', fontWeight: 700, color: '#1E293B', marginBottom: '1rem' }}>Čo nasleduje:</div>
            ...
            <div style={{ display: 'flex', gap: '0.75rem', marginBottom: '0.75rem' }}>
              ...
              <div>
                <div style={{ fontWeight: 600, color: '#1E293B', fontSize: '0.9rem' }}>Spracovanie objednávky</div>
            ...
            <div style={{ display: 'flex', gap: '0.75rem', marginBottom: '0.75rem' }}>
              ...
              <div>
                <div style={{ fontWeight: 600, color: '#1E293B', fontSize: '0.9rem' }}>Odoslanie balíka</div>
          ...
          <div style={{
            ...
            <div>
              <div style={{ fontWeight: 600, color: '#92400e', fontSize: '0.9rem' }}>Platba pri prevzatí: 69,99 €</div>
          ...
          <div style={{
            ...
            Máte otázky? Napíšte nám na: <a href="mailto:info@purchstar.com" style={{ color: '#16a34a', fontWeight: 600, textDecoration: 'none' }}>info@purchstar.com</a>
          </div>
