    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{
          ...
          Το NovaClean X1 σας με τον σταθμό ετοιμάζεται και θα αποσταλεί σύντομα.
        </p>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '0.8rem', color: '#166534', fontWeight: 600, marginBottom: '0.25rem' }}>ΚΩΔΙΚΟΣ ΠΑΡΑΓΓΕΛΙΑΣ</div>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '0.85rem', fontWeight: 700, color: '#1E293B', marginBottom: '1rem' }}>📦 Τι ακολουθεί:</div>
          ...
          <div style={{ display: 'flex', gap: '0.75rem', marginBottom: '0.75rem' }}>
            ...
            <div>
              <div style={{ fontWeight: 600, color: '#1E293B', fontSize: '0.9rem' }}>Επεξεργασία παραγγελίας</div>
          ...
          <div style={{ display: 'flex', gap: '0.75rem', marginBottom: '0.75rem' }}>
            ...
            <div>
              <div style={{ fontWeight: 600, color: '#1E293B', fontSize: '0.9rem' }}>Αποστολή δέματος</div>
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontWeight: 600, color: '#92400e', fontSize: '0.9rem' }}>Πληρωμή στην παράδοση: €79,00</div>
            <div style={{ color: '#a16207', fontSize: '0.8rem' }}>Ετοιμάστε το ακριβές ποσό για τον κούριερ</div>
          </div>
        </div>
        ...
        <div style={{
          ...
          Έχετε ερωτήσεις; Γράψτε μας: <a href="mailto:info@purchstar.com" style={{ color: '#16a34a', fontWeight: 600, textDecoration: 'none' }}>info@purchstar.com</a>
        </div>
