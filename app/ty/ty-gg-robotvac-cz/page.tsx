...
const CONVERSION_LABEL = 'AW-17791478075/GiMlCLO9k9QbELvS0aNC';
    ...
    <>
      ...
      <div style={{
        ...
        <p style={{
          ...
          Váš NovaClean X1 se stanicí se připravuje a brzy bude odeslán.
        </p>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: '0.75rem', marginBottom: '0.75rem' }}>
            ...
            <div>
              <div style={{ fontWeight: 600, color: '#1E293B', fontSize: '0.9rem' }}>Odeslání zásilky</div>
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontWeight: 600, color: '#92400e', fontSize: '0.9rem' }}>Platba při doručení: 1 970 Kč</div>
        ...
        <div style={{
          ...
          Máte dotazy? Napište nám: <a href="mailto:info@purchstar.com" style={{ color: '#16a34a', fontWeight: 600, textDecoration: 'none' }}>info@purchstar.com</a>
        </div>
