    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{
          ...
          Chef Pro-ul dumneavoastră se pregătește și va fi expediat în curând.
        </p>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '0.8rem', color: '#166534', fontWeight: 600, marginBottom: '0.25rem' }}>NUMĂR COMANDĂ</div>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '0.85rem', fontWeight: 700, color: '#1E293B', marginBottom: '1rem' }}>Pașii următori:</div>
          ...
          <div style={{ display: 'flex', gap: '0.75rem', marginBottom: '0.75rem' }}>
            ...
            <div>
              <div style={{ fontWeight: 600, color: '#1E293B', fontSize: '0.9rem' }}>Procesare comandă</div>
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontWeight: 600, color: '#92400e', fontSize: '0.9rem' }}>Plată la livrare: 507 Lei</div>
            <div style={{ color: '#a16207', fontSize: '0.8rem' }}>Pregătiți suma exactă pentru curier</div>
          </div>
        </div>
        ...
        <div style={{
          ...
          Întrebări? Contactați-ne la: <a href="mailto:info@purchstar.com" style={{ color: '#16a34a', fontWeight: 600, textDecoration: 'none' }}>info@purchstar.com</a>
        </div>
