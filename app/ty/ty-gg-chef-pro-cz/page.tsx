      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            Vas Chef Pro se pripravuje a brzy bude odeslan.
          </p>
          ...
          <div style={{
            ...
            <div style={{ fontSize: '0.8rem', color: '#166534', fontWeight: 600, marginBottom: '0.25rem' }}>CISLO OBJEDNAVKY</div>
          ...
          <div style={{
            ...
            <div style={{ fontSize: '0.85rem', fontWeight: 700, color: '#1E293B', marginBottom: '1rem' }}>Dalsi kroky:</div>
            ...
            <div style={{ display: 'flex', gap: '0.75rem', marginBottom: '0.75rem' }}>
              ...
              <div>
                <div style={{ fontWeight: 600, color: '#1E293B', fontSize: '0.9rem' }}>Priprava objednavky</div>
            ...
            <div style={{ display: 'flex', gap: '0.75rem', marginBottom: '0.75rem' }}>
              ...
              <div>
                <div style={{ fontWeight: 600, color: '#1E293B', fontSize: '0.9rem' }}>Odeslani</div>
                <div style={{ color: '#64748b', fontSize: '0.8rem' }}>Behem 24 hodin</div>
              </div>
            </div>
            ...
            <div style={{ display: 'flex', gap: '0.75rem' }}>
              ...
              <div>
                <div style={{ fontWeight: 600, color: '#1E293B', fontSize: '0.9rem' }}>Doruceni</div>
                <div style={{ color: '#64748b', fontSize: '0.8rem' }}>2-3 pracovni dny</div>
              </div>
            </div>
          </div>
          ...
          <div style={{
            ...
            <div>
              <div style={{ fontWeight: 600, color: '#92400e', fontSize: '0.9rem' }}>Platba pri prevzeti: 2199 Kc</div>
              <div style={{ color: '#a16207', fontSize: '0.8rem' }}>Pripravte si presnou castku pro kuriera</div>
            </div>
          </div>
          ...
          <div style={{
            ...
            Otazky? Kontaktujte nas: <a href="mailto:info@purchstar.com" style={{ color: '#16a34a', fontWeight: 600, textDecoration: 'none' }}>info@purchstar.com</a>
          </div>
