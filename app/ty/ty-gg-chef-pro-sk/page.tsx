...
const CONVERSION_ID = 'AW-17806153053';
const CONVERSION_LABEL = 'AW-17806153053/IWydCIzl9eIbEN2q0apC';
...
export default function ThankYouPage() {
  ...
  useEffect(() => {
    ...
    if (stored) {
      ...
      const newCode = 'CHP-' + Math.floor(100000 + Math.random() * 900000).toString();
      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            Váš Chef Pro sa pripravuje a čoskoro bude odoslaný.
          </p>
          ...
          <div style={{
            ...
            <div>
              <div style={{ fontWeight: 600, color: '#92400e', fontSize: '0.9rem' }}>Platba pri prevzatí: 89 €</div>
