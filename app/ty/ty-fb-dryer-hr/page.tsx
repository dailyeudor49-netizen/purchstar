      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            DryPro 360 Ultra se priprema i uskoro će biti poslan.
          </p>
          ...
          <div style={{
            ...
            <div style={{ fontSize: '0.8rem', color: '#166534', fontWeight: 600, marginBottom: '0.25rem' }}>KOD NARUDŽBE</div>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', gap: '0.75rem', marginBottom: '0.75rem' }}>
              ...
              <div>
                <div style={{ fontWeight: 600, color: '#1E293B', fontSize: '0.9rem' }}>Slanje paketa</div>
          ...
          <div style={{
            ...
            <div>
              <div style={{ fontWeight: 600, color: '#92400e', fontSize: '0.9rem' }}>Plaćanje pouzećem: 89,99€</div>
          ...
          <div style={{
            ...
            Imate pitanja? Pišite nam na: <a href="mailto:info@purchstar.com" style={{ color: '#16a34a', fontWeight: 600, textDecoration: 'none' }}>info@purchstar.com</a>
          </div>
