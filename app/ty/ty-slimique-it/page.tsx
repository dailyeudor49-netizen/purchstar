...
export default function ThankYouPage() {
  ...
  useEffect(() => {
    ...
    if (stored) {
      ...
      const newCode = 'SLM-' + Math.floor(100000 + Math.random() * 900000).toString();
    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{
          ...
          Il tuo Slimique Kit è in preparazione e verrà spedito a breve.
        </p>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '0.8rem', color: '#be123c', fontWeight: 600, marginBottom: '0.25rem' }}>CODICE ORDINE</div>
        ...
        <div style={{
          ...
          Hai domande? Scrivici a: <a href="mailto:supporto@slimique.it" style={{ color: '#e11d48', fontWeight: 600, textDecoration: 'none' }}>supporto@slimique.it</a>
        </div>
