...
export default function ThankYouPage() {
  ...
  useEffect(() => {
    ...
    if (stored) {
      ...
      const newCode = 'BCM-' + Math.floor(100000 + Math.random() * 900000).toString();
    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{
          ...
          Vaša Bio-Collagen Deep Mask se priprema i uskoro će biti poslana.
        </p>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '0.8rem', color: '#9f1239', fontWeight: 600, marginBottom: '0.25rem' }}>KOD NARUDŽBE</div>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '0.85rem', fontWeight: 700, color: '#1E293B', marginBottom: '1rem' }}>📦 Što slijedi:</div>
          ...
          <div style={{ display: 'flex', gap: '0.75rem', marginBottom: '0.75rem' }}>
            ...
            <div>
              <div style={{ fontWeight: 600, color: '#1E293B', fontSize: '0.9rem' }}>Obrada narudžbe</div>
          ...
          <div style={{ display: 'flex', gap: '0.75rem', marginBottom: '0.75rem' }}>
            ...
            <div>
              <div style={{ fontWeight: 600, color: '#1E293B', fontSize: '0.9rem' }}>Slanje pošiljke</div>
        ...
        <div style={{
          ...
          <div>
            ...
            <div style={{ color: '#a16207', fontSize: '0.8rem' }}>Pripremite točan iznos za dostavljača</div>
          </div>
        </div>
        ...
        <div style={{
          ...
          Imate pitanja? Pišite nam: <a href="mailto:info@biocollagen.hr" style={{ color: '#e11d48', fontWeight: 600, textDecoration: 'none' }}>info@biocollagen.hr</a>
        </div>
