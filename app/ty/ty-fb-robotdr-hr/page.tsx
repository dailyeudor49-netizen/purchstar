    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{
          ...
          Vaš NovaClean X1 sa stanicom se priprema i uskoro će biti poslan.
        </p>
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontWeight: 600, color: '#92400e', fontSize: '0.9rem' }}>Plaćanje pri dostavi: €87,00</div>
        ...
        <div style={{
          ...
          Imate pitanja? Pišite nam: <a href="mailto:info@purchstar.com" style={{ color: '#16a34a', fontWeight: 600, textDecoration: 'none' }}>info@purchstar.com</a>
        </div>
