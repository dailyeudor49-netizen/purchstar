...
export default function ThankYouPage() {
  ...
  useEffect(() => {
    ...
    if (stored) {
      ...
      const newCode = 'DFP-' + Math.floor(100000 + Math.random() * 900000).toString();
    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{
          ...
          Twój DryFold Pro™ jest przygotowywany i wkrótce zostanie wysłany.
        </p>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '0.8rem', color: '#c2410c', fontWeight: 600, marginBottom: '0.25rem' }}>KOD ZAMÓWIENIA</div>
          <div style={{ fontSize: '1.5rem', fontWeight: 800, color: '#f97316', letterSpacing: '1px', fontFamily: 'monospace' }}>{orderCode}</div>
        </div>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: '0.75rem', marginBottom: '0.75rem' }}>
            <div style={{ width: '24px', height: '24px', background: '#f97316', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontSize: '0.7rem', fontWeight: 700, flexShrink: 0 }}>1</div>
            <div>
              <div style={{ fontWeight: 600, color: '#1E293B', fontSize: '0.9rem' }}>Przetwarzanie zamówienia</div>
          ...
          <div style={{ display: 'flex', gap: '0.75rem', marginBottom: '0.75rem' }}>
            ...
            <div>
              <div style={{ fontWeight: 600, color: '#1E293B', fontSize: '0.9rem' }}>Wysyłka paczki</div>
        ...
        <div style={{
          ...
          Masz pytania? Napisz do nas: <a href="mailto:kontakt@dryfold.pl" style={{ color: '#f97316', fontWeight: 600, textDecoration: 'none' }}>kontakt@dryfold.pl</a>
        </div>
