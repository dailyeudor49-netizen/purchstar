...
export default function ThankYouPage() {
  ...
  useEffect(() => {
    ...
    if (stored) {
      ...
      const newCode = 'CHF-' + Math.floor(100000 + Math.random() * 900000).toString();
    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{
          ...
          O seu Robo de Cozinha Inteligente esta a ser preparado e sera enviado em breve.
        </p>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '0.8rem', color: '#9f1239', fontWeight: 600, marginBottom: '0.25rem' }}>CODIGO DE ENCOMENDA</div>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '0.85rem', fontWeight: 700, color: '#1E293B', marginBottom: '1rem' }}>📦 Proximos passos:</div>
          ...
          <div style={{ display: 'flex', gap: '0.75rem', marginBottom: '0.75rem' }}>
            ...
            <div>
              <div style={{ fontWeight: 600, color: '#1E293B', fontSize: '0.9rem' }}>Processamento da encomenda</div>
          ...
          <div style={{ display: 'flex', gap: '0.75rem', marginBottom: '0.75rem' }}>
            ...
            <div>
              <div style={{ fontWeight: 600, color: '#1E293B', fontSize: '0.9rem' }}>Envio da encomenda</div>
          ...
          <div style={{ display: 'flex', gap: '0.75rem' }}>
            ...
            <div>
              ...
              <div style={{ color: '#64748b', fontSize: '0.8rem' }}>2-3 dias uteis</div>
            </div>
          </div>
        </div>
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontWeight: 600, color: '#92400e', fontSize: '0.9rem' }}>Pagamento contra reembolso: 89,00€</div>
        ...
        <div style={{
          ...
          Tem duvidas? Escreva-nos: <a href="mailto:info@purchstar.com" style={{ color: '#e11d48', fontWeight: 600, textDecoration: 'none' }}>info@purchstar.com</a>
        </div>
