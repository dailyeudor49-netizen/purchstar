...
const CONVERSION_LABEL = 'AW-17321474795/U6NiCJPW1c4bEOv1wsNA';
    ...
    <>
      ...
      <div style={{
        ...
        <p style={{
          ...
          Twój klimatyzator Air Wave Smart™ jest przygotowywany i niedługo zostanie wysłany.
        </p>
        ...
        <div style={{
          ...
          <div>
            ...
            <div style={{ color: '#a16207', fontSize: '0.8rem' }}>Przygotuj odmierzoną kwotę dla dostawcy</div>
          </div>
        </div>
