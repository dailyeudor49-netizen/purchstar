...
const CONVERSION_LABEL = 'AW-17321474795/uDD1CPvtzs4bEOv1wsNA';
    ...
    <>
      ...
      <div style={{
        ...
        <p style={{
          ...
          Váš NovaClean X1 so stanicou sa pripravuje a čoskoro bude odoslaný.
        </p>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: '0.75rem', marginBottom: '0.75rem' }}>
            ...
            <div>
              <div style={{ fontWeight: 600, color: '#1E293B', fontSize: '0.9rem' }}>Odoslanie zásielky</div>
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontWeight: 600, color: '#92400e', fontSize: '0.9rem' }}>Platba pri doručení: €79,99</div>
            <div style={{ color: '#a16207', fontSize: '0.8rem' }}>Pripravte si presný obnos pre kuriéra</div>
          </div>
        </div>
        ...
        <div style={{
          ...
          Máte otázky? Napíšte nám: <a href="mailto:info@purchstar.com" style={{ color: '#16a34a', fontWeight: 600, textDecoration: 'none' }}>info@purchstar.com</a>
        </div>
