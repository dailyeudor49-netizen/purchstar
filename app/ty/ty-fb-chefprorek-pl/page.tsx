    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{
          ...
          Twój Chef Pro jest przygotowywany i wkrótce zostanie wysłany.
        </p>
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontWeight: 600, color: '#92400e', fontSize: '0.9rem' }}>Płatność przy odbiorze: 349 zł</div>
        ...
        <div style={{
          ...
          Pytania? Skontaktuj się z nami: <a href="mailto:info@purchstar.com" style={{ color: '#16a34a', fontWeight: 600, textDecoration: 'none' }}>info@purchstar.com</a>
        </div>
