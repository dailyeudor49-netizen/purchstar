      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            DryPro 360 Ultra se pregătește și va fi expediat în curând.
          </p>
          ...
          <div style={{
            ...
            <div style={{ fontSize: '0.8rem', color: '#166534', fontWeight: 600, marginBottom: '0.25rem' }}>COD COMANDĂ</div>
          ...
          <div style={{
            ...
            <div style={{ fontSize: '0.85rem', fontWeight: 700, color: '#1E293B', marginBottom: '1rem' }}>Ce urmează:</div>
            ...
            <div style={{ display: 'flex', gap: '0.75rem', marginBottom: '0.75rem' }}>
              ...
              <div>
                <div style={{ fontWeight: 600, color: '#1E293B', fontSize: '0.9rem' }}>Procesarea comenzii</div>
                <div style={{ color: '#64748b', fontSize: '0.8rem' }}>Astăzi</div>
              </div>
            </div>
            ...
            <div style={{ display: 'flex', gap: '0.75rem', marginBottom: '0.75rem' }}>
              ...
              <div>
                <div style={{ fontWeight: 600, color: '#1E293B', fontSize: '0.9rem' }}>Expedierea coletului</div>
                <div style={{ color: '#64748b', fontSize: '0.8rem' }}>În 24 de ore</div>
              </div>
            </div>
            ...
            <div style={{ display: 'flex', gap: '0.75rem' }}>
              ...
              <div>
                <div style={{ fontWeight: 600, color: '#1E293B', fontSize: '0.9rem' }}>Livrarea</div>
                <div style={{ color: '#64748b', fontSize: '0.8rem' }}>2-3 zile lucrătoare</div>
              </div>
            </div>
          </div>
          ...
          <div style={{
            ...
            <div>
              <div style={{ fontWeight: 600, color: '#92400e', fontSize: '0.9rem' }}>Plata la livrare: 339 RON</div>
              <div style={{ color: '#a16207', fontSize: '0.8rem' }}>Pregătește suma exactă pentru curier</div>
            </div>
          </div>
          ...
          <div style={{
            ...
            Ai întrebări? Scrie-ne: <a href="mailto:info@purchstar.com" style={{ color: '#16a34a', fontWeight: 600, textDecoration: 'none' }}>info@purchstar.com</a>
          </div>
