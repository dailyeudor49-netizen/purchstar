...
const OrderForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // Only add ua if fingerprint is missing
      if (!tmfp) {
      ...
      router.push('/ty/ty-fb-robot-asp-sk-unc');
    } catch (error) {
      ...
      <div className="max-w-xl mx-auto bg-white rounded-3xl shadow-2xl overflow-hidden border-4 border-orange-500 relative">
        ...
        <div className="bg-white p-6 md:p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="block text-xs font-bold text-gray-500 uppercase mb-1 ml-1">Ulica a Číslo Domu</label>
              <input
                type="text"
                name="address"
                required
                className="w-full p-4 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-transparent outline-none transition font-medium text-gray-900"
                placeholder="Napr: Hlavná 10"
...
export default function NovaCleanLandingSK() {
  ...
  return (
    <>
      ...
      <img
        src="https://offers.uncappednetwork.com/click?o=1259&uid=0191dbf2-738a-7d28-82a0-18c3859d5e8f&lp=1278"
           ...
           <div className="max-w-4xl mx-auto">
              ...
              <div className="bg-gray-50 rounded-2xl p-8 border border-gray-200 flex flex-col md:flex-row items-center gap-8">
                 <div className="w-full md:w-1/2 relative">
                    ...
                    <img src="/images/robot-asp/1.webp" className="rounded-xl shadow-lg w-full" alt="Obsah balenia" />
                 </div>
                 <div className="w-full md:w-1/2">
