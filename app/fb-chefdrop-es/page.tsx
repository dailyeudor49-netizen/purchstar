...
const REVIEWS = [
  ...
  { name: "Carlos Rodriguez", title: "Calidad por encima de las expectativas", rating: 5, date: "Hace 1 semana", text: "Materiales solidos y motor muy potente. Anoche hice un risotto y quedo perfecto, cremoso como en un restaurante. Por 69 euros es un regalo.", verified: true },
  ...
  { name: "Roberto Sanchez", title: "Relacion calidad-precio imbatible", rating: 5, date: "Hace 6 dias", text: "He visto productos similares a 400 euros. Este a 69 euros es una oferta irrepetible. La bascula es muy precisa.", verified: true },
    ...
    return (
      <div className="bg-white p-12 rounded-3xl shadow-2xl text-center border-4 border-green-500 animate-in zoom-in duration-500">
        ...
        <div className="p-4 bg-green-50 text-green-700 font-bold rounded-2xl">
          Tu paquete llegara en 24/48h. Prepara 69€ en efectivo para el mensajero!
        </div>
      </div>
    );
  }
        ...
        <main className="max-w-4xl mx-auto bg-white shadow-2xl relative">
          ...
          <section className="p-6 md:p-12 text-center">
            ...
            <h1 className="text-4xl md:text-6xl font-black leading-none mb-6 tracking-tighter">
              COCINA COMO UN PROFESIONAL POR SOLO <span className="text-rose-600">69€</span>
            </h1>
          ...
          <section className="py-20 bg-gray-900 text-white px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-gray-400 italic">Todo incluido en 69€ - Valor de los accesorios por separado: 149€</p>
            </div>
