...
export default function ThankYouPage() {
  ...
  useEffect(() => {
    ...
    if (stored) {
      ...
      const newCode = 'MINI-' + Math.floor(100000 + Math.random() * 900000).toString();
    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{
          ...
          Twoj Mini 17 Pro Titanium jest przygotowywany i zostanie wyslany wkrotce.
        </p>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '0.8rem', color: '#1e40af', fontWeight: 600, marginBottom: '0.25rem' }}>KOD ZAMOWIENIA</div>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: '0.75rem', marginBottom: '0.75rem' }}>
            ...
            <div>
              <div style={{ fontWeight: 600, color: '#1E293B', fontSize: '0.9rem' }}>Przetwarzanie zamowienia</div>
          ...
          <div style={{ display: 'flex', gap: '0.75rem', marginBottom: '0.75rem' }}>
            ...
            <div>
              <div style={{ fontWeight: 600, color: '#1E293B', fontSize: '0.9rem' }}>Wyslanie paczki</div>
              <div style={{ color: '#64748b', fontSize: '0.8rem' }}>W ciagu 24 godzin</div>
            </div>
          </div>
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontWeight: 600, color: '#92400e', fontSize: '0.9rem' }}>Platnosc przy odbiorze: 349 zl</div>
            <div style={{ color: '#a16207', fontSize: '0.8rem' }}>Przygotuj dokladna kwote dla kuriera</div>
          </div>
        </div>
        ...
        <div style={{
          ...
          Masz pytania? Napisz do nas: <a href="mailto:info@purchstar.com" style={{ color: '#2563eb', fontWeight: 600, textDecoration: 'none' }}>info@purchstar.com</a>
        </div>
