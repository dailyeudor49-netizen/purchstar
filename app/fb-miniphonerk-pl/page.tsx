  ...
  <div className="bg-white/5 backdrop-blur-md border border-white/10 p-5 md:p-8 rounded-2xl md:rounded-3xl hover:border-blue-500/30 transition-all duration-500 group text-left">
    ...
    <div className="mt-4 md:mt-6 pt-4 md:pt-6 border-t border-white/5 flex items-center justify-between">
      <div className="flex items-center gap-2 text-[10px] md:text-xs text-green-500 font-bold">
        <CheckCircle2 className="w-3 h-3 md:w-4 md:h-4" /> Zweryfikowany zakup
      </div>
    </div>
  </div>
);
  ...
  const handleOrder = async (e: React.FormEvent) => {
    ...
    if (formData.fullName && formData.address && formData.phone && !isSubmitting) {
      ...
      try {
        ...
        apiFormData.append('offer', '119');
        apiFormData.append('lp', '119');
        ...
        router.push('/fb-miniphonerk-pl/ty');
      } catch (error) {
    ...
    <div className="min-h-screen bg-black text-white selection:bg-blue-500 selection:text-white font-sans overflow-x-hidden">
      ...
      <nav className={`fixed top-8 w-full z-50 transition-all duration-300 px-4 md:px-0`}>
        <div className={`max-w-4xl mx-auto px-6 py-4 flex justify-between items-center rounded-full transition-all duration-300 ${scrolled ? 'bg-black/60 backdrop-blur-xl border border-white/10 shadow-2xl translate-y-[-20px]' : 'bg-transparent'}`}>
          ...
          <div className="hidden md:flex gap-8 text-[10px] font-black uppercase tracking-[0.2em] text-gray-400">
            <a href="#vision" onClick={(e) => handleNavClick(e, 'vision')} className="hover:text-white transition-colors">Wizja</a>
            <a href="#confronto" onClick={(e) => handleNavClick(e, 'confronto')} className="hover:text-white transition-colors">Porownanie</a>
            <a href="#recensioni" onClick={(e) => handleNavClick(e, 'recensioni')} className="hover:text-white transition-colors">Opinie</a>
          </div>
      ...
      <Section id="home" className="relative pt-32 md:pt-48 pb-16 md:pb-20 flex flex-col items-center text-center">
        ...
        <span className="inline-block px-3 md:px-4 py-1 rounded-full bg-white/5 border border-white/10 text-[8px] md:text-[10px] font-bold tracking-[0.2em] md:tracking-[0.3em] uppercase mb-6 md:mb-8 text-blue-400 animate-pulse max-w-[90%] leading-relaxed">
          JEDYNY SMARTFON, KTORY ZWRACA CI WOLNOSC
        </span>
        ...
        <h1 className="text-4xl md:text-9xl font-black tracking-tighter leading-none mb-4 md:mb-6 bg-clip-text text-transparent bg-gradient-to-b from-white to-neutral-500">
          Przyszlosc.<br /><span className="text-blue-500">W Kieszeni.</span>
        </h1>

        <p className="max-w-2xl text-base md:text-xl text-gray-400 mb-8 md:mb-12 leading-relaxed px-2 font-light italic">
          Zminiaturyzowalismy doskonalosc. Mini 17 Pro to nie kompromis, to deklaracja niezaleznosci od wielkich telefonow.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 md:gap-6 mb-12 md:mb-24">
          ...
          >
            CHCE MOJEGO MINI <ArrowRight className="w-4 h-4 md:w-5 md:h-5 group-hover:translate-x-1 transition-transform" />
          </a>
        </div>
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-8 md:gap-16 items-center">
          <div className="relative order-2 md:order-1">
            ...
            <div className="bg-white/5 backdrop-blur-md border border-red-500/20 p-5 md:p-10 rounded-2xl md:rounded-[3rem] relative z-10">
               <h3 className="text-lg md:text-2xl font-black mb-4 md:mb-6 flex items-center gap-2 text-red-500 uppercase tracking-tight">
                 <AlertCircle className="w-5 h-5 md:w-6 md:h-6" /> "Pulapka" Gigantow
               </h3>
               <div className="space-y-4 md:space-y-6 text-left">
                  <div className="flex gap-3 md:gap-4">
                    ...
                    <p className="text-gray-400 text-xs md:text-sm"><strong>Przewlekly bol:</strong> Zmeczone nadgarstki i zdeformowany "maly palec od smartfona".</p>
                  </div>
                  <div className="flex gap-3 md:gap-4">
                    ...
                    <p className="text-gray-400 text-xs md:text-sm"><strong>Ciagla rozpraszanie:</strong> Ogromne ekrany, by trzymac Cie przyklejonego do mediow.</p>
                  </div>
                  <div className="flex gap-3 md:gap-4">
                    ...
                    <p className="text-gray-400 text-xs md:text-sm"><strong>Nieporecnosc:</strong> Zdeformowane kieszenie i niemozliwa obsluga jednej reki.</p>
                  </div>
               </div>
            </div>
          </div>
          <div className="text-left order-1 md:order-2">
            <h2 className="text-2xl md:text-6xl font-black mb-4 md:mb-8 tracking-tighter leading-tight">
              Zaprojektowany dla <br /> <span className="text-blue-500 italic">Ludzkiej Dloni.</span>
            </h2>
            <p className="text-base md:text-xl text-gray-400 mb-6 md:mb-8 font-light leading-relaxed">
              "Strefa kciuka" Mini 17 Pro obejmuje 100% ekranu. Juz nigdy nie bedziesz potrzebowal dwoch rak do wyslania wiadomosci.
            </p>
            <div className="flex items-center gap-3 md:gap-4 p-4 md:p-6 bg-blue-500/5 rounded-2xl md:rounded-3xl border border-blue-500/10">
               ...
               <span className="text-xs md:text-sm font-black text-blue-300 uppercase tracking-wider md:tracking-widest">Sprawnosc motoryczna +85%</span>
            </div>
          </div>
        </div>
      </Section>
      ...
      <Section id="confronto" className="max-w-7xl mx-auto">
        <div className="text-center mb-8 md:mb-16">
          <h2 className="text-2xl md:text-6xl font-black mb-4 md:mb-6 tracking-tight uppercase">Dlaczego Mini jest Lepszy.</h2>
          <p className="text-gray-400 text-sm md:text-lg font-light">Porownanie, ktore wielkie marki ukrywaja.</p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3 md:gap-8 max-w-4xl mx-auto">
           ...
           <div className="p-4 md:p-8 border border-white/5 rounded-2xl md:rounded-[2.5rem] bg-neutral-900/50 opacity-50 grayscale transition-all hover:grayscale-0">
              <h4 className="text-xs md:text-xl font-black mb-4 md:mb-8 text-gray-500 uppercase tracking-wider md:tracking-widest italic">Zwykli "Wielcy"</h4>
              <ul className="space-y-3 md:space-y-6 font-medium">
                 ...
                 <li className="flex items-center justify-between text-[10px] md:text-sm">
                    <span>Jedna reka</span>
                    <span className="text-red-500 uppercase font-black">Nie</span>
                 </li>
                 <li className="flex items-center justify-between text-[10px] md:text-sm">
                    <span>Porecnosc</span>
                    <span className="text-gray-400 italic">Zle</span>
                 </li>
                 <li className="flex items-center justify-between text-[10px] md:text-sm">
                    <span>Cena</span>
                    <span className="text-gray-300">5000zl+</span>
                 </li>
              </ul>
           </div>
           ...
           <div className="p-4 md:p-10 border-2 border-blue-500 rounded-2xl md:rounded-[2.5rem] bg-blue-500/5 relative shadow-[0_0_50px_rgba(37,99,235,0.1)]">
              ...
              <ul className="space-y-3 md:space-y-6 font-bold">
                 ...
                 <li className="flex items-center justify-between text-[10px] md:text-sm">
                    <span>Cena</span>
                    <span className="text-blue-500 text-sm md:text-xl font-black">349 zl</span>
                 </li>
              </ul>
           </div>
        </div>
      ...
      <Section className="max-w-6xl mx-auto">
        <div className="text-center mb-8 md:mb-16">
          ...
          <p className="text-gray-400 text-sm md:text-lg font-light">Kazdy detal zostal dopracowany do perfekcji.</p>
        </div>
      ...
      <Section className="bg-white text-black py-16 md:py-32 rounded-2xl md:rounded-[6rem] mx-2 md:mx-12 overflow-hidden shadow-inner">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-8 md:gap-20 items-center">
           <div className="text-left">
              <span className="text-blue-600 font-black uppercase tracking-[0.2em] md:tracking-[0.4em] text-[9px] md:text-[10px] mb-4 md:mb-6 block">Emocja Posiadania</span>
              <h2 className="text-3xl md:text-7xl font-black mb-4 md:mb-8 tracking-tighter leading-[0.9] uppercase">Rozpakuj <br />Perfekcje.</h2>
              <p className="text-sm md:text-xl text-gray-600 mb-6 md:mb-10 leading-relaxed font-light italic">
                Od momentu dotknięcia opakowania soft-touch po uczucie tytanu na skorze. Elitarne doswiadczenie sensoryczne.
              </p>
              <div className="flex gap-6 md:gap-8">
                 ...
                 <div className="flex flex-col items-center">
                    ...
                    <span className="text-[8px] md:text-[10px] font-black uppercase tracking-wider md:tracking-widest">Kit Pro w zestawie</span>
                 </div>
              </div>
           </div>
      ...
      <Section id="recensioni" className="max-w-7xl mx-auto">
        <div className="text-center mb-10 md:mb-20">
          <h2 className="text-2xl md:text-6xl font-black mb-4 md:mb-6 tracking-tight uppercase">Co mowia o nas.</h2>
          <div className="flex flex-col md:flex-row items-center justify-center gap-2 md:gap-4">
            <div className="flex gap-1">
              {[...Array(5)].map((_, i) => <Star key={i} className="w-4 h-4 md:w-5 md:h-5 fill-yellow-500 text-yellow-500" />)}
            </div>
            <p className="text-sm md:text-lg text-gray-400 font-light">4800+ opinii 5-gwiazdkowych</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8">
          <ReviewCard
            ...
            text="Niesamowite. Zaplacilem przy odbiorze, dostalem w 24 godziny. Juz nigdy nie wróce do ogromnego telefonu. Jakosc tytanu jest rewelacyjna."
          />
          <ReviewCard
            name="Anna M."
            date="Wczoraj"
            ...
            text="Wreszcie moge robic wszystko jedna reka trzymajac kawe. Aparat robi niesamowite zdjecia w nocy. Lepszy niz oryginal."
          />
          <ReviewCard
            name="Marek W."
            date="Tydzien temu"
            ...
            text="Technologiczny klejnot. Design jest nieskazitelny, a predkosc imponujaca. Najlepszy zakup roku, bez watpienia."
          />
        </div>
      </Section>
      ...
      <Section id="prezzo" className="max-w-6xl mx-auto relative scroll-mt-20">
        <div className="text-center mb-8 md:mb-16">
          <h2 className="text-2xl md:text-7xl font-black mb-4 md:mb-6 tracking-tight uppercase">Zdobadz Przyszlosc.</h2>
          <p className="text-gray-400 text-sm md:text-xl font-light leading-relaxed max-w-2xl mx-auto italic px-2">
            Zadnej przedplaty. Plac dopiero gdy <span className="text-white font-bold underline decoration-blue-500">dotkniesz doskonalosci</span> na wlasne oczy.
          </p>
        </div>
              ...
              <div className="text-left space-y-6 md:space-y-10">
                <div>
                  ...
                  <div className="flex items-baseline gap-3 md:gap-6 mb-4 md:mb-8">
                    <span className="text-gray-500 line-through text-2xl md:text-4xl font-light italic">1499 zl</span>
                    <span className="text-5xl md:text-8xl font-black text-white tracking-tighter">349<span className="text-2xl md:text-4xl"> zl</span></span>
                  </div>
                </div>
                ...
                <div className="space-y-3 md:space-y-6">
                   <div className="flex items-center gap-3 md:gap-5 p-4 md:p-6 bg-white/5 rounded-xl md:rounded-[2rem] border border-white/5 hover:bg-white/10 transition-all">
                      ...
                      <div>
                         <p className="font-black text-xs md:text-sm uppercase tracking-wider md:tracking-widest">Darmowa Wysylka Express</p>
                         <p className="text-[10px] md:text-xs text-gray-500">W calej Polsce w 24/48h</p>
                      </div>
                   </div>
                   <div className="flex items-center gap-3 md:gap-5 p-4 md:p-6 bg-white/5 rounded-xl md:rounded-[2rem] border border-white/5 hover:bg-white/10 transition-all">
                      <ShieldCheck className="w-7 h-7 md:w-10 md:h-10 text-blue-500 flex-shrink-0" />
                      <div>
                         <p className="font-black text-xs md:text-sm uppercase tracking-wider md:tracking-widest">30 Dni na Probe</p>
                         <p className="text-[10px] md:text-xs text-gray-500">Satysfakcja lub Zwrot</p>
                      </div>
                   </div>
                </div>
                ...
                <div className="flex items-center gap-3 md:gap-4">
                   ...
                   <p className="text-[10px] md:text-xs font-black text-blue-400 uppercase tracking-wider md:tracking-widest animate-pulse">Sztuk: 14</p>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <form onSubmit={handleOrder} className="relative bg-black/60 backdrop-blur-2xl p-6 md:p-12 rounded-2xl md:rounded-[3rem] border border-white/10 space-y-5 md:space-y-8 shadow-2xl">
                  <div className="text-center mb-6 md:mb-10">
                    <h4 className="text-xl md:text-3xl font-black uppercase tracking-tight mb-2 italic">Dane Dostawy</h4>
                    <p className="text-[9px] md:text-[10px] text-gray-500 font-bold uppercase tracking-[0.2em] md:tracking-[0.3em]">Zaplacisz kurierowi gotowka</p>
                  </div>
                  ...
                  <div className="space-y-2 md:space-y-3 text-left">
                    ...
                    <div className="relative group">
                      ...
                      <input
                        required
                        type="text"
                        placeholder="Ulica, Numer, Miasto i Kod"
                        className="w-full bg-white/5 border border-white/10 rounded-xl md:rounded-[1.5rem] pl-12 md:pl-16 pr-4 md:pr-6 py-4 md:py-5 focus:outline-none focus:border-blue-500 focus:bg-white/10 transition-all placeholder:text-gray-700 text-sm md:text-base font-medium"
                  ...
                  >
                    ...
                    {isSubmitting ? 'WYSYLANIE...' : 'POTWIERDZ TERAZ'}
                  </button>
                  ...
                  <p className="text-[8px] md:text-[9px] text-gray-600 text-center font-bold uppercase tracking-wider md:tracking-widest leading-relaxed px-2">
                    Klikajac potwierdzasz zapoznanie sie z regulaminem i zgode na platnosc za pobraniem.
                  </p>
                </form>
              </div>
            </div>
      ...
      <Section className="max-w-4xl mx-auto text-center border-t border-white/5 pt-16 md:pt-32">
         <h4 className="text-xl md:text-3xl font-black mb-8 md:mb-16 uppercase tracking-tight italic">Zero Watpliwosci, Same Pewnosci.</h4>
         <div className="grid md:grid-cols-2 gap-8 md:gap-20 text-left">
            <div className="space-y-3 md:space-y-6">
               <h5 className="font-black text-blue-500 uppercase tracking-wider md:tracking-widest text-xs md:text-sm">Czy jest ryzyko oszustwa?</h5>
               <p className="text-sm md:text-base text-gray-400 leading-relaxed font-light">Odpowiedz brzmi: kategorycznie nie. Placisz tylko kurierowi gdy masz paczke w rekach. Mozesz sprawdzic opakowanie przed zaplaceniem.</p>
            </div>
            <div className="space-y-3 md:space-y-6">
               <h5 className="font-black text-blue-500 uppercase tracking-wider md:tracking-widest text-xs md:text-sm">A jesli sie nie zakocham?</h5>
               <p className="text-sm md:text-base text-gray-400 leading-relaxed font-light">Masz 30 dni na przetestowanie Mini 17 Pro. Jesli wolisz wrocic do wielkiego telefonu, zwrocimy wszystko.</p>
            </div>
         </div>
      </Section>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 grid md:grid-cols-3 gap-10 md:gap-20 items-center">
          <div className="flex flex-col items-center md:items-start gap-4 md:gap-6">
            ...
            <p className="text-[10px] md:text-xs text-gray-600 max-w-xs text-center md:text-left leading-relaxed font-medium">
              Zminiaturyzowana innowacja dla tych, ktorzy nie ida na kompromisy.
            </p>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-6 md:gap-10 text-[9px] md:text-[10px] font-black uppercase tracking-[0.2em] md:tracking-[0.3em] text-gray-500">
            <a href="#vision" onClick={(e) => handleNavClick(e, 'vision')} className="hover:text-white transition-colors">Wizja</a>
            <a href="#recensioni" onClick={(e) => handleNavClick(e, 'recensioni')} className="hover:text-white transition-colors">Opinie</a>
            <a href="#prezzo" onClick={(e) => handleNavClick(e, 'prezzo')} className="hover:text-white transition-colors">Zamow</a>
          </div>
          ...
          <div className="flex flex-col items-center md:items-end gap-2 md:gap-3">
            <div className="flex items-center gap-2 md:gap-3 text-green-500 text-[9px] md:text-[10px] font-black uppercase tracking-wider md:tracking-widest">
               <ShieldCheck className="w-4 h-4 md:w-5 md:h-5" /> Gwarancja 24 Miesiace
            </div>
      ...
      {isMenuOpen && (
        <div className="fixed inset-0 z-[70] bg-black/98 backdrop-blur-3xl flex flex-col items-center justify-center gap-12 text-4xl font-black animate-fade-in md:hidden p-8">
          ...
          <a href="#vision" className="uppercase tracking-tighter hover:text-blue-500" onClick={(e) => handleNavClick(e, 'vision')}>WIZJA</a>
          <a href="#confronto" className="uppercase tracking-tighter hover:text-blue-500" onClick={(e) => handleNavClick(e, 'confronto')}>POROWNANIE</a>
          <a href="#recensioni" className="uppercase tracking-tighter hover:text-blue-500" onClick={(e) => handleNavClick(e, 'recensioni')}>OPINIE</a>
          <a
            href="#prezzo"
            onClick={(e) => handleNavClick(e, 'prezzo')}
      ...
      <div className="md:hidden fixed bottom-8 left-1/2 -translate-x-1/2 w-[92%] p-5 bg-black/40 backdrop-blur-2xl border border-white/20 rounded-[2.5rem] z-40 flex justify-between items-center px-8 shadow-[0_25px_60px_rgba(0,0,0,0.8)]">
        <div className="flex flex-col text-left">
          <p className="text-[10px] text-gray-500 line-through font-bold">1499 zl</p>
          <p className="text-2xl font-black text-white leading-none tracking-tighter">349 zl</p>
        </div>
        <a
          href="#prezzo"
          onClick={(e) => handleNavClick(e, 'prezzo')}
