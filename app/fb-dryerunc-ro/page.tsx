...
const AmazonReviews = () => {
  const reviews = [
    ...
    { name: "Ion M.", date: "10 martie 2026", text: "Produs solid. Nu e un produs chinezesc obișnuit. Tamburul din oțel inoxidabil este indestructibil. Am plătit la livrare curierului, totul perfect.", img: "m2" }
  ];
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row gap-8 mb-10 pb-8 border-b">
          <div className="md:w-1/3 text-center md:text-left">
            ...
            <span className="text-sm text-slate-500">Pe baza a 14.582 de cumpărători</span>
          ...
          <div className="md:w-2/3 bg-slate-50 p-6 rounded-2xl">
            ...
            <p className="text-sm text-slate-600">99,4% dintre utilizatori au declarat că au redus drastic mirosul de umezeală din casă și au economisit în medie 200 RON lunar la electricitate.</p>
          </div>
        </div>
  ...
  <section className="py-16 px-4 bg-[#0f172a] text-white overflow-hidden relative">
    ...
    <div className="max-w-4xl mx-auto relative z-10">
      <h2 className="text-2xl sm:text-3xl md:text-5xl font-black mb-12 text-center uppercase tracking-tighter leading-none px-2">
        PERFORMANȚĂ <span className="text-[#c5a059] italic">FĂRĂ COMPROMISURI</span>
      </h2>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {[
          ...
          { icon: <Thermometer size={32} />, title: "Dezinfecție 65°C", desc: "Atinge temperatura critică pentru eliminarea a 99,9% din bacterii, acarieni și alergeni depuși în fibrele umede." },
          { icon: <Clock size={32} />, title: "Turbo-Dry 45 Minute", desc: "Haine uscate, calde și gata de purtat în mai puțin de 45 de minute. Gata cu așteptatul 2 zile pe uscător." },
          { icon: <ZapOff size={32} />, title: "Economie la Facturi", desc: "Consumă doar 0,80 RON pe ciclu. Un uscător industrial clasic costă în medie 7 RON. Economie automată." }
        ].map((spec, i) => (
...
const OrderFormContent = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      router.push('/ty/ty-fb-dryerunc-ro');
    } catch (error) {
    ...
    <section id="comanda" className="py-20 px-4 bg-slate-100">
      <div className="max-w-2xl mx-auto">
        <div className="text-center mb-10">
          ...
          <h2 className="text-2xl sm:text-4xl md:text-5xl font-black mb-4 tracking-tighter text-slate-900 leading-[0.9] px-2">COMPLETEAZĂ FORMULARUL <br/><span className="text-blue-700 italic">PLĂTEȘTI LA LIVRARE</span></h2>
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-[2.5rem] p-8 md:p-12 shadow-[0_30px_60px_-12px_rgba(0,0,0,0.15)] text-slate-900 border border-slate-200">
          ...
          <div className="flex items-center gap-4 mb-10 pb-6 border-b border-slate-100">
             <div className="flex-1">
               ...
               <span className="text-4xl font-black text-blue-700">339 RON</span>
             </div>
             <div className="text-right">
               <span className="text-slate-400 text-xs font-bold uppercase block">Preț de Catalog</span>
               <span className="text-xl font-bold text-slate-300 line-through">1.199 RON</span>
             </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="group">
              <label className="text-[10px] font-black uppercase text-slate-400 ml-4 mb-1 block group-focus-within:text-blue-600 transition-colors">Adresa de Livrare (Stradă, Nr., Oraș, Cod Poștal)</label>
              <input
                required
                type="text"
                name="address"
                placeholder="Strada Victoriei 10, București, 010011"
                className="w-full bg-slate-50 border-2 border-slate-100 p-5 rounded-2xl focus:border-blue-600 transition-all shadow-inner font-bold"
            ...
            <button disabled={loading} className="w-full bg-[#dc2626] text-white py-6 md:py-7 rounded-2xl font-black text-lg md:text-2xl shadow-[0_15px_30px_rgba(220,38,38,0.4)] hover:bg-red-700 hover:translate-y-[-2px] active:translate-y-[1px] transition-all flex flex-col items-center justify-center gap-1 md:gap-4 uppercase tracking-tighter leading-tight">
              {loading ? "SE PROCESEAZĂ..." : (
                <>
                  ...
                  <span className="text-xs md:text-lg opacity-80">(PLATA LA LIVRARE)</span>
                </>
              )}
            </button>
            <div className="flex items-center justify-center gap-6 opacity-60">
               <div className="flex items-center gap-1 text-[10px] font-black"><ShieldCheck size={14}/> DATE PROTEJATE</div>
               <div className="flex items-center gap-1 text-[10px] font-black"><Truck size={14}/> LIVRARE GRATUITĂ</div>
            </div>
  ...
  <section className="py-20 px-4 bg-white">
    <div className="max-w-4xl mx-auto">
      <div className="text-center mb-16">
        ...
        <p className="text-slate-500 font-medium">Fiecare uscător de rufe deschis eliberează până la 2 litri de apă în plămânii tăi.</p>
      </div>

      <div className="grid md:grid-cols-3 gap-8">
        {[
          { icon: <ShieldAlert className="text-red-600" />, title: "Bacterii și Patogeni", desc: "Umiditatea persistentă este raiul pentru acarieni. DryPro sterilizează hainele la 65°C, distrugând problema de la rădăcină." },
          ...
          { icon: <Stethoscope className="text-red-600" />, title: "Haine Distruse", desc: "Căldura excesivă din spălătorii distruge fibrele. Rotația noastră controlată păstrează hainele ca noi." }
        ].map((p, i) => (
      ...
      <div className="max-w-6xl mx-auto text-center flex flex-col items-center">
        <div className="z-10 space-y-6">
          ...
          <h1 className="text-3xl sm:text-5xl md:text-8xl font-black leading-[0.85] text-slate-900 tracking-tighter mb-6 px-2">
            LUXUL HAINELOR USCATE <br/><span className="text-blue-700 italic">ȘI STERILIZATE</span> ÎN <span className="underline decoration-[#c5a059]">45 DE MINUTE.</span>
          </h1>
          <p className="text-slate-600 text-base sm:text-xl md:text-2xl max-w-3xl mx-auto font-medium leading-tight px-2">
            Nu mai irosi spațiu și bani. Descoperă singurul uscător cu <b>Capacitate de 4KG</b> și <b>Dezinfecție la 65°C</b>, care consumă mai puțin decât un bec.
          </p>
        </div>
        ...
        <a href="#comanda" className="group w-full max-w-lg bg-[#dc2626] text-white py-6 md:py-7 rounded-[2rem] font-black text-lg sm:text-xl md:text-2xl shadow-[0_20px_40px_rgba(220,38,38,0.4)] flex items-center justify-center gap-4 transition-all hover:scale-105 active:scale-95 uppercase tracking-tighter leading-none mx-2">
...
const Navbar = () => (
  <nav className="bg-white/90 backdrop-blur-xl sticky top-[24px] z-[100] border-b px-6 py-4 flex justify-between items-center shadow-sm">
    ...
    <div className="hidden md:flex gap-8 font-black text-[10px] uppercase tracking-widest text-slate-400">
      <a href="#comanda" className="hover:text-blue-700 transition-colors">Avantaje</a>
...
const StickyCTA = () => (
  <div className="md:hidden fixed bottom-0 left-0 right-0 z-[200] bg-white border-t p-4 flex items-center justify-between shadow-[0_-10px_40px_rgba(0,0,0,0.1)]">
    <div className="flex flex-col">
      <span className="text-[#dc2626] font-black text-3xl leading-none">339 RON</span>
        ...
        <main className="pb-24">
          ...
          <section className="py-16 px-4 text-center bg-slate-900 text-white">
            <div className="max-w-4xl mx-auto space-y-6">
              ...
              <p className="text-[9px] text-slate-600 italic">&copy; 2026 DryPro 360 Ultra. Atenție: Economia de energie și timpul de uscare depind de tipul de încărcătură și condițiile de utilizare.</p>
            </div>
          </section>
        </main>
        <StickyCTA />
